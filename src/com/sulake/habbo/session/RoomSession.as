package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private const const_2363:int = 2500;
      ...
      {
         if(this._state == RoomSessionEvent.const_297 && this._connection != null)
         {
      ...
      public function sendChatMessage(param1:String) : void
      {
         ...
         this.var_1512.add(this.var_1511,getTimer());
         ++this.var_1511;
      }
      ...
      public function receivedChatWithTrackingId(param1:int) : void
      {
         ...
         {
            _loc3_ = getTimer();
            if(_loc3_ - int(_loc2_) > this.const_2363)
            {
