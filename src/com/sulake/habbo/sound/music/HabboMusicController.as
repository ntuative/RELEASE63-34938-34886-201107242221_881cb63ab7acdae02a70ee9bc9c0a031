package com.sulake.habbo.sound.music
{
   ...
   public class HabboMusicController implements IHabboMusicController, IDisposable
   {
      ...
      private static const const_1587:int = HabboMusicPrioritiesEnum.const_131;
      ...
      private var var_561:IPlayListController = null;
      ...
      public function HabboMusicController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_806.push(new TraxSongInfoMessageEvent(this.onSongInfoMessage));
         this.var_806.push(new UserSongDisksInventoryMessageEvent(this.onSongDiskInventoryMessage));
         for each(_loc5_ in this.var_806)
         {
            this._connection.addMessageEvent(_loc5_);
         }
         this.var_94.addEventListener(RoomEngineSoundMachineEvent.const_996,this.onJukeboxInit);
         this.var_94.addEventListener(RoomEngineSoundMachineEvent.const_293,this.onJukeboxDispose);
         this.var_94.addEventListener(RoomEngineSoundMachineEvent.const_831,this.onSoundMachineInit);
         this.var_94.addEventListener(RoomEngineSoundMachineEvent.const_1030,this.onSoundMachineDispose);
         this.var_1296 = new Timer(1000);
         this.var_1296.start();
         this.var_1296.addEventListener(TimerEvent.TIMER,this.sendNextSongRequestMessage);
         this._events.addEventListener(SoundCompleteEvent.TRAX_SONG_COMPLETE,this.onSongFinishedPlayingEvent);
         _loc6_ = 0;
         while(_loc6_ < HabboMusicPrioritiesEnum.const_309)
         {
            this.var_346[_loc6_] = null;
            this.var_848[_loc6_] = 0;
            _loc6_++;
         }
      }
      ...
      protected function onSongFinishedPlayingEvent(param1:SoundCompleteEvent) : void
      {
         ...
         {
            if(this.getTopRequestPriority() == this._priorityPlaying && this.getSongRequestCountAtPriority(this._priorityPlaying) == this.var_1984)
            {
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this._connection)
            {
               for each(_loc1_ in this.var_806)
               {
            ...
            if(this.var_94)
            {
               this.var_94.removeEventListener(RoomEngineSoundMachineEvent.const_996,this.onJukeboxInit);
               this.var_94.removeEventListener(RoomEngineSoundMachineEvent.const_293,this.onJukeboxDispose);
               this.var_94.removeEventListener(RoomEngineSoundMachineEvent.const_831,this.onSoundMachineInit);
               this.var_94.removeEventListener(RoomEngineSoundMachineEvent.const_1030,this.onSoundMachineDispose);
            }
      ...
      private function method_10(param1:int, param2:int, param3:Number, param4:Number, param5:Number, param6:Number) : Boolean
      {
         if(param1 < 0 || param1 >= HabboMusicPrioritiesEnum.const_309)
         {
            return false;
         }
         var _loc7_:SongStartRequestData = new SongStartRequestData(param2,param3,param4,param5,param6);
         this.var_346[param1] = _loc7_;
         this.var_848[param1] += 1;
         return true;
      }
      ...
      private function getSongIdRequestedAtPriority(param1:int) : int
      {
         ...
         var _loc2_:SongStartRequestData = this.var_346[param1];
      ...
      {
         var _loc1_:int = this.var_346.length - 1;
         while(_loc1_ >= 0)
         {
            if(this.var_346[_loc1_] != null)
            {
               return _loc1_;
            }
            _loc1_--;
      ...
      public function playSong(param1:int, param2:int, param3:Number = 0, param4:Number = 0.0, param5:Number = 0.5, param6:Number = 0.5) : Boolean
      {
         ...
         if(!this.method_10(param2,param1,param3,param4,param5,param6))
         {
            return false;
         }
      ...
      public function updateVolume(param1:Number) : void
      {
         ...
         var _loc4_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < HabboMusicPrioritiesEnum.const_309)
         {
      ...
      public function samplesUnloaded(param1:Array) : void
      {
         ...
         while(_loc2_ < this.var_290.length)
         {
            ...
            if(_loc3_.id != this.var_1577 && _loc4_ != null && _loc4_.ready)
            {
      ...
      public function get samplesIdsInUse() : Array
      {
         ...
         {
            if(this.var_346[_loc2_] != null)
            {
               _loc3_ = this.var_346[_loc2_];
      ...
      private function sendNextSongRequestMessage(param1:TimerEvent) : void
      {
         ...
         this._connection.send(new GetSongInfoMessageComposer(this.var_849));
         Logger.log("Requested song info\'s : " + this.var_849);
         this.var_849 = new Array();
      }
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc5_ < _loc4_.length)
         {
            ...
            if(_loc7_)
            {
               ...
               while(this.var_850.indexOf(_loc6_.id) != -1)
               {
                  this.var_850.splice(this.var_850.indexOf(_loc6_.id),1);
                  if(this.var_850.length == 0)
                  {
      ...
      {
         if(param2 == -1 || param1 < 0 || param1 >= HabboMusicPrioritiesEnum.const_309)
         {
            return false;
         }
         ...
         this.var_1984 = this.getSongRequestCountAtPriority(param1);
         this.var_1577 = param2;
         if(this._priorityPlaying <= const_1587)
         {
      ...
      private function notifySongPlaying(param1:SongDataEntry) : void
      {
         ...
         if(param1.length >= 8000 && (this.var_2671 != param1.id || _loc3_ > this.var_2670 + 8000))
         {
            this._soundManager.notifyPlayedSong(param1.name,param1.creator);
            this.var_2671 = param1.id;
            this.var_2670 = _loc3_;
         }
      }
      ...
      private function onSoundMachineInit(param1:Event) : void
      {
         ...
         this.var_561 = new SoundMachinePlayListController(this._soundManager,this,this._events,this.var_94,this._connection) as IPlayListController;
      }
      ...
      {
         this.disposeRoomPlaylist();
         this.var_561 = new JukeboxPlayListController(this._soundManager,this,this._events,this._connection) as IPlayListController;
