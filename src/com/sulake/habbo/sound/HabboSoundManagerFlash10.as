package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager, IUpdateReceiver
   {
      ...
      private static const const_1732:int = 60;
      
      private static const const_1733:int = 25165823;
      
      private static const const_1731:int = 16777215;
      ...
      private var var_1134:IHabboNotifications;
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null, param4:Boolean = true)
      {
         ...
         events.addEventListener(TraxSongLoadEvent.const_788,this.onTraxLoadComplete);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_1134)
         {
            this.var_1134.release(new IIDHabboNotifications());
            this.var_1134 = null;
         }
         super.dispose();
      }
      ...
      public function playSound(param1:String) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:HabboSound = this.var_1135.getValue(param1);
         if(_loc2_ == null)
         {
            _loc3_ = "";
            switch(param1)
            ...
            this.var_1135.add(param1,_loc2_);
         }
         _loc2_.volume = this.var_1117;
         _loc2_.play();
      }
      ...
      private function loadSample(param1:int) : void
      {
         ...
         var _loc2_:String = this.var_137.getKey("flash.dynamic.download.url","furniture/");
         _loc2_ += this.var_137.getKey("flash.dynamic.download.samples.template","mp3/sound_machine_sample_%typeid%.mp3");
      ...
      private function addTraxSongForDownload(param1:int, param2:String) : IHabboSound
      {
         ...
         if(!_loc3_.ready)
         {
            this.var_1403.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      private function createTraxInstance(param1:int, param2:String, param3:Boolean = true) : TraxSequencer
      {
         ...
         var _loc5_:TraxSequencer = new TraxSequencer(param1,_loc4_,this.var_311,events);
         _loc5_.volume = this.var_1117;
      ...
      private function validateSampleAvailability(param1:TraxSequencer, param2:Boolean) : void
      {
         ...
         {
            if(this.var_311.getValue(int(_loc4_[_loc6_])) == null)
            {
               if(param2)
               {
      ...
      public function notifyPlayedSong(param1:String, param2:String) : void
      {
         ...
         this.var_1134.addSongPlayingNotification(param1,param2);
      }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            if(this.var_137.getBoolean("trax.player.sample.memory.purge.enabled",false))
            {
               this.var_3029 = true;
            }
         }
      ...
      private function onNotificationsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1134 = IHabboNotifications(param2);
      }
      ...
      {
         if(this.var_137 == null || this._connection == null || this._roomEngine == null || this.var_245 != null)
         {
            return;
         }
      ...
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1780,this.var_923));
         this.var_923 = -1;
         this.var_924 = null;
      }
      ...
      private function storeVolumeSetting() : void
      {
         ...
         {
            this._connection.send(new SetSoundSettingsComposer(int(this.var_1117 * 100)));
         }
      }
      ...
      private function updateVolumeSetting(param1:Number) : void
      {
         ...
         this.var_245.updateVolume(this.var_1117);
      }
      ...
      private function processLoadedSample(param1:Sound) : void
      {
         ...
         if(this.var_746.getValue(param1) != null)
         {
            ...
            if(this.var_311.getValue(_loc2_) == null)
            {
               this.var_1702.clear();
               _loc3_ = param1.length;
               param1.extract(this.var_1702,int(_loc3_ * 44.1));
               _loc4_ = new TraxSample(this.var_1702,_loc2_,TraxSample.const_1828,TraxSample.const_2039);
               this.var_311.add(_loc2_,_loc4_);
            }
         }
      }
      ...
      private function processLoadedSamples() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         if(this.var_1404.length > 0)
         {
            _loc1_ = getTimer();
            _loc2_ = _loc1_;
            while(_loc2_ - _loc1_ < const_1732 && this.var_1404.length > 0)
            {
               _loc3_ = this.var_1404.splice(0,1)[0];
               this.processLoadedSample(_loc3_);
               _loc2_ = getTimer();
            }
            if(this.var_746.length == 0 && this.var_923 != -1)
            {
               this.var_924.ready = true;
               _loc4_ = this.var_923;
               this.var_923 = -1;
               this.var_924 = null;
               events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_788,_loc4_));
               if(this.var_3029)
               {
      ...
      private function loadNextSong() : void
      {
         var _loc1_:int = 0;
         var _loc2_:* = null;
         if(this.var_924 == null && this.var_1403.length > 0)
         {
            _loc1_ = this.var_1403.getKey(0);
            _loc2_ = this.var_1403.remove(_loc1_);
            if(_loc2_ != null && !_loc2_.disposed)
            {
               this.validateSampleAvailability(_loc2_,true);
               if(_loc2_.ready)
               {
                  events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_788,_loc1_));
               }
               else
               {
                  this.var_924 = _loc2_;
      ...
      private function processSampleMemoryUsage() : void
      {
         ...
         {
            _loc5_ = this.var_311.getKey(_loc4_);
            _loc6_ = this.var_311.getWithIndex(_loc4_);
         ...
         if(_loc1_ > const_1733)
         {
            ...
            _loc8_ = 0;
            _loc9_ = 0;
            while(_loc8_ < _loc1_ - const_1731 && _loc9_ < _loc2_.length)
            {
            ...
            if(_loc7_.length > 0)
            {
               for each(_loc11_ in _loc7_)
               {
                  ...
                  _loc12_ = this.var_311.getValue(_loc11_) as TraxSample;
                  _loc12_.dispose();
                  this.var_311.remove(_loc11_);
               }
