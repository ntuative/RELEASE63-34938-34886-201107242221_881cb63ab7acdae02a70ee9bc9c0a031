package com.sulake.habbo.ui.handler
{
   ...
   public class PlayListEditorWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_1638:IMessageEvent;
      
      private var var_2092:IMessageEvent;
      
      private var var_2093:IMessageEvent;
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         ...
         if(this._container.soundManager)
         {
            ...
            this._container.soundManager.events.addEventListener(PlayListStatusEvent.const_157,this.processSoundManagerEvent);
      ...
      {
         this.var_1638 = new FurniListUpdateEvent(this.onFurniListUpdated);
         this.var_2092 = new FurniListRemoveEvent(this.onFurniListUpdated);
         this.var_2093 = new FurniListInsertEvent(this.onFurniListUpdated);
         this._connection = param1;
         this._connection.addMessageEvent(this.var_1638);
         this._connection.addMessageEvent(this.var_2092);
         this._connection.addMessageEvent(this.var_2093);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._connection)
            {
               this._connection.removeMessageEvent(this.var_1638);
               this._connection.removeMessageEvent(this.var_2092);
               this._connection.removeMessageEvent(this.var_2093);
            }
            ...
            if(this._container)
            {
               if(this._container.soundManager)
               {
                  if(this._container.soundManager.events)
                  {
                     ...
                     this._container.soundManager.events.removeEventListener(PlayListStatusEvent.const_157,this.processSoundManagerEvent);
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_972,RoomWidgetPlayListModificationMessage.const_933,RoomWidgetPlayListModificationMessage.const_835,RoomWidgetPlayListPlayStateMessage.const_1017,RoomWidgetPlayListUserActionMessage.const_887];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_972:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc7_)
                  {
                     _loc8_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_922,_loc2_.id);
            ...
            case RoomWidgetPlayListModificationMessage.const_835:
               ...
               break;
            case RoomWidgetPlayListPlayStateMessage.const_1017:
               ...
               break;
            case RoomWidgetPlayListUserActionMessage.const_887:
      ...
      private function onFurniListUpdated(param1:IMessageEvent) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_901,-1));
            }
         }
      }
      ...
      private function processSoundManagerEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case SongDiskInventoryReceivedEvent.SONG_DISK_INVENTORY_RECEIVED:
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_883));
               break;
            case PlayListStatusEvent.const_103:
               ...
               break;
            case PlayListStatusEvent.const_157:
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_157));
               break;
