package com.sulake.habbo.ui.handler
{
   ...
   public class FurnitureClothingChangeWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver
   {
      ...
      private static const const_1592:String = "hd-99999-99999.lg-270-62";
      
      private static const const_1591:String = "hd-99999-99999.ch-630-62.lg-695-62";
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_1011,RoomWidgetClothingChangeMessage.const_857,RoomWidgetAvatarEditorMessage.const_541];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_1011:
               ...
               break;
            case RoomWidgetClothingChangeMessage.const_857:
               ...
               if(_loc2_ != null)
               {
                  ...
                  if(_loc3_ != null)
                  {
                     ...
                     _loc8_ = "null";
                     _loc9_ = _loc3_.getString(RoomObjectVariableEnum.const_1393);
                     ...
                     {
                        _loc8_ = "null";
                        _loc9_ = _loc3_.getString(RoomObjectVariableEnum.const_1391);
                        if(_loc9_ == null || _loc9_ == "")
                        {
                           _loc9_ = const_1591;
                        }
                     }
                     if(this._container.avatarEditor.openEditor(AvatarEditorInstanceId.const_463,this,[AvatarEditorFigureCategory.const_285,AvatarEditorFigureCategory.const_938],false,"${widget.furni.clothingchange.editor.title}"))
                     {
                        this._container.avatarEditor.loadAvatarInEditor(AvatarEditorInstanceId.const_463,_loc9_,_loc8_,HabboClubLevelEnum.const_53);
