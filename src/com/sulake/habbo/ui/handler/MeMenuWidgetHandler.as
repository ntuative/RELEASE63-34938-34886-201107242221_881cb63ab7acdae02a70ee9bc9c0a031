package com.sulake.habbo.ui.handler
{
   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IAvatarImageListener
   {
      ...
      public function dispose() : void
      {
         ...
         {
            this._container.avatarEditor.close(AvatarEditorInstanceId.const_209);
         }
         this.var_1150 = true;
         this.container = null;
         this.var_12 = null;
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this.var_12.events.removeEventListener(HabboInventoryEffectsEvent.const_277,this.onAvatarEffectsChanged);
               this.var_12.events.removeEventListener(HabboInventoryHabboClubEvent.const_324,this.onHabboClubSubscriptionChanged);
            }
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_827,this.onHelpTutorialEvent);
            ...
            {
               this._container.catalog.events.removeEventListener(PurseEvent.const_127,this.onCreditBalance);
            }
         }
         ...
         if(this.var_12 != null)
         {
            this.var_12.events.addEventListener(HabboInventoryEffectsEvent.const_277,this.onAvatarEffectsChanged);
            this.var_12.events.addEventListener(HabboInventoryHabboClubEvent.const_324,this.onHabboClubSubscriptionChanged);
         }
         ...
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_827,this.onHelpTutorialEvent);
         ...
         {
            this._container.catalog.events.addEventListener(PurseEvent.const_127,this.onCreditBalance);
         }
      }
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc3_ != this.var_1627)
            {
               ...
               this.var_2074 = _loc1_;
               this.var_2073 = _loc2_;
            }
            else
            {
               _loc1_ = this.var_2074;
               _loc2_ = this.var_2073;
            }
         }
         if(this._toolbar != null)
         {
            if(_loc1_ != null && _loc2_ != null)
            {
               if(_loc1_.height > const_481)
               {
                  ...
                  if(_loc2_.height > const_481 - const_1134)
                  {
                     _loc8_.offset(0,_loc2_.height - const_481 + const_1134);
                  }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetDanceMessage.const_954);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_918);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1221);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1188);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1318);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_1013);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_848);
         _loc1_.push(RoomWidgetStopEffectMessage.const_785);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1853);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1395);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_541);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1797);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1305);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_846);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_759);
         _loc1_.push(RoomWidgetMeMenuMessage.const_892);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_1014);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1792);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_908);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_956);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1245);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetWaveMessage.const_768:
               ...
               break;
            case RoomWidgetDanceMessage.const_954:
               if(this._container != null && this._container.roomSession != null)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_918:
               if(this.var_12 != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_1221:
               if(this.var_12 != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_1188:
               if(this.var_12 != null)
               {
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_848:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1328)
               {
            ...
            case RoomWidgetOpenInventoryMessage.const_1013:
               ...
               if(this.var_12 != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_1751:
                        this._catalog.openCatalogPage(CatalogPageName.const_1270,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1369:
                        this.var_12.toggleInventoryPage(InventoryCategory.const_216);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_2016:
                        this.var_12.toggleInventoryPage(InventoryCategory.const_78);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1878:
                        break;
                     default:
            ...
            case RoomWidgetStopEffectMessage.const_785:
               ...
               break;
            case RoomWidgetNavigateToRoomMessage.const_1395:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_846:
               if(this._container != null)
               {
                  this._container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetMeMenuMessage.const_892:
               ...
               {
                  this._container.events.dispatchEvent(new RoomWidgetPurseUpdateEvent(RoomWidgetPurseUpdateEvent.const_127,this._catalog.getPurse().credits));
               }
            ...
            case RoomWidgetAvatarEditorMessage.const_541:
               ...
               if(this._container)
               {
                  this._container.avatarEditor.openEditor(AvatarEditorInstanceId.const_209,null,null,true);
                  this._container.avatarEditor.loadOwnAvatarInEditor(AvatarEditorInstanceId.const_209);
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_1014:
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_406,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_908:
               ...
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_406,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_956:
               this._container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_406,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_1245:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
      ...
      private function onCreditBalance(param1:PurseEvent) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetPurseUpdateEvent(RoomWidgetPurseUpdateEvent.const_127,param1.balance));
      }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_130:
               ...
               break;
            case HabboHelpTutorialEvent.const_827:
