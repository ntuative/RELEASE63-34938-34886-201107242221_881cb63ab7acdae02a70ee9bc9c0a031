package com.sulake.habbo.ui.handler
{
   ...
   public class RoomQueueWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetRoomQueueMessage.const_998);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomQueueMessage.CHANGE_TO_SPECTATOR_QUEUE:
               this._container.roomSession.changeQueue(RoomSessionQueueEvent.const_1198);
               break;
            case RoomWidgetRoomQueueMessage.const_844:
               this._container.roomSession.changeQueue(RoomSessionQueueEvent.const_1287);
               break;
            case RoomWidgetRoomQueueMessage.const_998:
      ...
      {
         return [RoomSessionQueueEvent.const_554];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionQueueEvent.const_554:
               ...
               {
                  case RoomSessionQueueEvent.const_1287:
                     _loc3_ = "null";
                     break;
                  case RoomSessionQueueEvent.const_1198:
                     _loc3_ = "null";
               }
               if(_loc3_ == null)
               {
               ...
               if(_loc5_.length > 1)
               {
                  ...
                  {
                     _loc6_ = _loc2_.getQueueSize(RoomSessionQueueEvent.const_1989) + 1;
                  }
               }
               else
               {
