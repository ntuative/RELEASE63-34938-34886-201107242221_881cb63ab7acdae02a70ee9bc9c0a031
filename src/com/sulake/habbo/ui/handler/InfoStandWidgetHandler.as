package com.sulake.habbo.ui.handler
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         {
            this.var_245.events.addEventListener(NowPlayingEvent.const_102,this.onNowPlayingChanged);
            this.var_245.events.addEventListener(SongInfoReceivedEvent.const_101,this.onSongInfoReceivedEvent);
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            if(this._container.roomSessionManager != null)
            {
               ...
               this._container.roomSessionManager.events.removeEventListener(RoomSessionPetInfoUpdateEvent.const_113,this.onPetInfo);
         ...
         if(this._container.roomSessionManager != null)
         {
            ...
            this._container.roomSessionManager.events.addEventListener(RoomSessionPetInfoUpdateEvent.const_113,this.onPetInfo);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_649.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_649.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_245 != null)
         {
            this.var_245.events.removeEventListener(NowPlayingEvent.const_102,this.onNowPlayingChanged);
            this.var_245.events.removeEventListener(SongInfoReceivedEvent.const_101,this.onSongInfoReceivedEvent);
            this.var_245 = null;
         }
         this.var_1150 = true;
         this.container = null;
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_598);
         _loc1_.push(RoomWidgetRoomObjectMessage.const_893);
         ...
         _loc1_.push(RoomWidgetChangeMottoMessage.const_891);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_670)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_272 || param1.type == RoomWidgetUserActionMessage.const_514 || param1.type == RoomWidgetUserActionMessage.const_504)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_598:
               return this.handleGetObjectInfoMessage(param1 as RoomWidgetRoomObjectMessage);
            case RoomWidgetRoomObjectMessage.const_893:
            ...
            case RoomWidgetUserActionMessage.const_563:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1333,_loc3_.name);
            ...
            case RoomWidgetFurniActionMessage.const_976:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_1291:
            ...
            case RoomWidgetGetBadgeDetailsMessage.const_861:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_955:
            ...
            case RoomWidgetPetCommandMessage.const_622:
               ...
               break;
            case RoomWidgetChangeMottoMessage.const_891:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               else if(_loc8_.getNumber(RoomObjectVariableEnum.const_897) == 1)
               {
                  _loc6_.extraParam = RoomWidgetInfostandExtraParamEnum.const_1381;
               }
               ...
               _loc10_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1191);
               _loc11_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1187);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  _loc28_ = "";
                  _loc29_ = "";
                  if(_loc6_.extraParam == RoomWidgetInfostandExtraParamEnum.const_607)
                  {
            ...
            case RoomObjectCategoryEnum.const_29:
               ...
               {
                  if(_loc12_.type != RoomObjectTypeEnum.const_652)
                  {
                     return null;
                  }
                  _loc13_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc14_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_334);
               }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_179)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc38_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_919);
                  ...
                  if(!_loc35_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_757;
                  }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc15_.push(RoomWidgetUserInfoUpdateEvent.const_2034);
               }
               else
               {
      ...
      {
         return [RoomSessionUserBadgesEvent.const_178];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_178:
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_649.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_649.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_919);
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_245 != null)
         {
            ...
            if(_loc2_ != null)
            {
               this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_449,param1.id,_loc2_.name,_loc2_.creator));
            }
         }
      }
   }
