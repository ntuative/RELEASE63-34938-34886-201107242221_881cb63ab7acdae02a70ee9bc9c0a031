package com.sulake.habbo.ui.handler
{
   ...
   public class LoadingBarWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(InterstitialEvent.const_503);
         _loc1_.push(InterstitialEvent.const_538);
         _loc1_.push(RoomWidgetLoadingBarUpdateEvent.const_110);
         _loc1_.push(RoomWidgetLoadingBarUpdateEvent.const_354);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case InterstitialEvent.const_503:
               ...
               break;
            case InterstitialEvent.const_538:
            ...
            case RoomWidgetLoadingBarUpdateEvent.const_110:
               ...
               break;
            case RoomWidgetLoadingBarUpdateEvent.const_354:
               this._container.events.dispatchEvent(param1);
         }
      }
