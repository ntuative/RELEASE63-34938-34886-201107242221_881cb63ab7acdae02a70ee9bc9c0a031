package com.sulake.habbo.ui.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_1522:String = "pointer";
      
      private static const const_4:String = "background";
      
      private static var var_1211:IRegionWindow;
      
      private static var var_1489:IRegionWindow;
      
      private static var var_1488:IRegionWindow;
      
      private static var var_1487:IRegionWindow;
      ...
      public function RoomChatItem(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:String, param5:IHabboLocalizationManager, param6:String)
      {
         ...
         if(!var_1488 || !var_1489 || !var_1487 || !var_1211)
         {
            var_1488 = this.buildBubbleWindow("bubble_speak");
            var_1489 = this.buildBubbleWindow("bubble_shout");
            var_1487 = this.buildBubbleWindow("bubble_whisper");
      ...
      public function set y(param1:Number) : void
      {
         ...
         if(this._window != null)
         {
            this._window.y = param1 - this.var_794;
         }
      }
      ...
      {
         var _loc5_:Rectangle = new Rectangle(this._x,this.var_187,this.width,const_1070);
      ...
      public function renderView() : void
      {
         ...
         switch(this.var_1486)
         {
            case RoomWidgetChatUpdateEvent.const_126:
               this._window = var_1488.clone() as IRegionWindow;
               break;
            case RoomWidgetChatUpdateEvent.const_156:
               this._window = var_1487.clone() as IRegionWindow;
               break;
            case RoomWidgetChatUpdateEvent.const_122:
               this._window = var_1489.clone() as IRegionWindow;
               break;
            case RoomWidgetChatUpdateEvent.const_385:
         ...
         var pointerWindow:IBitmapWrapperWindow = this._window.findChildByName(const_1522) as IBitmapWrapperWindow;
         ...
         if(this.var_275 && !isRespect)
         {
            ...
            if(userIconWindow)
            {
               ...
               userIconWindow.x = x1;
               userIconWindow.y = y1;
               this.var_794 = Math.max(0,(this.var_275.height - background.height) / 2);
               this.var_230 += userIconWindow.x + this.var_275.width;
            }
         }
         if(nameWindow != null)
         {
            if(!isRespect)
            {
               nameWindow.text = this.var_976 + ": ";
               nameWindow.y += this.var_794;
         ...
         if(this.var_1486 == RoomWidgetChatUpdateEvent.const_385)
         {
            textWindow.text = this.var_77.registerParameter("widgets.chatbubble.respect","username",this.var_976);
            this.var_230 = const_1068;
         }
         else if(this.var_1486 == RoomWidgetChatUpdateEvent.const_355)
         {
            textWindow.text = this.var_77.registerParameter("widget.chatbubble.petrespect","petname",this.var_976);
            this.var_230 = const_1068;
         }
         ...
         else
         {
            ...
            while(i < this.var_375.length)
            {
               ...
               this.var_793.push([placeholderPos,lastLinkEndPos]);
            ...
            i = 0;
            while(i < this.var_793.length)
            {
               linkPos = this.var_793[i];
               try
               {
         ...
         if(textWindow.visible)
         {
            ...
            textWindow.y += this.var_794;
            messageWidth = textWindow.textWidth;
            textWindow.width = messageWidth + const_1521;
         ...
         if(pointerWindow != null && pointerWindow.visible)
         {
            ...
            pointerWindow.y += this.var_794;
         }
         var bitmap:BitmapData = this.buildBubbleImage(nameWindow.width + textWindow.width,background.height,this.var_2425,isRespect);
         this._window.width = bitmap.width;
         this._window.y -= this.var_794;
         this.var_230 = this._window.width;
         background.bitmap = bitmap;
         background.y = this.var_794;
      }
      ...
      private function testMessageLinkMouseClick(param1:int, param2:int) : Boolean
      {
         ...
         {
            _loc5_ = 0;
            while(_loc5_ < this.var_793.length)
            {
               if(_loc4_ >= this.var_793[_loc5_][0] && _loc4_ <= this.var_793[_loc5_][1])
               {
                  ...
                  {
                     HabboWebTools.openWebPage(this.var_1804 + this.var_375[_loc5_][0],"habboMain");
                  }
                  else
                  {
                     HabboWebTools.openWebPage(this.var_1804 + this.var_375[_loc5_][0]);
                  }
                  return true;
               }
               _loc5_++;
      ...
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         ...
         this._widget.onItemMouseClick(this.var_1212,this.var_976,this.var_1210,this._roomId,this._roomCategory,param1);
      }
      
      private function onBubbleMouseDown(param1:WindowMouseEvent) : void
      {
         this._widget.onItemMouseDown(this.var_1212,this.var_1210,this._roomId,this._roomCategory,param1);
      }
      
      private function onBubbleMouseOver(param1:WindowMouseEvent) : void
      {
         this._widget.onItemMouseOver(this.var_1212,this.var_1210,this._roomId,this._roomCategory,param1);
      }
      
      private function onBubbleMouseOut(param1:WindowMouseEvent) : void
      {
         this._widget.onItemMouseOut(this.var_1212,this.var_1210,this._roomId,this._roomCategory,param1);
      }
