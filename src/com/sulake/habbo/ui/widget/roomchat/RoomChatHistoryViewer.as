package com.sulake.habbo.ui.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private static const const_1701:int = 18;
      ...
      private var var_209:RoomChatHistoryPulldown;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_1150 = false;
         this._widget = param1;
         this.var_209 = new RoomChatHistoryPulldown(param1,param2,param3,param4);
         this.var_209.state = RoomChatHistoryPulldown.const_313;
         ...
         this.var_54 = param2.createWindow("chatscroller","",HabboWindowType.const_1330,HabboWindowStyle.const_47,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         this.var_209.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_313);
      }
      ...
      public function get visible() : Boolean
      {
         ...
         return this.var_209.state == RoomChatHistoryPulldown.const_413 || this.var_209.state == RoomChatHistoryPulldown.const_516;
      }
      ...
      {
         if(!this.var_501 && !this.var_1845)
         {
            this.var_501 = true;
            this.setHistoryViewerScrollbar(true);
            this.var_209.state = RoomChatHistoryPulldown.const_413;
            if(this._widget != null)
            {
      ...
      public function containerResized(param1:Rectangle, param2:Boolean = false) : void
      {
         if(this.var_54 != null)
         {
            ...
            if(param2)
            {
               this.var_54.scrollV = this.var_733;
            }
         }
         if(this.var_209 != null)
         {
            this.var_209.containerResized(param1);
         }
      }
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_500 > 0 && param2)
         {
            if(this.var_2155)
            {
               if(Math.abs(param1 - this.var_500) <= const_1321)
               {
                  return;
               }
               this.var_2155 = false;
            ...
            if(this.var_501)
            {
               ...
               _loc3_ = this.var_733 - _loc5_ / _loc4_;
               _loc3_ = Math.max(0,_loc3_);
               _loc3_ = Math.min(1,_loc3_);
               _loc6_ = param1 - this.var_500;
               _loc7_ = true;
               _loc8_ = true;
               if(this.var_54.scrollV < 1 - const_1701 / this.var_54.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || this.var_2156)
               {
      ...
      public function beginDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_54 != null)
         {
            this.var_733 = this.var_54.scrollV;
         }
         if(this.var_54 != null)
         {
      ...
      private function moveHistoryScroll() : void
      {
         ...
         var _loc1_:Number = this.var_733 - this.var_54.scrollV;
         if(_loc1_ == 0)
         {
            return;
         }
