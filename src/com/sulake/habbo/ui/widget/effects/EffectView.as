package com.sulake.habbo.ui.widget.effects
{
   ...
   public class EffectView
   {
      ...
      private const const_2389:int = 1000;
      ...
      private var var_729:IWindow;
      
      private var var_332:Number;
      
      private var var_410:ITextWindow;
      
      private var var_226:Timer;
      
      private var var_730:IWindow;
      ...
      public function EffectView(param1:EffectsWidget, param2:IWidgetAvatarEffect)
      {
         ...
         this.var_116 = param2;
         this._widget = param1;
         this.var_226 = new Timer(this.const_2389);
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_116.isActive)
         {
            ...
            this.var_729.width = _loc2_ * this.var_332;
         }
         else
         {
            this.var_729.width = 0;
            this.var_226.stop();
         }
         this.setTimeLeft();
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_410 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_410 == null)
            {
               return;
            }
         ...
         if(!this.var_116.isActive)
         {
            this.var_410.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         if(this.var_116.secondsLeft > 86400)
         {
            this.var_410.caption = "${widgets.memenu.effects.active.daysleft}";
            _loc1_ = this.var_410.text;
            _loc2_ = Math.floor(this.var_116.secondsLeft / 86400);
            _loc1_ = _loc1_.replace("%days_left%",_loc2_);
         }
         else
         {
            this.var_410.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = this.var_410.text;
      ...
      public function update() : void
      {
         ...
         if(!this._window)
         {
            this._window = this._widget.windowManager.createWindow("","",HabboWindowType.const_76,HabboWindowStyle.const_31,HabboWindowParam.const_65) as IWindowContainer;
         }
         ...
         else
         {
            ...
            this.var_730 = this._window.findChildByName("effect_hilite");
            this.var_730.visible = false;
         }
         this.setTimeLeft();
         this.var_729 = this._window.findChildByName("loader_bar");
         if(this.var_729 != null)
         {
            this.var_332 = this.var_729.width;
            this.var_226.start();
            this.onUpdate();
         }
