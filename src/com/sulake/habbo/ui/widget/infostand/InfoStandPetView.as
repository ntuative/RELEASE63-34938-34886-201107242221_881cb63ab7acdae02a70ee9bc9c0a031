package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private static const const_1499:int = 162;
      
      private static const const_1491:int = 16;
      
      private static const const_692:int = 4;
      
      private static const const_1501:uint = 14342874;
      
      private static const const_1497:uint = 3815994;
      
      private static const const_1493:uint = 2085362;
      
      private static const const_1494:uint = 39616;
      
      private static const const_1498:uint = 10513106;
      
      private static const const_1490:uint = 8734654;
      
      private static const const_1492:uint = 9094430;
      
      private static const const_1496:uint = 6200576;
      
      private static const const_1503:String = "happiness";
      
      private static const const_1500:String = "experience";
      
      private static const const_1502:String = "energy";
      
      private static const const_1495:int = 250;
      
      private static const const_1065:int = 25;
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(const_1503,param1.nutrition,param1.nutritionMax,const_1494,const_1493);
         this.updateStateElement(const_1500,param1.experience,param1.experienceMax,const_1490,const_1498);
         this.updateStateElement(const_1502,param1.energy,param1.energyMax,const_1496,const_1492);
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(const_1499,const_1491,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),const_1501);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,const_1497);
         var _loc9_:Rectangle = new Rectangle(1,1 + const_692,_loc7_.width - 2,_loc7_.height - 2 - const_692);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,const_692);
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_216 && this.var_216.getPetId() == this.var_551)
               {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_400,this._widget.petData.ownerId);
      ...
      private function arrangeButtons() : void
      {
         ...
         for each(_loc5_ in _loc2_)
         {
            if(_loc5_.visible)
            {
               ...
               {
                  _loc3_ = _loc1_;
                  _loc4_ += const_1065 + const_1064;
               }
               _loc5_.x = _loc3_ - _loc5_.width;
               _loc5_.y = _loc4_;
               _loc3_ = _loc5_.x - const_1064;
            }
         }
         this.var_109.height = _loc4_ + const_1065;
         this.updateWindow();
      }
   }
}
