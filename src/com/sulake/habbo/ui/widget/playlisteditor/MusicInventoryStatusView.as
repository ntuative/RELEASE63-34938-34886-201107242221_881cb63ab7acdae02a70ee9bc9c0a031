package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class MusicInventoryStatusView
   {
      ...
      public static const const_819:String = "MISV_BUY_MORE";
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_440.getValues())
         {
            _loc1_.destroy();
         }
         this.var_440 = null;
      ...
      public function method_3(param1:String) : void
      {
         ...
         this._container.addChildAt(this.var_440[param1] as IWindowContainer,0);
         this.var_53 = param1;
      }
      ...
      {
         this.blitBackgroundImage(const_819,"get_more_music_background_image",param1);
         if(param2 && param1 != null)
         {
            param1.dispose();
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_440.add(const_940,_loc1_);
            this.var_2163 = _loc1_.getChildByName("preview_play_track_name") as ITextWindow;
            this.var_2162 = _loc1_.getChildByName("preview_play_author_name") as ITextWindow;
            ...
            this.setPreviewPlayingBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_506));
         ...
         if(_loc1_ != null)
         {
            this.var_440.add(const_819,_loc1_);
            ...
            this.setGetMoreMusicBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_547));
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc4_:IWindowContainer = this.var_440[param1] as IWindowContainer;
         if(_loc4_ == null)
         {
            return;
         }
