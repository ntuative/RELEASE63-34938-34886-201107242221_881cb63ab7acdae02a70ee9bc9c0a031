package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_944:String = "PLSV_ADD_SONGS";
      
      public static const const_1355:String = "PLSV_START_PLAYBACK";
      
      public static const const_522:String = "PLSV_NOW_PLAYING";
      ...
      {
         if(this.var_53 != const_522)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_440[this.var_53];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_440[const_944];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_440.add(const_522,_loc1_);
