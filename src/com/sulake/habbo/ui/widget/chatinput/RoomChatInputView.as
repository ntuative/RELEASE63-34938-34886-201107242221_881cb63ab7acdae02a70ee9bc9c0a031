package com.sulake.habbo.ui.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1529:int = 250;
      
      private static const const_1527:int = 0;
      
      private static const BOTTOM_MARGIN:int = 55;
      
      private static const const_1528:String = "${widgets.chatinput.say}";
      ...
      private var var_1809:IWindow;
      
      private var _button:IWindow;
      
      private var var_1808:IWindow;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget)
      {
         super();
         this._widget = param1;
         this.var_1221 = param1.localizations.getKey("widgets.chatinput.mode.whisper",":tell");
         this.var_2433 = param1.localizations.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2434 = param1.localizations.getKey("widgets.chatinput.mode.speak",":speak");
      ...
      private function createWindow() : void
      {
         ...
         this.var_1809 = this._window.findChildByName("input_border");
         this._button = this._window.findChildByName("send_button");
         this.var_1808 = this._window.findChildByName("send_button_text");
         this.var_1493 = this._window.findChildByName("block_text");
         this.var_1808.caption = const_1528;
         ...
         this.var_26.addEventListener(WindowKeyboardEvent.const_366,this.keyUpHandler);
         this.var_26.addEventListener(WindowEvent.const_111,this.onInputChanged);
         this._window.findChildByName("send_button").addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSend);
         this.var_1494 = true;
         this.var_650 = "";
         this._window.addEventListener(WindowEvent.const_589,this.updatePosition);
         this._window.addEventListener(WindowEvent.const_580,this.updatePosition);
      }
      ...
      private function updatePosition(param1:WindowEvent = null) : void
      {
         ...
         var _loc4_:int = (this._window.desktop.width - this.var_1809.width) / 2 - _loc3_;
         var _loc5_:int = this._window.desktop.width - this._window.width - const_1529 - _loc3_;
         this._window.x = Math.max(Math.min(_loc4_,_loc5_),const_1527);
      }
      ...
      private function windowKeyEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ == Keyboard.BACKSPACE)
         {
            if(this.var_26 != null)
            {
               ...
               _loc8_ = _loc7_.split(" ");
               if(_loc8_[0] == this.var_1221 && _loc8_.length == 3 && _loc8_[2] == "")
               {
                  this.var_26.text = "";
                  this.var_650 = "";
               }
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(this.var_651);
