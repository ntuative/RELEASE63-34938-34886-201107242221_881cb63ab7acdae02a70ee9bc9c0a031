package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuSoundSettingsSlider
   {
      ...
      private var var_1900:MeMenuSoundSettingsView;
      ...
      private function buttonProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_1900.saveVolume(this.getValue(param2.x),false);
      }
      ...
      private function method_8() : void
      {
         ...
         if(_loc3_ != null && this.var_804 != null)
         {
            _loc3_.bitmap = new BitmapData(this.var_804.width,this.var_804.height,true,16777215);
            _loc3_.bitmap.copyPixels(this.var_804,this.var_804.rect,new Point(0,0),null,null,true);
         }
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null && this.var_803 != null)
               {
                  ...
                  this.var_1855 = _loc1_.width - _loc3_.width;
               }
            }
         }
      }
