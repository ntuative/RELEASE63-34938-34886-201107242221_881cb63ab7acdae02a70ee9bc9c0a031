package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuWidget extends RoomWidgetBase
   {
      ...
      public static const const_198:String = "me_menu_top_view";
      
      public static const const_536:String = "me_menu_my_clothes_view";
      
      public static const const_1346:String = "me_menu_dance_moves_view";
      
      public static const const_763:String = "me_menu_settings_view";
      
      public static const const_1007:String = "me_menu_sound_settings";
      
      private static const const_1115:Point = new Point(95,440);
      ...
      public function MeMenuWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IEventDispatcher, param6:IHabboConfigurationManager)
      {
         ...
         if(false)
         {
            this.var_2675 = param6.getBoolean("client.news.embed.enabled",false);
         }
         this.var_2170 = this._config.getBoolean("menu.own_avatar.enabled",false);
         (param1 as MeMenuWidgetHandler).widget = this;
         this.changeView(const_198);
         this.hide();
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetWaveUpdateEvent.const_858,this.onWaveEvent);
         param1.addEventListener(RoomWidgetDanceUpdateEvent.const_953,this.onDanceEvent);
         param1.addEventListener(RoomWidgetUpdateEffectsUpdateEvent.const_832,this.onUpdateEffects);
         param1.addEventListener(RoomWidgetToolbarClickedUpdateEvent.const_1008,this.onToolbarClicked);
         param1.addEventListener(RoomWidgetAvatarEditorUpdateEvent.const_1311,this.onAvatarEditorClosed);
         param1.addEventListener(RoomWidgetAvatarEditorUpdateEvent.const_1399,this.onHideAvatarEditor);
         ...
         param1.addEventListener(RoomWidgetPurseUpdateEvent.const_127,this.onCreditBalance);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetWaveUpdateEvent.const_858,this.onWaveEvent);
         param1.removeEventListener(RoomWidgetDanceUpdateEvent.const_953,this.onDanceEvent);
         param1.removeEventListener(RoomWidgetUpdateEffectsUpdateEvent.const_832,this.onUpdateEffects);
         param1.removeEventListener(RoomWidgetToolbarClickedUpdateEvent.const_1008,this.onToolbarClicked);
         ...
         param1.removeEventListener(RoomWidgetAvatarEditorUpdateEvent.const_1311,this.onHideAvatarEditor);
         param1.removeEventListener(RoomWidgetAvatarEditorUpdateEvent.const_1399,this.onAvatarEditorClosed);
         ...
         param1.removeEventListener(RoomWidgetPurseUpdateEvent.const_127,this.onCreditBalance);
      ...
      private function onUserInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         if(!(this.var_562 && this.var_53.window.name == const_536))
         {
      ...
      private function onSettingsUpdate(param1:RoomWidgetSettingsUpdateEvent) : void
      {
         ...
         if(this.var_53.window.name == const_1007)
         {
      ...
      private function onTutorialEvent(param1:RoomWidgetTutorialEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetTutorialEvent.const_656:
               Logger.log("* MeMenuWidget: onHighlightClothesIcon " + this.var_562 + " view: " + this.var_53.window.name);
               if(this.var_562 != true || this.var_53.window.name != const_198)
               {
                  return;
               }
               (this.var_53 as MeMenuMainView).setIconAssets("clothes_icon",const_198,"clothes_highlighter_blue");
               break;
      ...
      private function onToolbarClicked(param1:RoomWidgetToolbarClickedUpdateEvent) : void
      {
         ...
         if(this.var_562)
         {
            _loc2_ = new RoomWidgetMeMenuMessage(RoomWidgetMeMenuMessage.const_892);
            if(messageListener != null)
            {
               messageListener.processWidgetMessage(_loc2_);
            }
      ...
      {
         if(this.var_53 != null && this.var_53.window.name != const_536)
         {
            this.hide();
         }
      }
      ...
      {
         var _loc2_:* = param1.daysLeft != this.var_1580;
         this.var_1580 = param1.daysLeft;
         this.var_2673 = param1.periodsLeft;
         this.var_3098 = param1.pastPeriods;
         this.var_2674 = param1.allowClubDances;
         _loc2_ = Boolean(_loc2_ || param1.clubLevel != this.var_1988);
         this.var_1988 = param1.clubLevel;
         if(_loc2_)
         {
            if(this.var_53 != null)
            {
      ...
      private function onCreditBalance(param1:RoomWidgetPurseUpdateEvent) : void
      {
         ...
         this.var_2676 = param1.balance;
         localizations.registerParameter("widget.memenu.credits","credits",this.var_2676.toString());
      }
