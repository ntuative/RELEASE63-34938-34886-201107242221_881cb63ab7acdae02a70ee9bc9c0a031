package com.sulake.habbo.ui.widget.avatarinfo
{
   ...
   public class AvatarInfoWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      private static const const_1157:String = "use_minimized_own_avatar_menu";
      ...
      private var var_263:AvatarInfoData;
      ...
      private var var_909:AvatarInfoView;
      
      private var var_910:OwnAvatarMenuView;
      
      private var var_911:AvatarMenuView;
      ...
      public function AvatarInfoWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboConfigurationManager, param5:IHabboLocalizationManager, param6:Component)
      {
         ...
         this.var_22 = param6;
         this.var_137 = param4;
         this.var_263 = new AvatarInfoData();
         this.var_2976 = Boolean(this.var_137.getBoolean("menu.avatar.enabled",false));
         this.var_2170 = this.var_137.getBoolean("menu.own_avatar.enabled",false);
      ...
      {
         messageListener.processWidgetMessage(new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_1033,0,0));
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetUserInfoUpdateEvent.const_179,this.updateEventHandler);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_341,this.updateEventHandler);
         ...
         param1.addEventListener(RoomWidgetPetInfoUpdateEvent.const_113,this.updateEventHandler);
         ...
         param1.addEventListener(RoomWidgetRoomObjectNameEvent.const_602,this.updateEventHandler);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_902,this.updateEventHandler);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_453,this.updateEventHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetUserInfoUpdateEvent.const_179,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_341,this.updateEventHandler);
         ...
         param1.removeEventListener(RoomWidgetPetInfoUpdateEvent.const_113,this.updateEventHandler);
         ...
         param1.removeEventListener(RoomWidgetRoomObjectNameEvent.const_602,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_453,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_453,this.updateEventHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetAvatarInfoEvent.const_138:
               ...
               if(this.var_2170 && _loc2_.allowNameChange)
               {
               ...
               break;
            case RoomWidgetRoomObjectNameEvent.const_602:
               ...
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_341:
               this.var_2171 = true;
               break;
            ...
            case RoomWidgetRoomObjectUpdateEvent.const_902:
               ...
               {
                  this.var_2169 = RoomWidgetRoomObjectUpdateEvent(param1).id;
                  messageListener.processWidgetMessage(new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_893,RoomWidgetRoomObjectUpdateEvent(param1).id,RoomWidgetRoomObjectUpdateEvent(param1).category));
               }
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_453:
               if(!(this._view is AvatarMenuView || this._view is OwnAvatarMenuView))
               {
                  if(RoomWidgetRoomObjectUpdateEvent(param1).id == this.var_2169)
                  {
            ...
            case RoomWidgetUserInfoUpdateEvent.const_179:
               ...
               this.updateView(_loc3_.webID,_loc3_.name,_loc3_.userRoomId,RoomObjectTypeEnum.const_129,false,!!_loc3_.isSpectatorMode ? null : this.var_263);
               break;
            case RoomWidgetUserInfoUpdateEvent.BOT:
               _loc4_ = param1 as RoomWidgetUserInfoUpdateEvent;
               this.updateView(_loc4_.webID,_loc4_.name,_loc4_.userRoomId,RoomObjectTypeEnum.const_652,false,null);
               break;
            case RoomWidgetPetInfoUpdateEvent.const_113:
               if(this.var_2171)
               {
                  _loc6_ = param1 as RoomWidgetPetInfoUpdateEvent;
                  this.updateView(_loc6_.id,_loc6_.name,_loc6_.roomIndex,RoomObjectTypeEnum.const_215,false,null);
               }
               break;
            ...
            case RoomWidgetRoomObjectUpdateEvent.const_197:
               ...
               for each(_loc7_ in this.var_418)
               {
      ...
      public function selectOwnAvatar() : void
      {
         ...
         _loc3_ = new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_353,_loc2_.id,RoomObjectCategoryEnum.const_29);
      ...
      {
         this.var_263.amIAnyRoomController = param1.amIAnyRoomController;
         this.var_263.amIController = param1.amIController;
         this.var_263.amIOwner = param1.amIOwner;
         this.var_263.canBeAskedAsFriend = param1.canBeAskedAsFriend;
         this.var_263.canBeKicked = param1.canBeKicked;
         this.var_263.canTrade = param1.canTrade;
         this.var_263.canTradeReason = param1.canTradeReason;
         this.var_263.hasFlatControl = param1.hasFlatControl;
         this.var_263.isIgnored = param1.isIgnored;
         this.var_263.respectLeft = param1.respectLeft;
         this.var_263.isOwnUser = param1.type == RoomWidgetUserInfoUpdateEvent.const_117;
         this.var_263.allowNameChange = param1.allowNameChange;
      }
      ...
      private function updateView(param1:int, param2:String, param3:int, param4:int, param5:Boolean, param6:AvatarInfoData) : void
      {
         ...
         if(param6)
         {
            _loc7_ = !!param6.isOwnUser ? Boolean(this.var_2170) : Boolean(this.var_2976);
         }
            ...
            if(!this.var_1986)
            {
               if(_loc7_)
               {
                  if(param6.isOwnUser)
                  {
                     if(!this.var_910)
                     {
                        this.var_910 = new OwnAvatarMenuView(this);
                     }
               ...
               else
               {
                  if(!this.var_909)
                  {
                     this.var_909 = new AvatarInfoView(this);
                  }
                  this._view = this.var_909;
      ...
      public function removeView(param1:AvatarInfoView, param2:Boolean) : void
      {
         if(param1)
         {
            ...
            {
               this.var_418.remove(param1.userName);
               param1.dispose();
               this.checkUpdateNeed();
            }
         }
      ...
      public function checkUpdateNeed() : void
      {
         ...
         if(this._view || this.var_418.length > 0)
         {
      ...
      {
         this.handler.container.avatarEditor.openEditor(AvatarEditorInstanceId.const_209,null,null,true);
         this.handler.container.avatarEditor.loadOwnAvatarInEditor(AvatarEditorInstanceId.const_209);
      }
      ...
      {
         return this.handler.container.config.getBoolean(const_1157,true);
      }
      
      public function set useMinimizedOwnAvatarMenu(param1:Boolean) : void
      {
         this.handler.container.config.setKey(const_1157,!!param1 ? "1" : "0");
      }
   }
}
