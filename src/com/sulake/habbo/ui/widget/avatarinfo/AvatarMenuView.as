package com.sulake.habbo.ui.widget.avatarinfo
{
   ...
   public class AvatarMenuView extends AvatarInfoView
   {
      ...
      protected static const const_1044:uint = 1;
      
      protected static const const_1045:uint = 2;
      
      protected static var var_1439:uint = const_1044;
      
      private static const const_1664:uint = 16744755;
      
      private static const const_1663:uint = 16756591;
      
      private static const const_1107:int = 8;
       
      
      protected var _data:AvatarInfoData;
      
      protected var var_704:uint = 1;
      ...
      protected function updateButtons() : void
      {
         ...
         if(!this.var_1725)
         {
            ...
            {
               this.var_704 = const_1045;
            }
            else
            {
               this.var_704 = var_1439;
            }
         }
         if(this.var_704 == const_1044)
         {
      ...
      private function showButton(param1:String, param2:Boolean = true) : void
      {
         ...
         if(_loc6_)
         {
            ...
            {
               _loc6_.x = _loc5_.x + (_loc5_.width - _loc5_.textWidth) / 2 - _loc6_.width - const_1107;
            }
            if(_loc6_.tags.indexOf("arrow_right") != -1)
            {
               _loc6_.x = _loc5_.x + (_loc5_.width + _loc5_.textWidth) / 2 + const_1107;
            }
         }
      }
      ...
      private function buttonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            if(param2.name == "button")
            {
               param2.color = param2.tags.indexOf("moderate") > -1 ? uint(const_2073) : uint(const_1040);
            }
            else if(param2.tags.indexOf("link") > -1)
            {
               if(param2.tags.indexOf("actions") > -1)
               {
                  ITextWindow(IWindowContainer(param2).getChildAt(0)).textColor = const_1428;
               }
               else if(param2.tags.indexOf("moderate") > -1)
               {
                  ITextWindow(IWindowContainer(param2).getChildAt(0)).textColor = const_1663;
               }
            }
         }
