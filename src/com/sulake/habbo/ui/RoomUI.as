package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends ComponentContext implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_1264:IRoomWidgetFactory;
      
      private var var_396:ISessionDataManager;
      
      private var _friendList:IHabboFriendList;
      
      private var var_983:IAvatarRenderManager;
      ...
      private var var_1180:IHabboHelp;
      ...
      {
         this.var_1551 = RoomDesktop.const_493;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_983.release(new IIDAvatarRenderManager());
            this.var_983 = null;
         }
         ...
         {
            this.var_1180.release(new IIDHabboHelp());
            this.var_1180 = null;
         }
         ...
         if(this.var_1263)
         {
            this.var_1263.release(new IIDHabboUserDefinedRoomEvents());
            this.var_1263 = null;
         }
         this.var_1513 = null;
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_983 = param2 as IAvatarRenderManager;
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         {
            this.var_335.events.addEventListener(InterstitialEvent.const_538,this.interstitialCompleteEventHandler);
            this.var_335.events.addEventListener(InterstitialEvent.const_503,this.adEventHandler);
            this.var_335.events.addEventListener(AdEvent.const_610,this.adEventHandler);
         }
      }
      ...
      private function onHabboHelpReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1180 = param2 as IHabboHelp;
      }
      ...
      private function registerSessionEvents() : void
      {
         if(this.var_15)
         {
            this.var_15.events.addEventListener(RoomSessionEvent.const_297,this.roomSessionStateEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionChatEvent.const_228,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionChatEvent.const_661,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionUserBadgesEvent.const_178,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionDoorbellEvent.const_132,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionDoorbellEvent.const_161,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionDoorbellEvent.const_60,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionPresentEvent.const_361,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionPetPackageEvent.const_497,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionPetPackageEvent.const_653,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionViralFurniStatusEvent.const_604,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionViralFurniStatusEvent.const_659,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_312,this.roomSessionDialogEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_1268,this.roomSessionDialogEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_964,this.roomSessionDialogEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_1027,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionQueueEvent.const_554,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionVoteEvent.const_162,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionVoteEvent.const_165,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionPollEvent.const_176,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionDimmerPresetsEvent.const_517,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionFriendRequestEvent.const_89,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionDanceEvent.const_171,this.roomSessionEventHandler);
         }
      }
      ...
      private function roomSessionStateEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionEvent.const_297:
            ...
            case RoomSessionEvent.const_86:
               if(param1.session != null)
               {
                  ...
                  this._toolbar.setToolbarState(HabboToolbarEnum.const_985);
               }
         }
      }
      ...
      private function roomSessionDialogEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(event.type)
         {
            case RoomSessionErrorMessageEvent.const_312:
            ...
            case RoomSessionErrorMessageEvent.const_962:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_964:
               errorMessage = "${room.error.pets.forbidden_in_flat}";
               break;
            case RoomSessionErrorMessageEvent.const_913:
               errorMessage = "${room.error.pets.no_free_tiles}";
               break;
            case RoomSessionErrorMessageEvent.const_1027:
      ...
      private function interstitialCompleteEventHandler(param1:InterstitialEvent) : void
      {
         ...
         var _loc2_:String = this.getRoomIdentifier(this._interstitialRoomId,this.var_2579);
      ...
      private function onUserDefinedRoomEventsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1263 = param2 as IHabboUserDefinedRoomEvents;
      }
      ...
      private function initializeRoomEngineEvents() : void
      {
         ...
         {
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_1022,this.roomEngineEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_605,this.roomEngineEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineRoomColorEvent.const_907,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_936,this.roomObjectEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_761,this.roomObjectEventHandler);
      ...
      private function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         if(param1.type == RoomEngineEvent.const_1022)
         {
            if(this.var_15 != null)
            {
               this.var_15.roomEngineReady = true;
         ...
         else if(param1.type == RoomEngineEvent.const_581 || param1.type == RoomEngineEvent.const_605)
         {
      ...
      private function roomEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_194:
               ...
               _loc3_.disposeWidget(RoomWidgetEnum.const_679);
               ...
               if(!_loc3_.session.isSpectatorMode)
               {
                  ...
                  _loc3_.createWidget(RoomWidgetEnum.const_89);
               ...
               _loc3_.createWidget(RoomWidgetEnum.const_965);
               ...
               if(this.var_1551 != RoomDesktop.const_493)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_369,this.var_1551);
               }
               if(this.var_335 != null)
               {
            ...
            case RoomEngineEvent.const_367:
               ...
               break;
            case RoomEngineRoomColorEvent.const_907:
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         if(_loc3_.showInterstitial())
         {
            ...
            this.var_2579 = param1.roomCategory;
         }
         else
         {
            this.var_1552 = false;
      ...
      public function disposeDesktop(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getWidgetState(RoomWidgetEnum.const_369);
