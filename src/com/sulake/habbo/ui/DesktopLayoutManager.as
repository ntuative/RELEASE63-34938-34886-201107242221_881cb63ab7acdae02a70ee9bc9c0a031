package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private function getWidgetContainer(param1:String, param2:IWindow) : IWindowContainer
      {
         ...
         if(param1 == RoomWidgetEnum.const_326)
         {
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = this.var_98.getChildByTag(const_705) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function get roomViewRect() : Rectangle
      {
         ...
         var _loc1_:IWindowContainer = this.var_98.findChildByTag(const_705) as IWindowContainer;
         if(!_loc1_)
         {
            return null;
         }
