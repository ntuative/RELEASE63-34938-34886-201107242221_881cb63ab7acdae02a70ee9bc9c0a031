      ...
      public function updateGenderTab() : void
      {
         ...
         switch(var_78.controller.gender)
         {
            case FigureData.const_94:
               activateTab(this.const_730);
               inactivateTab(this.const_729);
               break;
            case FigureData.FEMALE:
               activateTab(this.const_729);
               inactivateTab(this.const_730);
         }
      }
