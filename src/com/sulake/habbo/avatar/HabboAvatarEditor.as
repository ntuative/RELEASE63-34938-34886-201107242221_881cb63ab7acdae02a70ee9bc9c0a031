package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor
   {
      ...
      private static const const_1480:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1481:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_526:HabboAvatarEditorManager;
      
      private var var_963:IFigureData;
      ...
      public function HabboAvatarEditor(param1:uint, param2:HabboAvatarEditorManager)
      {
         ...
         this.var_526 = param2;
         this.var_963 = this.var_526.avatarRenderManager.getFigureData(AvatarType.const_139);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            for each(_loc2_ in this.var_527)
            {
               _loc2_.dispose();
               _loc2_ = null;
            }
      ...
      private function init(param1:Array = null) : void
      {
         ...
         this.var_636["null"] = new FigureData(this);
         var _loc2_:FigureData = this.var_636["null"];
         var _loc3_:FigureData = this.var_636["null"];
         _loc2_.loadAvatarData(const_1480,FigureData.const_94);
         _loc3_.loadAvatarData(const_1481,FigureData.FEMALE);
         this.var_119 = new Map();
         this.var_527 = new Map();
         this.var_119.add(AvatarEditorFigureCategory.const_934,new BodyModel(this));
         this.var_119.add(AvatarEditorFigureCategory.const_56,new HeadModel(this));
         this.var_119.add(AvatarEditorFigureCategory.const_285,new TorsoModel(this));
         this.var_119.add(AvatarEditorFigureCategory.const_938,new LegsModel(this));
         ...
         this.var_527.add(AvatarEditorSideCategory.const_112,new WardrobeModel(this));
         this.var_527.add(AvatarEditorSideCategory.const_658,new ClubPromoModel(this));
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         if(this.var_782 != param3)
         {
            this.var_782 = param3;
            _loc4_ = true;
         }
         var _loc5_:FigureData = this.var_636[param2];
         if(_loc5_ == null)
         {
            return;
         }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_963.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_963.getPalette(param1);
      }
      ...
      private function selectDefaultCategory(param1:Array) : void
      {
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_934);
         }
      }
      ...
      {
         var _loc2_:ISideContentModel = this.var_527.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      {
         return this.var_636[this.var_1096];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         else
         {
            ...
            this.var_526.communication.getHabboMainConnection(null).send(_loc3_);
            _loc3_.dispose();
            _loc3_ = null;
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_782 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < const_689)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1711.clone() as IWindowContainer,param1,_loc13_);
            ...
            {
               _loc20_ = 2;
               _loc14_ = this.var_526.avatarRenderManager.getMandatoryAvatarPartSetIds(this.gender,_loc20_);
            }
            else
            {
               _loc14_ = this.var_526.avatarRenderManager.getMandatoryAvatarPartSetIds(this.gender,this.clubMemberLevel);
            }
            _loc15_ = Boolean(_loc14_.indexOf(param2) == -1);
            if(_loc15_)
            {
               _loc21_ = this.var_526.assets.getAssetByName("removeSelection") as BitmapDataAsset;
               if(_loc21_)
               {
                  _loc22_ = (_loc21_.content as BitmapData).clone();
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1415.clone() as IWindowContainer,param1,null,null,false);
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1965)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_782 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1415.clone() as IWindowContainer,param1,_loc6_,_loc11_,_loc16_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      {
         return this.var_526.configuration.getBoolean("avatareditor.allowclubtryout",false);
      }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_782 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_527.getValue(AvatarEditorSideCategory.const_112);
      }
