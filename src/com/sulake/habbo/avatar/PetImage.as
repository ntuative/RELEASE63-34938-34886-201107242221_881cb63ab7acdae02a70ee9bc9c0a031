package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_282:AvatarImageCache;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_56)
         {
            ...
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1516);
            if(_loc3_ != null)
            {
         ...
         switch(param1)
         {
            case AvatarAction.const_405:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1988:
                  case AvatarAction.const_2026:
                  case AvatarAction.const_1818:
                  case AvatarAction.const_1231:
                  case AvatarAction.const_1189:
                  case AvatarAction.const_1807:
                  case AvatarAction.const_1795:
      ...
      private function sortActions() : void
      {
         ...
         this.var_1517 = this._structure.sortActions(this.var_365);
         ...
         {
            this.var_894 = this._structure.getCanvasOffsets(this.var_1517,this._scale,this.var_103);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_1517)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_358)
               {
                  this.var_992 = true;
               }
            }
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               for each(_loc4_ in _loc3_.parts)
               {
                  if(_loc4_.type == "pbd")
                  {
                     this.var_1368 = _loc4_.id;
                     this.var_1861 = _loc4_.breed;
                     break;
                  }
               }
            }
