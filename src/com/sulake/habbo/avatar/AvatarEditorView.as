package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1415:IWindowContainer;
      
      public static var var_1711:IWindowContainer;
      
      public static var var_2253:int = 6710886;
      
      private static const const_1585:int = 5000;
      
      private static const const_1544:Point = new Point(100,30);
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:Array)
      {
         ...
         var _loc5_:* = null;
         this.var_1291 = [];
         this.var_1573 = [AvatarEditorFigureCategory.const_934,AvatarEditorFigureCategory.const_56,AvatarEditorFigureCategory.const_285,AvatarEditorFigureCategory.const_938,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_112];
         super();
         this.var_23 = param1;
         if(var_1415 == null)
         {
            _loc4_ = this.var_23.manager.assets.getAssetByName("AvatarEditorThumb") as XmlAsset;
            var_1415 = this.var_23.manager.windowManager.buildFromXML(_loc4_.content as XML) as IWindowContainer;
         }
         if(var_1711 == null)
         {
         ...
         this._saveTimer = new Timer(const_1585,1);
         this._saveTimer.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param2 == null)
         {
            param2 = this.var_1573;
         }
         for each(_loc3_ in param2)
         {
            this.var_1291.push(_loc3_);
         }
         this.createWindow();
      }
      ...
      public function getFrame(param1:Array, param2:String = null) : IFrameWindow
      {
         ...
         this.var_87.position = const_1544;
      ...
      public function embedToContext(param1:IWindowContainer, param2:Array) : Boolean
      {
         ...
         else
         {
            if(this.var_692 == null)
            {
               this.var_692 = this.var_23.manager.windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_76,HabboWindowStyle.const_31,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               this.var_692.addChild(this.var_59);
            }
            _loc3_ = this.var_692.getChildIndex(this.var_59);
            if(_loc3_)
            {
               param1.removeChildAt(_loc3_);
            }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1573);
         }
         if(param1.length != this.var_1291.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1291.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function createWindow() : void
      {
         ...
         this.var_254 = this.var_59.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc1_:int = this.var_254.numSelectables - 1;
         while(_loc1_ >= 0)
         {
            _loc2_ = this.var_254.getSelectableAt(_loc1_);
            if(_loc2_ != null && this.var_1291.indexOf(_loc2_.name) < 0)
            {
      ...
      private function attachImages() : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         var _loc1_:Array = this.var_1573;
      ...
      public function update() : void
      {
         ...
         if(this.var_23.manager.sessionData && this.var_23.manager.sessionData.clubLevel >= HabboClubLevelEnum.const_35 && (this.var_1572 == AvatarEditorSideCategory.const_112 || this.var_2650))
         {
            _loc4_ = "null";
         }
         ...
         this.setViewToCategory(this.var_429);
      }
      ...
      {
         if(this.var_1572 == AvatarEditorSideCategory.const_112)
         {
            this.var_2650 = false;
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_511:
               break;
            case AvatarEditorSideCategory.const_658:
               _loc3_ = this.var_23.getSideContentWindowContainer(AvatarEditorSideCategory.const_658);
               break;
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_343)
         {
            ...
            this.var_343 = this.var_23.manager.windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_343.procedure = this.stripClubDialogEventProc;
            this.var_343.center();
         }
         else
         {
