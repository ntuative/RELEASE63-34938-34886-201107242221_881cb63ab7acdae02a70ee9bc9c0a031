package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_2681:uint;
      
      private var var_2679:uint;
      ...
      {
         super();
         this.var_1995 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2681 = parseInt(_loc2_,16);
         this.var_2679 = parseInt(_loc3_,16);
         ...
         this.var_893 = new ColorTransform(this.var_1835,this.var_1838,this.var_1834,this._alphaMultiplier);
         this.var_1297 = this.generatePaletteMapForGrayscale(this.var_2679,this.var_2681);
      }
      ...
      {
         return this.var_1297.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1297.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1297.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1297.getValue("alphas") as Array;
      }
