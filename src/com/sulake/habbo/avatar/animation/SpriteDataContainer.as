package com.sulake.habbo.avatar.animation
{
   public class SpriteDataContainer implements ISpriteDataContainer
   {
      ...
      private var var_1148:IAnimation;
      ...
      public function SpriteDataContainer(param1:IAnimation, param2:XML)
      {
         ...
         this.var_1995 = parseInt(param2.@ink);
         this.var_2589 = String(param2.@member);
         this.var_2588 = Boolean(parseInt(param2.@directions));
         this._dx = [];
         this.var_1557 = [];
         this.var_1556 = [];
         for each(_loc3_ in param2.direction)
         {
            ...
            this.var_1557[_loc4_] = parseInt(_loc3_.@dy);
            this.var_1556[_loc4_] = parseInt(_loc3_.@dz);
         }
      }
