package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_1442:PartOffsetData;
      ...
      {
         this.var_1442.loadOffsets(param1);
      }
      ...
      public function initActions(param1:IAssetLibrary, param2:XML) : void
      {
         ...
         this.var_948 = new AvatarActionManager(param1,this.var_520,param2);
         this.var_993 = this.var_948.getDefaultAction();
      }
      
      public function method_4(param1:XML) : Boolean
      {
         if(!param1)
         {
         ...
         {
            if(this.var_520 == AvatarType.const_139)
            {
      ...
      public function getMandatorySetTypeIds(param1:String, param2:int) : Array
      {
         ...
         this.var_622[param1][param2] = this.var_370.getMandatorySetTypeIds(param1,param2);
         return this.var_622[param1][param2];
      }
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1772[param3];
      ...
      {
         return this.var_1442.getOffset(param1,param2,param3,param4,param5,param6);
      }
