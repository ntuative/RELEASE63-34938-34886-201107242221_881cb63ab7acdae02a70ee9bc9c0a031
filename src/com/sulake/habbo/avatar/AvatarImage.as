package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1538:String = "Default";
      
      private static const const_1537:int = 2;
      
      private static const const_1539:String = AvatarSetType.const_43;
      ...
      protected var var_894:Array;
      
      protected var _assets:AssetAliasCollection;
      
      protected var var_282:AvatarImageCache;
      ...
      private var var_2575:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.var_727 = param3;
         this.var_282 = new AvatarImageCache(this._structure,this,this._assets,this._scale);
         this.setDirection(const_1539,const_1537);
         this.var_365 = new Array();
         this.var_993 = new ActiveActionData(AvatarAction.const_436);
         this.var_993.definition = this._structure.getActionDefinition(const_1538);
         this.resetActions();
      ...
      {
         param2 += this.var_1860;
         if(param2 < AvatarDirectionAngle.const_1179)
         {
         ...
         if(param1 == AvatarSetType.const_56 || param1 == AvatarSetType.const_43)
         {
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_286.length == 1 && this.var_103 == this.var_2198)
         {
            return this.var_103 + this.var_553 + this.var_683 % 4;
         }
         if(this.var_286.length == 2)
         {
      ...
      {
         if(param3 != this.var_2576 || param2 != this.var_2575 || param1 != this.var_2577)
         {
            this.var_2576 = param3;
            this.var_2575 = param2;
            this.var_2577 = param1;
            this.var_1918 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_365.push(new ActiveActionData(param1,param2,this.var_683));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_315 = this.var_993;
         this.var_315.definition = this.var_993.definition;
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_553 = "";
         this.var_286 = this._structure.sortActions(this.var_365);
         if(this.var_286 == null)
         {
            this.var_894 = new Array(0,0,0);
            if(this.var_1262 != "")
            {
               _loc1_ = true;
               this.var_1262 = "";
         ...
         {
            this.var_894 = this._structure.getCanvasOffsets(this.var_286,this._scale,this.var_103);
            for each(_loc4_ in this.var_286)
            {
               this.var_553 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_380)
               {
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_286)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_992 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        this.var_1860 = _loc2_.directionData.offset;
                     }
               ...
               if(_loc1_.actionType == AvatarAction.const_358 || _loc1_.actionType == AvatarAction.const_281 || _loc1_.actionType == AvatarAction.const_408)
               {
                  this.var_992 = true;
               }
            }
