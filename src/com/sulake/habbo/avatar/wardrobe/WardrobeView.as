package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeView implements ISideContentView
   {
      ...
      private var var_1412:IItemListWindow;
      ...
      public function WardrobeView(param1:WardrobeModel)
      {
         ...
         this.var_1144 = this._window.findChildByName("hc_slots") as IItemListWindow;
         this.var_1412 = this._window.findChildByName("vip_slots") as IItemListWindow;
      ...
      public function update() : void
      {
         ...
         while(_loc3_ < _loc1_.length)
         {
            ...
            else if(this.var_1412)
            {
               this.var_1412.addListItem(_loc2_.view);
               _loc2_.view.visible = true;
            }
            _loc3_++;
         }
