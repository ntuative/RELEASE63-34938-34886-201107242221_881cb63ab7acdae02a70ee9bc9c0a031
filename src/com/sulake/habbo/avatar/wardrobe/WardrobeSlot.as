package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeSlot implements IOutfit, IAvatarImageListener
   {
      ...
      public function updateView() : void
      {
         ...
         if(this.var_727 && this.var_1665)
         {
            _loc5_ = this.var_27.manager.avatarRenderManager.createAvatarImage(this.figure,AvatarScaleType.const_114,this.var_1096,this);
            if(_loc5_)
            {
               _loc5_.setDirection(AvatarSetType.const_43,parseInt(FigureData.const_824));
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            case "set_button":
               this.var_727 = this.var_27.figureData.getFigureString();
               this.var_1096 = this.var_27.gender;
               this.var_27.handler.saveWardrobeOutfit(this.var_2128,this);
               this.updateView();
               break;
            case "get_button":
               if(this.var_727)
               {
                  this.var_27.loadAvatarInEditor(this.var_727,this.var_1096,this.var_27.clubMemberLevel);
               }
         }
      }
