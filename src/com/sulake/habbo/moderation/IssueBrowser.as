package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2387:String = "my_issues";
      
      private const const_2386:String = "open_issues";
      
      private const const_2385:String = "picked_issues";
      
      private const const_2400:String = "closed_issues";
      ...
      private var var_400:IIssueBrowserView;
      
      private var var_2069:IIssueBrowserView;
      
      private var var_2070:IIssueBrowserView;
      
      private var var_2068:PickedIssuesView;
      ...
      private function method_3(param1:String) : void
      {
         ...
         this.var_400.view.width = this.var_297.container.width;
         this.var_400.view.height = this.var_297.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2387:
               if(this.var_2069 == null)
               {
                  this.var_2069 = new MyIssuesView(this.issueManager,this,this.var_297.container);
               }
               return this.var_2069;
            case this.const_2386:
               if(this.var_2070 == null)
               {
                  this.var_2070 = new OpenIssuesView(this.issueManager,this,this.var_297.container);
               }
               return this.var_2070;
            case this.const_2385:
               if(this.var_2068 == null)
               {
                  this.var_2068 = new PickedIssuesView(this.issueManager,this,this.var_297.container);
               }
      ...
      private function onTabSelected(param1:WindowEvent) : void
      {
         ...
         this.method_3(param1.window.name);
      }
