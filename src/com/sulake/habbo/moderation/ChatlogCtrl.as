package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1093:Array = [];
      
      private static var var_2113:int = 1000;
      
      private static var var_1094:Array = [];
      
      private static var var_2112:int = 200;
      ...
      private var var_2071:IMessageComposer;
      ...
      {
         this.var_889 = IWindowContainer(this.var_36.getXmlWindow("chatlog_roomheader"));
         this.var_888 = IWindowContainer(this.var_36.getXmlWindow("chatlog_chatline"));
         ...
         this.var_36.connection.send(this.var_2071);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1093.pop() as IWindowContainer;
         }
      ...
      private function getChatHeaderWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1094.pop() as IWindowContainer;
         }
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_2111[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1657.getValue(param2.chatterName))
            {
               this.var_1657.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1657.getValue(_loc2_);
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1659)
         {
            this.storeChatLineWindow(_loc1_);
         }
         for each(_loc1_ in this.var_1658)
         {
