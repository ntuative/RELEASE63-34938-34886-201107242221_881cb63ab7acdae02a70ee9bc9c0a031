package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_542:UserInfoCtrl;
      
      private var var_1249:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         this.var_542 = new UserInfoCtrl(this._window,this.var_74,_loc3_.message);
         this.var_1249 = new UserInfoCtrl(this._window,this.var_74,_loc3_.message);
         this.var_542.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc3_.reporterUserId);
         ...
         {
            this.var_1249.load(_loc4_,this.var_176.reportedUserId);
         }
         else
         {
      ...
      {
         if(this.var_74 != null && this.var_74.issueManager != null && this.var_176 != null)
         {
            this.var_74.issueManager.removeHandler(this.var_176.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_74.issueManager.closeBundle(this.var_176.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_74.issueManager.closeBundle(this.var_176.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_74.issueManager.closeBundle(this.var_176.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_74.issueManager.releaseBundle(this.var_176.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         this.var_74.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_74,WindowTracker.const_1202,_loc2_),this._window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            this.var_542 = new UserInfoCtrl(this._window,this.var_74,_loc3_.message);
            this.var_542.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc2_);
         }
      }
