package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1319:IDropMenuWindow;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         this.var_1318 = IButtonWindow(this.var_36.getXmlWindow("modact_offence"));
         this.var_1317 = IButtonWindow(this.var_36.getXmlWindow("modact_offencectg"));
      }
      ...
      public function show() : void
      {
         ...
         this._frame.caption = "Mod action on: " + this.var_2037;
         ...
         this.var_1319 = IDropMenuWindow(this._frame.findChildByName("banLengthSelect"));
         this.prepareBanSelect(this.var_1319);
      ...
      public function refreshCategorization() : void
      {
         ...
         {
            this.refreshButtons("offences_cont",2,this.var_1059.offences,this.var_1318,this.onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,this.var_36.initMsg.offenceCategories,this.var_1317,this.onOffenceCtgButton);
      ...
      {
         return WindowTracker.const_1858;
      }
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.connection.send(new ModAlertMessageComposer(this.var_1603,this.var_571.text,this.var_1602));
         this.dispose();
      }
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_571.text = this.var_1060.msg;
         this.var_707 = false;
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.connection.send(new ModKickMessageComposer(this.var_1603,this.var_571.text,this.var_1602));
         this.dispose();
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1319.selection < 0)
         {
            this.var_36.windowManager.alert("Alert","You must select ban lenght",0,this.onAlertClose);
            return;
         }
         this.var_36.connection.send(new ModBanMessageComposer(this.var_1603,this.var_571.text,this.getBanLength(),this.var_1602));
         this.dispose();
      }
      ...
      {
         var _loc1_:int = this.var_1319.selection;
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_1318.destroy();
            this.var_1318 = null;
         }
         if(this.var_1317 != null)
         {
            this.var_1317.destroy();
            this.var_1317 = null;
         }
         this.var_1319 = null;
         this.var_571 = null;
