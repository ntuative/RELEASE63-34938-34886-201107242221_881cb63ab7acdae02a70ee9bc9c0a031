package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_873:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2329 = param2.pickerUserId;
         this.var_2814 = param2.pickerUserName;
         this.var_1449 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1334 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1333;
         }
         if(this.var_873 == null || param1.timeStamp < this.var_873.timeStamp)
         {
            this.var_873 = param1;
         }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_873;
         if(_loc2_ == null)
         {
