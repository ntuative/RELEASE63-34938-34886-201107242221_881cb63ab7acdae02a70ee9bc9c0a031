package com.sulake.habbo.moderation
{
   ...
   public class IssueListView
   {
      ...
      private var var_2120:IWindowContainer;
      
      private var var_3131:BitmapData;
      
      private var var_3132:BitmapData;
      ...
      public function IssueListView(param1:IssueManager, param2:IssueBrowser, param3:IItemListWindow, param4:String)
      {
         ...
         this.var_2120 = this.var_736.createWindow(param4) as IWindowContainer;
      }
      ...
      public function update(param1:Array) : void
      {
         ...
         if(_loc4_ < _loc5_)
         {
            ...
            {
               _loc3_ = this.var_2120.clone() as IWindowContainer;
         ...
         for each(_loc7_ in param1)
         {
            ...
            if(_loc7_ == null || this.var_2120 == null)
            {
               return;
            }
            ...
            if(_loc11_ != null)
            {
               ...
               _loc13_ = this.var_736.assets.getAssetByName(_loc12_) as BitmapDataAsset;
