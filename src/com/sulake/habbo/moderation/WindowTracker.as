package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_1202:int = 3;
      
      public static const const_1028:int = 4;
      
      public static const const_1373:int = 5;
      
      public static const const_2028:int = 6;
      
      public static const const_1858:int = 7;
      
      public static const TYPE_ISSUEHANDLER:int = 8;
      
      public static const const_1935:int = 9;
      ...
      {
         var _loc2_:Dictionary = this.var_2148[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            this.var_2148[param1] = _loc2_;
         }
         return _loc2_;
      }
   }
