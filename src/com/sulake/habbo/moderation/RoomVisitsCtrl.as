package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1070:Array = [];
      
      private static var var_2062:int = 200;
      ...
      {
         this.var_876 = IWindowContainer(this.var_36.getXmlWindow("roomvisits_row"));
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1070.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_876.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_1070.length < var_2062)
         {
            ...
            param1.width = this.var_876.width;
            param1.height = this.var_876.height;
            var_1070.push(param1);
         }
         else
         {
            param1.dispose();
