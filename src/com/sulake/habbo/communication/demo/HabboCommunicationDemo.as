package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_2345:PseudoRandom;
      ...
      private const const_2084:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_627 = param1;
            this.var_62.initConnection(HabboConnectionType.const_271);
         }
      }
      ...
      private function onHabboCommunication(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            this.var_62.addHabboConnectionMessageEvent(new SecretKeyEvent(this.method_7));
      ...
      {
         if(this.var_62 && this.var_153 && this.var_15 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_627 = this.var_153.getKey("sso.ticket",null);
         this.var_1743 = this.var_153.getKey("flash.client.url","");
         this.var_2344 = this.var_153.getKey("external.variables.txt","");
         if(this.var_242 == null)
         {
            this.var_242 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc5_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_884,this.onInitConnection);
            }
            else
            {
               Core.crash("Login without an SSO ticket is not supported",Core.const_1994);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_62.mode = HabboConnectionType.const_1380;
            }
         }
         this.var_62.initConnection(HabboConnectionType.const_271);
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2345 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_62.mode)
         {
            case HabboConnectionType.const_99:
               ...
               this.var_1444 = _loc4_;
               this.var_242.loadBannerImage(_loc7_ + "?token=" + this.var_1444,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1380:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_2015:
               this.var_953 = this.generateRandomHexString(30);
               this.var_521 = new DiffieHellman(new BigInteger(this.var_153.getKey("connection.development.prime"),16),new BigInteger(this.var_153.getKey("connection.development.generator"),16));
               this.var_521.init(this.var_953);
      ...
      private function method_7(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2345);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         this.var_1445 = true;
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_315);
         connection.send(new VersionCheckMessageComposer(401,this.var_1743,this.var_2344));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_2084,"/");
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2343)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1444);
