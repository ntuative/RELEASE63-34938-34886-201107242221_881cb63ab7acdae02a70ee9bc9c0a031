package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_884:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_131.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_163,HabboWindowStyle.const_47,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_2084,"/");
         if(_loc5_ != null)
         {
         ...
         if(_loc8_)
         {
            ...
            {
               if(this.var_131.habboConfiguration.getKey("use.sso","false") == "FlatAccessibleMessageParser")
               {
                  _loc8_.select();
               }
            }
         ...
         if(this.var_131.habboConfiguration && this.var_131.habboConfiguration.getKey("try.existing.session","false") == "FlatAccessibleMessageParser")
         {
            this.var_1521 = true;
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_2084,"/");
         ...
         {
            dispatchEvent(new Event(const_884));
         }
      }
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         {
            this.var_155.removeEventListener(SSOTicket.const_437,this.onParsedTicketSuccess);
            this.var_155.removeEventListener(SSOTicket.const_370,this.onParsedTicketFailure);
            this.var_155 = null;
         }
         var _loc2_:String = "";
         ...
         this.var_155 = new SSOTicket(this.var_131.assets,_loc3_,_loc2_,param1);
         this.var_155.addEventListener(SSOTicket.const_437,this.onParsedTicketSuccess);
         this.var_155.addEventListener(SSOTicket.const_370,this.onParsedTicketFailure);
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         this.var_131.flashClientUrl = this.var_155.flashClientUrl;
         this.var_131.ssoTicket = this.var_155.ticket;
         this.var_155.removeEventListener(SSOTicket.const_437,this.onParsedTicketSuccess);
         this.var_155.removeEventListener(SSOTicket.const_370,this.onParsedTicketFailure);
         this.var_155 = null;
         dispatchEvent(new Event(const_884));
