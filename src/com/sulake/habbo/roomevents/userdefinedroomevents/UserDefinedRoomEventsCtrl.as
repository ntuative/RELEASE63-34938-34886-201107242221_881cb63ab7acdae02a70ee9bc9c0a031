package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private static var var_1690:int = 2;
      ...
      private var var_2181:TriggerConfs;
      
      private var var_2180:ActionTypes;
      
      private var var_2182:ConditionTypes;
      
      private var var_309:Dictionary;
      
      private var var_37:Triggerable;
      
      private var var_916:RoomObjectHightLighter;
      ...
      {
         this.var_2181 = new TriggerConfs();
         this.var_2180 = new ActionTypes();
         this.var_2182 = new ConditionTypes();
         this.var_309 = new Dictionary();
         super();
         this.var_94 = param1;
         this.var_916 = new RoomObjectHightLighter(param1);
      ...
      public function stuffSelected(param1:int, param2:String) : void
      {
         ...
         if(this.var_309[param1])
         {
            ...
            this.var_916.hide(param1);
         }
         else if(this.getStuffIds().length < this.var_37.furniLimit)
         {
            this.var_309[param1] = param2;
            this.var_916.show(param1);
         }
         this.refresh();
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1396 = new SliderWindowController(this.var_94,IWindowContainer(this.find(this.var_57,"delay_slider_container")),this.var_94.assets,0,20,1);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_916.hideAll(this.var_309);
         }
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = this.var_37.stuffTypeSelectionCode < 1 ? int(var_1690) : int(this.var_37.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = (this.var_37.stuffTypeSelectionCode + 1) % (var_1690 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_2181);
         this.refreshConfigureElement(this.var_2180);
         this.refreshConfigureElement(this.var_2182);
