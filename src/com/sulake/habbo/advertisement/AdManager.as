package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_408:AdImageRequest;
      
      private var var_1359:BitmapData = null;
      
      private var var_1357:BitmapData = null;
      ...
      {
         this.var_306 = param2 as IHabboCommunicationManager;
         if(this.var_306 == null)
         {
            return;
         }
         this._connection = this.var_306.getHabboMainConnection(this.onConnectionReady);
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2902 = this._config.getKey("interstitial.enabled","false") == "FlatAccessibleMessageParser";
         this.var_2901 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2904 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_2126 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_2126 > 0 && this.var_2125 >= this.var_2126)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1358;
         if(_loc1_ > this.var_2901)
         {
            ++this.var_2125;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1664 = _loc2_.imageUrl;
         this.var_2903 = _loc2_.clickUrl;
         this.var_1358 = getTimer();
         if(this.var_1664 != "")
         {
            _loc3_ = this.var_1664;
            ...
            {
               this.var_261 = new Timer(this.var_2904,1);
            ...
            this.var_261.start();
            _loc4_ = new URLRequest(this.var_1664);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new InterstitialEvent(InterstitialEvent.const_503,param1.bitmapData,this.var_2903));
            this.var_1358 = getTimer();
         }
         else
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new InterstitialEvent(InterstitialEvent.const_538));
         }
      }
      
      public function showRoomAd(param1:int, param2:int) : void
      {
         this.var_408 = new AdImageRequest(param1,param2);
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         if(this.var_408 != null && _loc2_.imageUrl != "" && _loc2_.clickUrl != "")
         {
            ...
            this.var_408 = new AdImageRequest(this.var_408.roomId,this.var_408.roomCategory,_loc2_.imageUrl,_loc2_.clickUrl);
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_) && this.var_408 != null)
         {
            _loc4_ = this.emulateBackgroundTransparency(_loc3_.bitmapData);
            events.dispatchEvent(new AdEvent(AdEvent.const_610,this.var_408.roomId,this.var_408.roomCategory,_loc4_,_loc2_.assetName,this.var_408.clickURL,this.var_1359,this.var_1357));
            this.var_408 = null;
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1359 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1357 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function loadRoomAdImage(param1:int, param2:int, param3:int, param4:int, param5:String, param6:String) : void
      {
         ...
         var _loc8_:Array = this.var_725.getValue(_loc7_);
         if(_loc8_ == null)
         {
            _loc8_ = new Array();
            this.var_725.add(_loc7_,_loc8_);
         }
         if(_loc8_.length > 0)
         {
         ...
         _loc10_.addEventListener(AssetLoaderEvent.const_41,this.method_11);
      }
      ...
      private function onBillboardImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc2_:AssetLoaderStruct = param1.target as AssetLoaderStruct;
         var _loc3_:Bitmap = _loc2_.assetLoader.content as Bitmap;
         var _loc4_:Array = this.var_725.remove(_loc2_.assetName);
      ...
      private function dispatchImageAsset(param1:BitmapData, param2:int, param3:int, param4:int, param5:int, param6:String, param7:String) : void
      {
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_863,param2,param3,param1,param6,param7,null,null,param4,param5));
         }
      }
      ...
      private function method_11(param1:AssetLoaderEvent) : void
      {
         var _loc4_:* = null;
         var _loc2_:AssetLoaderStruct = param1.target as AssetLoaderStruct;
         var _loc3_:Array = this.var_725.remove(_loc2_.assetName);
