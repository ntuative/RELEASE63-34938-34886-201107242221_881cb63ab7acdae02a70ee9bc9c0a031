package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1711:int = 10;
      
      private static const const_1158:int = 100;
      
      private static const const_1710:int = 20;
       
      
      private var var_152:HabboMessenger;
      
      private var var_2988:IScrollbarWindow;
      
      private var var_2178:IContainerButtonWindow;
      
      private var var_66:IItemListWindow;
      
      private var var_598:Conversation;
      
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_152 = param1;
         this.var_2178 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this.var_66 = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2988 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_1158 + const_1710)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1711;
         param1.invalidate();
      }
      ...
      public function refresh() : void
      {
         ...
         if(this.var_598 == null || _loc1_.id != this.var_598.id)
         {
            this.var_598 = _loc1_;
            this.refreshList();
            this.afterResize();
      ...
      {
         if(this.var_598.followingAllowed)
         {
            this.var_2178.enable();
         }
         else
         {
            this.var_2178.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this.var_66.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_598.messages.length - const_1158);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < this.var_598.messages.length)
         {
            this.refreshEntry(true,_loc1_,this.var_598.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_1029 || param3.type == Message.const_980 ? param3.time + ": " : "";
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc3_["recipientid"] = "" + this.var_598.id;
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_152.send(new FollowFriendMessageComposer(this.var_598.id));
      ...
      private function getChatBgColor(param1:int) : uint
      {
         ...
         if(param1 == Message.const_957)
         {
            return 4293454056;
         }
         if(param1 == Message.const_1026)
         {
            return 4293454056;
         }
         if(param1 == Message.const_1259)
         {
            return 4288269465;
         }
         return 4291611852;
