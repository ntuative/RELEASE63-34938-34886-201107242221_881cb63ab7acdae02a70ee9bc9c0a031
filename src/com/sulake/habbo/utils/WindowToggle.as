package com.sulake.habbo.utils
{
   ...
   public class WindowToggle implements IDisposable
   {
      ...
      public static const const_2043:int = 1;
      ...
      {
         return this.visible && this._window.getStateFlag(WindowState.const_95);
      }
      ...
      public function show() : void
      {
         ...
         {
            if(this._window.parent != this.var_966)
            {
               this.var_966.addChild(this._window);
            }
