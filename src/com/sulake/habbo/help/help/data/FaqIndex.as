package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_844:FaqCategory;
      ...
      {
         super();
         this.var_844 = new FaqCategory(-999,"${help.faq.title.urgent}");
         this.var_845 = new FaqCategory(-9999,"${help.faq.title.normal}");
      ...
      {
         var _loc4_:* = null;
         if(this.var_844.hasItem(param1))
         {
            this.var_844.getItem(param1).answerText = param2;
         }
      ...
      private function findItem(param1:int) : FaqItem
      {
         ...
         if(this.var_844.hasItem(param1))
         {
            return this.var_844.getItem(param1);
         }
         if(this.var_845.hasItem(param1))
         {
