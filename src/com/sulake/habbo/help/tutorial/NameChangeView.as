package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1662:uint = 13232628;
      
      private static var var_2114:uint = 11129827;
      ...
      private var var_1354:NameSuggestionListRenderer;
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_2116 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_891)
         {
            this.var_891 = this.var_27.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_891)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_890)
         {
            this.var_890 = this.var_27.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_890)
            {
               return;
            }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this.var_27.localization.registerParameter("help.tutorial.name.available","name",this.var_590);
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         _loc5_.visible = true;
         this.var_1354 = new NameSuggestionListRenderer(this.var_27);
         var _loc6_:int = this.var_1354.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1662;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_590 = this.var_27.myName;
               this.showConfirmationView();
               break;
            ...
            case "confirm_name_button":
               this.var_27.changeName(this.var_590);
               break;
