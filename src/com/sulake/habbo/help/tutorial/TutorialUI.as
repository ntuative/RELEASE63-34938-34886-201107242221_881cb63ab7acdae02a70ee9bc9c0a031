package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_594:String = "TUI_GUIDEBOT_VIEW";
      ...
      private var var_411:NameChangeView;
      ...
      public function TutorialUI(param1:HabboHelp, param2:Boolean = true)
      {
         ...
         this.var_36.events.addEventListener(HabboHelpTutorialEvent.const_576,this.onTaskDoneEvent);
         this.var_36.events.addEventListener(HabboHelpTutorialEvent.const_629,this.onTaskDoneEvent);
         if(this.var_36.sessionDataManager != null)
         {
            this.var_36.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_338,this.onFigureUpdate);
         }
      }
      ...
      {
         return this.var_1363 && this.var_1362 && this.var_1667;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_36)
         {
            ...
            this.var_36.events.removeEventListener(HabboHelpTutorialEvent.const_576,this.onTaskDoneEvent);
            this.var_36.events.removeEventListener(HabboHelpTutorialEvent.const_629,this.onTaskDoneEvent);
            if(this.var_36.sessionDataManager != null)
            {
               this.var_36.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_338,this.onFigureUpdate);
            }
            this.var_36 = null;
         }
      }
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_674:
               this.var_1667 = true;
               if(this.var_53 != null && this.var_53.id == const_594)
               {
                  this.showView(const_96);
               }
               break;
            case HabboHelpTutorialEvent.const_576:
               if(this.var_53 != null && this.var_53.id == const_425)
               {
                  this.var_2131 = true;
                  this.disposeWindow();
               }
      ...
      public function showView(param1:String) : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_2912 = this._window.width - _loc2_.width;
         ...
         switch(param1)
         {
            ...
            case const_379:
               ...
               if(this.var_411 == null)
               {
                  this.var_411 = new NameChangeView(this);
               }
               this.var_411.showMainView();
               this.prepareForTutorial();
               break;
            case const_425:
         ...
         this._window.height = _loc2_.height + this.var_2911;
         this._window.width = _loc2_.width + this.var_2912;
         if(_loc3_)
         {
            if(this._window == null)
            {
      ...
      public function prepareForTutorial() : void
      {
         ...
         this.var_36.hideUI();
         this.var_36.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_130));
      }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(this.var_53 != null && (this.var_53.id == const_379 || this.var_53.id == const_96))
         {
            this.showView(const_96);
         }
      }
      ...
      {
         this.var_1363 = true;
         if(this.var_53 != null && (this.var_53.id == const_425 || this.var_53.id == const_96))
         {
            this.showView(const_96);
         }
      }
      ...
      public function onChangeUserNameResult(param1:ChangeUserNameResultMessageEvent) : void
      {
         ...
         {
            this.var_411.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
         }
      }
      ...
      public function onCheckUserNameResult(param1:CheckUserNameResultMessageEvent) : void
      {
         ...
         if(_loc2_.resultCode == ChangeUserNameResultMessageEvent.var_508)
         {
            this.var_411.checkedName = _loc2_.name;
         }
         else
         {
            this.var_411.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
