package com.sulake.habbo.help
{
   ...
   public class HabboHelp extends Component implements IHabboHelp
   {
      ...
      private var var_317:IHabboLocalizationManager;
      ...
      private var var_2314:UserRegistry;
      
      private var var_2315:String = "";
      
      private var var_949:WelcomeScreenController;
      
      public function HabboHelp(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_1443 = new CallForHelpData();
         this.var_2314 = new UserRegistry();
      ...
      {
         if(this.var_306 != null && param1 != null)
         {
            this.var_306.getHabboMainConnection(null).send(param1);
         }
      }
      ...
      public function reportUser(param1:int, param2:String) : void
      {
         ...
         this.var_72.showUI(HabboHelpViewEnum.const_431);
      }
      ...
      public function startNameChange() : void
      {
         if(this.var_120)
         {
            this.var_120.showView(TutorialUI.const_379);
         }
      }
      ...
      private function onCommunicationManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._incomingMessages = new IncomingMessages(this,this.var_306);
      ...
      {
         this.var_317 = IHabboLocalizationManager(param2);
      ...
      public function showWelcomeScreen(param1:WelcomeNotification) : void
      {
         if(!this.var_949)
         {
            this.var_949 = new WelcomeScreenController(this,this._windowManager);
         }
         this.var_949.showWelcomeScreen(param1);
      }
