package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_2309:int = "F".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_1096 = param1.gender;
         this.var_895 = param1.online;
         this.var_1769 = param1.followingAllowed && param1.online;
         this.var_727 = param1.figure;
         this.var_1770 = param1.motto;
         this.var_1768 = param1.lastAccess;
         this.var_1691 = param1.categoryId;
