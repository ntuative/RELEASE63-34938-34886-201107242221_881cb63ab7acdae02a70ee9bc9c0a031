package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1544:Point = new Point(110,50);
       
      
      private var _friendList:HabboFriendList;
      
      private var var_1875:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_1875 = new FriendListTabsView(this._friendList);
      }
      ...
      public function openFriendList() : void
      {
         ...
         {
            this.prepare();
            this.var_16.position = const_1544;
         }
         else
         {
      ...
      private function prepare() : void
      {
         ...
         this.var_312 = IWindowContainer(this.var_16.content.findChildByName("footer"));
         this.var_1875.prepare(this.var_952);
         this.var_16.procedure = this.onWindow;
         this.var_16.content.setParamFlag(HabboWindowParam.const_1256,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_1234,true);
         this.var_16.header.setParamFlag(HabboWindowParam.const_948,false);
         this.var_16.header.setParamFlag(HabboWindowParam.const_745,true);
         this.var_16.content.setParamFlag(HabboWindowParam.const_948,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_745,true);
         this.var_16.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1520 = ITextWindow(this.var_16.findChildByName("info_text"));
         this.var_1520.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1874 == -1 ? 0 : int(this.var_16.height - this.var_1874);
         var _loc4_:int = this.var_1873 == -1 ? 0 : int(this.var_16.width - this.var_1873);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_312.y = Util.getLowestPoint(this.var_16.content);
         this.var_312.width = this._friendList.tabs.windowWidth;
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1271,this._friendList.tabs.findSelectedTab() != null);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_948,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1256,false);
         ...
         this.var_1874 = this.var_16.height;
         this.var_1873 = this.var_16.width;
