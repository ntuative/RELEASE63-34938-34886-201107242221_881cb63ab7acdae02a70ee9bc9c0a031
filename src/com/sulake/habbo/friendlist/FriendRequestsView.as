package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_2112:String = "no_reqs_info";
      ...
      private var var_2009:IContainerButtonWindow;
      ...
      {
         this.var_2010 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_2009 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_2009.procedure = this.onDismissAllButtonClick;
         this.var_2010.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         if(param1.state == FriendRequest.const_186)
         {
         ...
         else if(param1.state == FriendRequest.const_1410)
         {
      ...
      public function acceptAllRequests() : void
      {
         ...
         for each(_loc2_ in this._friendList.friendRequests.requests)
         {
            if(_loc2_.state != FriendRequest.const_401 && _loc2_.state != FriendRequest.const_417)
            {
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_2009,_loc1_);
      }
