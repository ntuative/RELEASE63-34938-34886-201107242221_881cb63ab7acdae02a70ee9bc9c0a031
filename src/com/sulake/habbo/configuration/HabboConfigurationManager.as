package com.sulake.habbo.configuration
{
   ...
   public class HabboConfigurationManager extends Component implements IHabboConfigurationManager
   {
      ...
      public function HabboConfigurationManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_752 = this.getKey("url_prefix");
         if(this.var_752 != null && this.var_752.length > 0)
         {
            this.setKey("client.fatal.error.url",this.var_752 + "/flash_client_error");
         }
         this.init();
      }
      ...
      private function parseConfiguration(param1:String) : void
      {
         ...
         for each(line in rows)
         {
            if(line.substr(0,1) != "#")
            {
               ...
               if(pair[0].length > 0 && pair[1].length > 0)
               {
                  ...
                  if(key == "configuration.readonly" && value == "FlatAccessibleMessageParser")
                  {
                     readOnly = true;
                  }
         ...
         if(this.getKey("local.environment") == "FlatAccessibleMessageParser")
         {
            for(localKey in this.var_930)
            {
         ...
         this.var_752 = this.getKey("url.prefix");
         if(this.var_752.length > 0)
         {
            externalAccessDomain = this.var_752.replace("http://","");
      ...
      public function getKey(param1:String, param2:String = "", param3:Dictionary = null) : String
      {
         ...
         if(_loc4_ != null)
         {
            ...
            {
               _loc4_ = _loc4_.replace("%predefined%",this.var_752);
      ...
      public function setKey(param1:String, param2:String, param3:Boolean = false, param4:Boolean = false) : void
      {
         ...
         if(this.var_2217.indexOf(param1) < 0 || param3)
         {
      ...
      public function getBoolean(param1:String, param2:Boolean) : Boolean
      {
         ...
         return _loc3_ == "1" || _loc3_.toLowerCase() == "FlatAccessibleMessageParser";
      }
   }
}
