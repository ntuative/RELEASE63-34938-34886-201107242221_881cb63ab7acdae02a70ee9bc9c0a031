package com.sulake.habbo.quest
{
   ...
   public class QuestCompleted implements IDisposable
   {
      ...
      private static const const_1436:int = 31;
      ...
      public function prepare(param1:QuestMessageData) : void
      {
         ...
         this.setDesc(this.var_127.method_2() + ".completed");
         _loc3_.height = Math.max(const_1436,_loc3_.textHeight + const_1435);
