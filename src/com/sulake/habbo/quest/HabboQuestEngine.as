package com.sulake.habbo.quest
{
   ...
   public class HabboQuestEngine extends Component implements IHabboQuestEngine, IUpdateReceiver
   {
      ...
      private static const const_1469:int = 800;
      
      private static const const_1471:int = 15;
      
      private static const const_1472:int = 300;
      ...
      private var var_1179:QuestController;
      
      private var var_958:AchievementController;
      ...
      public function HabboQuestEngine(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1179 = new QuestController(this);
         this.var_958 = new AchievementController(this);
         ...
         registerUpdateReceiver(this,const_1470);
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_396.events.removeEventListener(BadgeImageReadyEvent.const_214,this.var_958.onBadgeImageReady);
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_396.events.addEventListener(BadgeImageReadyEvent.const_214,this.var_958.onBadgeImageReady);
      }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:Boolean = this._localization.hasKey(param1.method_2() + ".searchtag");
         if(_loc2_)
         {
            _loc3_ = param1.method_2() + ".searchtag";
         }
         else
         {
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_49)
         {
            ...
            {
               this.var_1179.onToolbarClick();
            }
            if(param1.iconId == HabboToolbarIconEnum.ACHIEVEMENTS)
            {
               this.var_958.onToolbarClick();
            }
         }
      }
