package com.sulake.habbo.quest
{
   ...
   public class NextQuestTimer implements IDisposable
   {
      ...
      public static const const_752:int = 1000;
      ...
      private function refresh() : void
      {
         ...
         this._window.findChildByName("quest_header_txt").caption = this.var_51.localization.getKey("quests.nextquesttimer.caption." + (!!this.var_601 ? "expanded" : "contracted"));
      ...
      {
         this._window.findChildByName("quest_timer_expanded").visible = this.var_601;
         this._window.findChildByName("quest_timer_contracted").visible = !this.var_601;
         this._window.findChildByName("more_info_txt").visible = this.var_601 && this.var_51.currentlyInRoom;
         this._window.findChildByName("more_info_region").visible = this.var_601 && this.var_51.currentlyInRoom;
         this._window.findChildByName("quest_pic_bitmap").visible = this.var_601;
         this._window.findChildByName("desc_txt").visible = this.var_601;
         this.refresh();
      }
