package com.sulake.habbo.quest
{
   ...
   public class QuestDetails implements IDisposable
   {
      ...
      private static const const_1505:int = 56;
      
      private static const const_486:int = 5;
      
      private static const const_1435:int = 5;
      
      private static const const_1146:Point = new Point(8,8);
      
      private static const const_1668:Array = ["PLACE_ITEM","PLACE_FLOOR","PLACE_WALLPAPER","PET_DRINK","PET_EAT"];
      ...
      private function openDetails(param1:QuestMessageData) : void
      {
         ...
         if(this._window == null)
         {
            ...
            _loc8_.x = const_1146.x;
            _loc8_.y = const_1146.y;
         ...
         if(!_loc2_)
         {
            ...
            _loc3_.height = _loc3_.textHeight + const_1435;
         }
         _loc3_.visible = !_loc2_;
         var _loc5_:int = this.getTextHeight(_loc3_) - _loc4_;
         var _loc6_:int = this.method_12("link_region",_loc3_.y + _loc3_.height + const_486);
         ...
         this._window.height = _loc8_.height + const_1505;
         this._window.visible = true;
         this._window.activate();
      }
      
      private function method_12(param1:String, param2:int) : int
      {
      ...
      {
         return this.var_127.waitPeriodSeconds < 1 && const_1668.indexOf(this.var_127.type) > -1;
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         this.var_1461 = NextQuestTimer.const_752;
