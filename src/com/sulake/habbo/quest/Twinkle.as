package com.sulake.habbo.quest
{
   ...
   public class Twinkle implements AnimationObject, IDisposable
   {
      ...
      private static const const_1735:int = 100;
      ...
      {
         this.var_1314 = new Point(Math.round(Math.random() * 0),Math.round(Math.random() * 0));
      }
      ...
      {
         var _loc2_:int = param1 - this.var_3035;
         if(_loc2_ < 0)
         {
            return const_1734;
         }
         var _loc3_:int = Math.floor(_loc2_ / const_1735);
