package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_2083:String = "ctlg_";
      ...
      private var var_592:EventDispatcher;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_592 = new EventDispatcher();
      ...
      {
         return this._localization.getLinks(this.var_1369);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1369);
      }
      ...
      {
         var _loc2_:String = const_2083 + param1;
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1957:
               if(this.var_1370 == null)
               {
                  this.var_1370 = new ItemGridCatalogWidget(param1,this._catalog.sessionDataManager);
                  this.var_39.push(this.var_1370);
               }
               break;
            ...
            case CatalogWidgetEnum.const_2012:
               ...
               break;
            case CatalogWidgetEnum.const_1910:
      ...
      private function initializeWidgets() : void
      {
         ...
         this.var_592.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         if(this.var_592 != null)
         {
            return this.var_592.dispatchEvent(param1);
         }
         return false;
      }
