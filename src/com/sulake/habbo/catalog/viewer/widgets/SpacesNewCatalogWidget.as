package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesNewCatalogWidget extends ItemGridCatalogWidget implements IDisposable, ICatalogWidget, IItemGrid
   {
      ...
      override public function init() : Boolean
      {
         ...
         this.switchCategory(this.var_119[this.var_550]);
      ...
      {
         var _loc2_:int = this.var_744[this.var_550];
         var _loc3_:Offer = this.var_219[this.var_550][_loc2_];
      ...
      public function selectIndex(param1:int) : void
      {
         ...
         {
            _loc2_ = this.var_219[this.var_550][param1];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         this.var_744[this.var_550] = (this.var_219[this.var_550] as Array).indexOf(_loc2_);
         this.updateRoomPreview();
      }
      
      private function updateRoomPreview() : void
      {
         var _loc1_:int = this.var_744[0];
         var _loc2_:int = this.var_744[1];
         var _loc3_:int = this.var_744[2];
      ...
      private function createOfferGroups() : Boolean
      {
         ...
         for each(_loc1_ in page.offers)
         {
            ...
            if(!(_loc2_.productType == ProductTypeEnum.const_64 || _loc2_.productType == ProductTypeEnum.const_71))
            {
               continue;
            }
      ...
      private function switchCategory(param1:String) : void
      {
         ...
         if(_loc2_ > -1)
         {
            ...
            page.replaceOffers(this.var_219[this.var_550],false);
            resetTimer();
            populateItemGrid();
            ...
            _loc3_ = this.var_744[this.var_550];
