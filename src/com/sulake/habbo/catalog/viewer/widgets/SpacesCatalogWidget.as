package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1524:String = "default";
      ...
      private var var_1523:String = "1.1";
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1004 = this.parseElements(_loc2_.floors.pattern);
         this.var_1245 = this.parseElements(_loc2_.walls.pattern);
         ...
         for each(_loc3_ in page.offers)
         {
            ...
            {
               case "floor":
                  for(_loc10_ in this.var_1004)
                  {
                     _loc11_ = this.var_1004[_loc10_];
                     if(this.var_664.indexOf(_loc10_) == -1)
                     {
                        this.var_664.push(_loc10_);
                        this.var_1246.push(_loc3_);
                     }
                  }
                  break;
               case "wallpaper":
                  if(this.var_1245[_loc8_] != null)
                  {
         ...
         events.dispatchEvent(new CatalogWidgetUpdateRoomPreviewEvent(this._floorType,this.var_1524,this.var_1523,64));
         return true;
      }
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_wall_color_next":
               ...
               break;
            case "ctlg_buy_wall":
               _loc3_ = this.var_1248[this.var_458];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page.pageId,this.var_1524);
               }
               break;
            ...
            case "ctlg_floor_color_next":
               ...
               break;
            case "ctlg_buy_floor":
               _loc3_ = this.var_1246[this.var_456];
               if(_loc3_ != null)
               {
      ...
      private function updateConfiguration() : void
      {
         ...
         var _loc2_:String = this.var_664[this.var_456];
         var _loc3_:Array = this.var_1004[_loc2_];
         if(_loc3_ != null && this.var_455 >= 0)
         {
            _loc11_ = _loc3_[this.var_455];
            if(_loc11_ != null)
            {
               this._floorType = _loc11_;
            }
         }
         var _loc4_:Offer = this.var_1246[this.var_456];
         if(_loc4_ != null)
         {
         ...
         var _loc5_:String = this.var_809[this.var_458];
         var _loc6_:Array = this.var_1245[_loc5_];
         if(_loc6_ != null && this.var_457 >= 0)
         {
            _loc13_ = _loc6_[this.var_457];
            if(_loc13_ != null)
            {
               this.var_1524 = _loc13_;
            }
         }
         var _loc7_:Offer = this.var_1248[this.var_458];
         if(_loc7_ != null)
         {
         ...
         var _loc8_:String = this.var_810[this.var_454];
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_109:
               ...
               if(this.var_456 < 0)
               {
                  this.var_456 = this.var_664.length - 1;
               }
               if(this.var_456 >= this.var_664.length)
               {
                  this.var_456 = 0;
               }
               this.var_455 = 0;
               this.var_1002 = 0;
               _loc5_ = this.var_664[this.var_456];
               _loc6_ = this.var_1004[_loc5_];
               if(_loc6_ != null)
               {
                  this.var_1002 = _loc6_.length;
               }
            ...
            case const_243:
               ...
               if(this.var_458 < 0)
               {
                  this.var_458 = this.var_809.length - 1;
               }
               if(this.var_458 == this.var_809.length)
               {
                  this.var_458 = 0;
               }
               this.var_457 = 0;
               this.var_1005 = 0;
               _loc7_ = this.var_809[this.var_458];
               _loc8_ = this.var_1245[_loc7_];
               if(_loc8_ != null)
               {
                  this.var_1005 = _loc8_.length;
               }
            ...
            case TYPE_LANDSCAPE:
               ...
               if(this.var_454 < 0)
               {
                  this.var_454 = this.var_810.length - 1;
               }
               if(this.var_454 >= this.var_810.length)
               {
                  this.var_454 = 0;
               }
               this.var_453 = 0;
               this.var_1003 = 0;
               _loc9_ = this.var_810[this.var_454];
               _loc10_ = this.var_1247[_loc9_];
               if(_loc10_ != null)
               {
                  this.var_1003 = _loc10_.length;
               }
