   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid, IDragAndDropDoneReceiver
   {
      ...
      public function ItemGridCatalogWidget(param1:IWindowContainer, param2:ISessionDataManager)
      {
         ...
         if(this._scrollBar != null)
         {
            ...
            this._scrollBar.addEventListener(WindowEvent.const_800,this.activateScrollbar);
            ...
            this._scrollBar.addEventListener(WindowEvent.const_286,this.deActivateScrollbar);
         }
         this.var_33 = param2;
      }
      ...
      protected function loadItemGridGraphics(param1:TimerEvent = null) : void
      {
         ...
         if(_loc2_ > 0)
         {
            ...
            while(_loc3_ < 3)
            {
               if(this.var_841 >= 0 && this.var_841 < _loc2_)
               {
                  _loc4_ = page.offers[this.var_841];
      ...
      {
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_1741) as IWindowContainer;
         ...
         if(param1.pricingModel == Offer.const_569)
         {
            ++this.var_1968;
            (param1.productContainer as BundleProductContainer).setBundleCounter(this.var_1968);
         }
      }
