package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1108.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_1108 = null;
         }
         if(this.var_1107 != null)
         {
            this.var_1107.removeEventListener(WindowKeyboardEvent.const_192,this.windowKeyEventProcessor);
            this.var_1107 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1108 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_1108 != null)
         {
            this.var_1108.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_1107 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_1107 != null)
         {
            this.var_1107.addEventListener(WindowKeyboardEvent.const_192,this.windowKeyEventProcessor);
         }
         return true;
      }
