package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SongDiskProductViewCatalogWidget extends ProductViewCatalogWidget
   {
      ...
      private var var_481:IButtonWindow;
      ...
      {
         super(param1);
         this.var_481 = _window.findChildByName("listen") as IButtonWindow;
         this.var_1209 = _window.findChildByName("ctlg_song_length") as ITextWindow;
         if(this.var_481 != null)
         {
            this.var_481.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickPlay);
            this.var_481.disable();
         }
         this.var_1208 = _window.findChildByName("playPreviewContainer") as IWindowContainer;
      ...
      override public function dispose() : void
      {
         if(this.var_481 != null)
         {
            this.var_481.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickPlay);
         }
         if(this._soundManager != null && this._soundManager.musicController != null)
         {
            this._soundManager.musicController.stop(HabboMusicPrioritiesEnum.const_208);
      ...
      private function onClickPlay(param1:WindowMouseEvent) : void
      {
         if(this._soundManager != null && this._soundManager.musicController != null)
         {
            ...
            this.forceNoFadeoutOnPlayingSong(HabboMusicPrioritiesEnum.const_208);
            this._soundManager.musicController.playSong(this.var_975,HabboMusicPrioritiesEnum.const_208,15,40,0.5,2);
         }
      }
      ...
      private function onSelectProduct(param1:SelectProductEvent) : void
      {
         ...
         {
            this.var_975 = parseInt(_loc2_.extraParam);
            if(this.var_1208 != null)
            {
      ...
      private function updateView() : void
      {
         ...
         if(_loc2_ >= 0)
         {
            ...
            {
               this.var_1209.text = _loc8_;
            }
         }
         else if(this.var_1209 != null)
         {
            this.var_1209.text = "";
         }
         if(this.var_481 != null)
      ...
      private function getSongLength() : int
      {
         ...
         if(this._soundManager != null && this._soundManager.musicController != null)
         {
            _loc1_ = this._soundManager.musicController.getSongInfo(this.var_975);
            if(_loc1_ != null)
            {
               return _loc1_.length / 1000;
            }
            this._soundManager.musicController.requestSongInfoWithoutSamples(this.var_975);
         }
         return -1;
      }
