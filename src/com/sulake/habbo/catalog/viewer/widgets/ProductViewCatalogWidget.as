package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_572:IDisplayObjectWrapper;
      
      private var var_2038:Point;
      
      private var var_573:IItemGridWindow;
      
      private var var_1604:IScrollbarWindow;
      
      protected var var_1741:XML;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1061 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1320 = _window.findChildByName("ctlg_description") as ITextWindow;
         ...
         if(this.var_204 != null)
         {
            ...
            this.var_572 = this.var_204.findChildByName("room_canvas") as IDisplayObjectWrapper;
            _loc3_ = (page.viewer.catalog as HabboCatalog).roomPreviewer;
            if(this.var_572 != null && _loc3_ != null)
            {
               this.var_204.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickRoomView);
               _loc3_.reset();
               _loc4_ = _loc3_.getRoomCanvas(this.var_572.width,this.var_572.height);
               if(_loc4_ != null)
               {
                  this.var_572.setDisplayObject(_loc4_);
               }
            }
            else
            {
         ...
         this.var_2038 = new Point(this.var_100.x,this.var_100.y);
         this.var_573 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1604 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(this.var_573 == null)
         {
            Logger.log("[ProductViewCatalogWidget] Bundle Grid not initialized!");
         }
         var _loc1_:XmlAsset = page.viewer.catalog.assets.getAssetByName("gridItem") as XmlAsset;
         this.var_1741 = _loc1_.content as XML;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(this.var_573 != null)
         {
            this.var_573.visible = false;
            this.var_573.destroyGridItems();
         }
         ...
         this.var_1061.text = _loc4_;
         this.var_1320.text = _loc5_;
         this.var_1061.height = this.var_1061.textHeight + 5;
         this.var_1320.y = this.var_1061.y + this.var_1061.height;
         this.var_1320.height = Math.max(130,this.var_1320.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_569:
                  ...
                  if(this.var_573 != null)
                  {
                     this.var_573.visible = true;
                     _loc11_ = _loc2_.productContainer as BundleProductContainer;
                     _loc11_.populateItemGrid(this.var_573,this.var_1604,this.var_1741);
               ...
               case Offer.const_441:
                  ...
                  if(this.var_204 != null)
                  {
                     if(_loc9_.productType == ProductTypeEnum.const_71 || _loc9_.productType == ProductTypeEnum.const_64 || _loc9_.productType == ProductTypeEnum.const_195)
                     {
                  ...
                  switch(_loc9_.productType)
                  {
                     case ProductTypeEnum.const_71:
                        if(_loc8_ != null && this.var_572 != null)
                        {
                        ...
                        else
                        {
                           ...
                           if(_loc17_.avatarRenderManager != null)
                           {
                              ...
                              if(_loc18_ != null)
                              {
                                 ...
                                 _loc18_.appendAction(AvatarAction.const_327,AvatarAction.const_626);
                                 _loc18_.appendAction(AvatarAction.const_380,_loc9_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2773)
         {
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_100 != null && true)
         {
            ...
            this.var_100.x = this.var_2038.x;
            this.var_100.y = this.var_2038.y;
            if(param3 != null)
            {
