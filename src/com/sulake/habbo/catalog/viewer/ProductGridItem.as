package com.sulake.habbo.catalog.viewer
{
   ...
   public class ProductGridItem implements IGridItem
   {
      ...
      private static const const_1102:String = "bg";
      ...
      {
         this._view.getChildByName(const_1102).style = HabboWindowStyle.const_31;
      }
      
      public function deActivate() : void
      {
         this._view.getChildByName(const_1102).style = 3;
      }
      ...
      public function setDraggable(param1:Boolean) : void
      {
         ...
         {
            (this._view as IInteractiveWindow).setMouseCursorForState(WindowState.const_91,MouseCursorType.const_866);
            (this._view as IInteractiveWindow).setMouseCursorForState(0 | 0,MouseCursorType.const_866);
         }
      }
      ...
      private function eventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _loc3_ = this.var_233.startDragAndDrop(this);
            if(_loc3_)
            {
               this.var_603 = null;
            }
         ...
         else if(param1.type == WindowMouseEvent.const_174)
         {
            this.var_603 = null;
         }
      }
