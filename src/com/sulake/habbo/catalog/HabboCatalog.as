package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener, IUpdateReceiver
   {
      ...
      private var var_1196:IRoomSession;
      ...
      private var var_2723:GiftWrappingConfiguration;
      
      private var var_1311:ClubGiftController;
      
      private var var_570:ClubBuyController;
      
      private var var_701:ClubExtendController;
      
      private var var_862:Map;
      
      private var var_1310:Boolean = false;
      
      private var var_861:IPurchasableOffer;
      ...
      private var var_702:RoomPreviewer;
      
      private const const_2113:Point = new Point(100,20);
      ...
      private function reset(param1:Boolean = false) : void
      {
         ...
         if(!param1)
         {
            ...
            {
               Core.crash("Could not reload product data after reset() because _sessionDataManager was null",Core.const_1903);
               return;
            }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2726 = this.isNewItemsNotificationEnabled();
      ...
      {
         if(this._roomEngine != null && this.var_137 != null && this.var_137.getKey("catalog.furniture.animation","false") == "FlatAccessibleMessageParser")
         {
            if(this.var_702 == null)
            {
               this.var_702 = new RoomPreviewer(this._roomEngine);
            }
         }
      }
      ...
      {
         return this.var_137.getBoolean("toolbar.new_additions.notification.enabled",false);
      }
      ...
      public function openCatalogPage(param1:String, param2:Boolean = false) : void
      {
         ...
         if(!this.var_929 || !this.var_255 || !this.var_255.isInitialized())
         {
            this.toggleCatalog(true);
            this.var_1052 = -1;
            this.var_860 = param1;
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_137.getKey("client.credits.embed.enabled","false") == "FlatAccessibleMessageParser";
         if(false && _loc1_)
         {
         ...
         {
            _loc2_ = this.var_137.getKey("link.format.credits","/credits");
      ...
      {
         var _loc2_:Array = this.var_862.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function createMainWindow() : void
      {
         ...
         if(this.var_137.getBoolean("catalog.show.purse",false))
         {
            _loc1_ = "catalog_with_purse";
         }
         var _loc2_:XmlAsset = assets.getAssetByName(_loc1_) as XmlAsset;
         this._mainContainer = this._windowManager.buildFromXML(_loc2_.content as XML,const_706) as IWindowContainer;
         this._mainContainer.tags.push("habbo_catalog");
         this._mainContainer.position = this.const_2113;
         this.hideMainWindow();
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_69:
               this.var_2023 = param1.session.isPrivateRoom;
               this.var_1196 = param1.session;
               if(this.var_107 != null)
               {
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1311 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubExtendController() : void
      {
         if(this.var_701 == null)
         {
            this.var_701 = new ClubExtendController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_255.openPage(this.var_860);
            this.var_860 = "";
            this.var_1052 = -1;
         }
         else if(this.var_1052 > -1)
         {
            this.var_255.openPageById(this.var_1052,this.var_2024);
            this.var_1052 = -1;
            this.var_2024 = -1;
            this.var_860 = "";
         }
         else if(this.var_1591 && this.var_2726)
         {
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NEW_ITEMS_SHOW));
            this.var_255.loadNewAdditionsPage(this.getLocalizedPageName(CatalogPageName.const_1871));
         }
         else
         {
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2724 && this._soundManager != null)
         {
         ...
         events.dispatchEvent(new PurseEvent(PurseEvent.const_127,this.var_113.credits));
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2725 && this._soundManager != null)
         {
         ...
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_381,_loc2_.amount));
         }
         if(_loc2_.type == ActivityPointTypeEnum.const_1021)
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_374,_loc2_.amount));
         }
         events.dispatchEvent(new PurseUpdateEvent());
      }
      ...
      private function onActivityPoints(param1:IMessageEvent) : void
      {
         ...
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_381,_loc2_.points["null"]));
         }
         if(_loc2_.points["null"] != null)
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_374,_loc2_.points["null"]));
         }
         events.dispatchEvent(new PurseUpdateEvent());
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         this.var_113.isExpiring = _loc2_.responseType == ScrSendUserInfoMessageParser.const_1324 ? true : false;
         this.updatePurse();
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1311.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2723 = new GiftWrappingConfiguration(param1);
      }
      ...
      {
         if(this.var_701 != null && this.var_137.getBoolean("club.membership.extend.promotion.enabled",false))
         {
            this.var_701.onOffer(param1);
         }
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_862.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_862.add(_loc2_.productCode,_loc3_.slice());
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         {
            if(false && "FlatAccessibleMessageParser" == this.var_137.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
            {
               _loc3_ = this.var_137.getKey("link.format.credits");
               if(_loc3_ != "")
               {
                  this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
      ...
      private function noPixelsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         if(param2.type == WindowEvent.const_153)
         {
            _loc3_ = this.var_137.getKey("link.format.pixels");
            if(_loc3_ != "")
            {
               this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
               HabboWebTools.navigateToURL(_loc3_,"habboMain");
      ...
      {
         if(!this.var_137.keyExists("catalog.drag_and_drop") || this.var_137.getKey("catalog.drag_and_drop") != "FlatAccessibleMessageParser")
         {
            return false;
         }
         if(!this.var_1196 || !this.var_1196.isRoomOwner)
         {
            return false;
         }
      ...
      private function updateRoom(param1:String, param2:String) : void
      {
         ...
         var _loc4_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_210);
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(this.var_1310 && param1.type == RoomEngineObjectEvent.const_158)
         {
            this.resetPlacedOfferData(true);
            if(this.var_861 == null || this.var_861.disposed)
            {
               this.resetObjectMover();
               return;
            }
            _loc2_ = param1.category;
            _loc3_ = this.var_861.productContainer.firstProduct;
            _loc4_ = false;
            ...
            this.var_65 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_861);
            ...
            if(this.var_65.roomCategory == this._roomEngine.activeRoomCategory && this.var_65.roomId == this._roomEngine.activeRoomId)
            {
               ...
               switch(param1.category)
               {
                  case FurniCategory.const_378:
                     _loc8_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_210);
                  ...
                  case FurniCategory.const_357:
                     _loc10_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_204);
      ...
      private function retrievePreviewAsset(param1:String, param2:Function) : void
      {
         ...
         var _loc3_:String = this.var_137.getKey("image.library.catalogue.url");
      ...
      public function update(param1:uint) : void
      {
         if(this.var_702 != null)
         {
            this.var_702.updatePreviewRoomView();
         }
      }
   }
}
