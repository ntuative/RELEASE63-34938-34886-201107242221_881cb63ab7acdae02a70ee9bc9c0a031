package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_3112:String = "magic.pixels";
      
      private var var_3113:String = "catalog.page.club";
      ...
      {
         this.openPage(this.var_3112);
      }
      
      private function openClubPage() : void
      {
         this._catalog.openCatalogPage(this.var_3113,true);
      }
