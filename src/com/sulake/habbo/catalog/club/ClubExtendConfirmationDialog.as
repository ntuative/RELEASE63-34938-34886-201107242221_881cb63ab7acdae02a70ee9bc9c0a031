package com.sulake.habbo.catalog.club
{
   ...
   public class ClubExtendConfirmationDialog
   {
      ...
      private static const const_1468:String = "your_price_icon";
      
      private static const const_1465:String = "http://images.habbo.com/c_images/catalogue/vip_extend_tsr.png";
      
      private static const const_1464:String = "image/png";
      
      private static const const_1467:int = 2000;
      
      private static const const_1466:int = 75;
      ...
      public function ClubExtendConfirmationDialog(param1:ClubExtendController, param2:ClubOfferExtendData)
      {
         ...
         this.var_27 = param1;
         this.var_104 = param2;
         this.var_634 = new Vector.<BitmapData>(const_387);
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_631)
         {
            this.var_631.removeEventListener(WindowMouseEvent.const_25,this.onMouseOutLaterRegion);
            this.var_631.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onMouseOverLaterRegion);
            this.var_631 = null;
         }
         if(this.var_633)
         {
         ...
         if(this.var_634)
         {
            ...
            {
               this.var_634[_loc1_].dispose();
               this.var_634[_loc1_] = null;
               _loc1_++;
            }
            this.var_634 = null;
         }
      ...
      public function showConfirmation() : void
      {
         ...
         this.var_631 = this._view.findChildByName("maybe_later_region") as IRegionWindow;
         this.var_633 = this._view.findChildByName("maybe_later_link") as ITextWindow;
         if(!this.var_631 || !this.var_633)
         {
            return;
         }
         this.var_631.addEventListener(WindowMouseEvent.const_25,this.onMouseOutLaterRegion);
         this.var_631.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onMouseOverLaterRegion);
         ...
         _loc4_.height = 144;
         _loc4_.width = 133;
         this.loadAssetFromUrl("club_teaser","club_teaser",const_1465,const_1464,this.onTeaserLoaded);
         ...
         this.var_371 = this._view.findChildByName(const_1468) as IBitmapWrapperWindow;
         ...
         while(_loc8_ < const_387)
         {
            ...
            this.var_634[_loc8_] = _loc10_.clone();
            _loc8_++;
         }
         this.startAnimation();
      }
      ...
      private function onMouseOutLaterRegion(param1:WindowMouseEvent) : void
      {
         if(this.var_633)
         {
            this.var_633.textColor = const_2065;
         }
      }
      ...
      private function onMouseOverLaterRegion(param1:WindowMouseEvent) : void
      {
         if(this.var_633)
         {
            this.var_633.textColor = LINK_COLOR_HOVER;
         }
      }
      ...
      private function startAnimation() : void
      {
         ...
         this.var_778 = new Timer(const_1467);
         this.var_778.addEventListener(TimerEvent.TIMER,this.onAnimationTrigger);
         this.var_778.start();
      }
      ...
      private function setAnimationFrame() : void
      {
         ...
         if(this.var_632 < const_387)
         {
            this.var_371.bitmap = new BitmapData(this.var_371.width,this.var_371.height,true,0);
            this.var_371.bitmap.copyPixels(this.var_634[this.var_632],this.var_634[this.var_632].rect,new Point(0,0));
         }
         else
         {
            Logger.log("Animation frame " + this.var_632);
         }
      }
      
      private function startAnimationFrame() : void
      {
         this.var_442 = new Timer(const_1466,const_387 - 1);
