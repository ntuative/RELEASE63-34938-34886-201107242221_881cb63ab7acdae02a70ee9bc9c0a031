package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener, IDisposable
   {
      ...
      private const const_2125:uint = 4.293848814E9;
      
      private const const_2126:uint = 4.294967295E9;
      
      private const const_1588:uint = 4.291613146E9;
      ...
      public function onIsOfferGiftable(param1:IsOfferGiftableMessageParser) : void
      {
         ...
         if(this.var_1400 != param1.offerId)
         {
            return;
         }
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc6_ != null)
         {
            ...
            _loc6_.addEventListener(WindowKeyboardEvent.const_366,this.onNameInputKeyUp);
         }
         ...
         if(_loc1_.isEnabled)
         {
            ...
            if(_loc12_ != null)
            {
               ...
               _loc12_.addEventListener(WindowEvent.const_455,this.onFreeWrappingUnSelect);
            }
            ...
            this.var_2052 = _loc1_.stuffTypes;
            this.var_922 = _loc1_.boxTypes;
            this.var_921 = _loc1_.ribbonTypes;
            this.var_1401 = this.var_2052[0];
            this.var_424 = this.var_922[0];
            this.var_426 = this.var_921[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         if(this.var_426 < 0)
         {
            this.var_426 = this.var_921.length - 1;
         }
         if(this.var_426 > this.var_921.length - 1)
         {
            this.var_426 = 0;
         }
         if(this.var_424 < 0)
         {
            this.var_424 = this.var_922.length - 1;
         }
         if(this.var_424 > this.var_922.length - 1)
         {
            this.var_424 = 0;
         }
         var _loc1_:int = this.var_922[this.var_424] * 1000 + this.var_921[this.var_426];
         if(this._window == null)
         {
            return;
         }
         ...
         var _loc2_:ImageResult = this._roomEngine.getFurnitureImage(this.var_1401,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc2_ == null)
         {
            return;
         }
         this.var_1698 = _loc2_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         for each(_loc3_ in this.var_2052)
         {
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1401);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_922[this.var_424]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_921[this.var_426]);
         this._catalog.purchaseProductAsGift(this.var_1699,this.var_1400,this.var_1697,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      
      private function onBuyButtonClick(param1:WindowEvent) : void
      {
         this._catalog.purchaseProduct(this.var_1699,this.var_1400,this.var_1697);
         this.dispose();
      }
      ...
      private function onNameInputChange(param1:WindowEvent) : void
      {
         ...
         for each(_loc5_ in this.var_260)
         {
            ...
            if(_loc4_.length >= this.const_2397)
            {
               break;
            }
         }
         this.updateSuggestions(_loc4_);
         this.var_3017 = _loc2_.text;
      }
      ...
      {
         if(this.var_310 == null || !this.var_310.visible)
         {
            return;
         }
         var _loc1_:IItemListWindow = this.var_310.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_310 == null)
         {
            this.var_310 = this._window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(this.var_920 == null)
         {
            this.var_920 = this.createWindow("suggestion_list_item") as IWindowContainer;
         }
         if(this.var_310 == null || this.var_920 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = this.var_310.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_920.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function onSuggestionsMouseOver(param1:WindowEvent) : void
      {
         ...
         var _loc3_:IItemListWindow = this.var_310.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1588;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_2125) : uint(this.const_2126);
      }
      ...
      {
         this.var_1401 = param1.target.id;
         this.updateColorGrid();
         this.updatePreview();
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1401;
               }
            }
            _loc4_++;
         }
