package com.sulake.habbo.catalog.purchase
{
   ...
   public class PlacedObjectPurchaseData implements IDisposable
   {
      ...
      {
         this.var_1400 = param1.offerId;
         this.var_1907 = param1.productContainer.firstProduct.productClassId;
         this.var_1906 = param1.productContainer.firstProduct.productData;
         this.var_681 = param1.productContainer.firstProduct.furnitureData;
         this.var_1697 = param1.productContainer.firstProduct.extraParam;
      }
      
      public function toString() : String
      {
         return [this._roomCategory,this._roomId,this.var_238,this._category,this.var_2083,this._x,this.var_187,this._direction,this.var_1400,this.var_1907].toString();
      }
