package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      {
         return this.var_691 != const_1110;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1967 != RecyclerStatusMessageEvent.const_1404;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_691 == const_478;
      }
      ...
      {
         this.var_691 = const_1109;
         this.var_136 = new Array(const_220);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_1967)
         {
            case RecyclerStatusMessageEvent.const_1961:
               this.var_691 = const_478;
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1176:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_2013:
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_136.length < const_220)
         {
            return false;
         }
         var _loc1_:int = 0;
