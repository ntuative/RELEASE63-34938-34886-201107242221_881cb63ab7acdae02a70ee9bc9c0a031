package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            for each(_loc1_ in this.var_1304)
            {
      ...
      {
         if(this.var_2699 == param1 && this.var_2698 == direction)
         {
      ...
      private function getInstanceMask(param1:int) : IGraphicAsset
      {
         ...
         if(_loc3_ != null)
         {
            if(this.var_1304.indexOf(_loc2_) < 0)
            {
      ...
      private function updateBorderData() : void
      {
         ...
         var _loc3_:int = this.var_564 + 2;
         var _loc4_:int = this.var_697 + 2;
         var _loc5_:int = 0;
      ...
      private function updateTopBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc8_ < _loc3_ - 1)
         {
            if(_loc4_[_loc8_] == false)
            {
               ...
               this.var_698[param2] = ShoreMaskCreatorUtility.getBorderType(_loc6_,_loc7_);
            }
            param2++;
            _loc8_++;
         }
      ...
      private function updateRightBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc10_ < _loc4_ - 1)
         {
            ...
            if(_loc7_[_loc3_ - 1] == false)
            {
               ...
               this.var_698[param2] = ShoreMaskCreatorUtility.getBorderType(_loc5_,_loc6_);
            }
            param2++;
            _loc10_++;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_564 == 0 || this.var_697 == 0)
         {
            ...
            this.var_564 = _loc2_.getNumber(RoomObjectVariableEnum.const_264);
            this.var_697 = _loc2_.getNumber(RoomObjectVariableEnum.const_349);
         }
         this.var_480 = [];
         this.var_698 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_564 * 2 + this.var_697 * 2)
         {
            this.var_480.push(false);
            this.var_698.push(ShoreMaskCreatorUtility.const_83);
            _loc1_++;
         }
      }
      ...
      {
         var _loc1_:int = this.var_564 + 2;
         var _loc2_:int = this.var_697 + 2;
         var _loc3_:* = [];
         var _loc4_:* = null;
         var _loc5_:int = 0;
         var _loc6_:int = 0;
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_80,getSize(param3),this.var_480,this.var_698,assetCollection);
      }
