package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureRoomBrandingVisualization extends FurnitureVisualization
   {
      ...
      private static const const_1485:String = "branded_image";
      
      private static const const_1482:int = 0;
      
      private static const const_1486:int = 1;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc2_)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  this.var_1715 = _loc4_.getNumber(RoomObjectVariableEnum.const_628);
                  this.var_1716 = _loc4_.getNumber(RoomObjectVariableEnum.const_518);
                  this._paramOffsetZ = _loc4_.getNumber(RoomObjectVariableEnum.const_597);
               }
            }
         }
         if(!this.var_1419)
         {
            this.var_1419 = this.checkIfImageReady();
            if(this.var_1419)
            {
               this.checkAndCreateImageForCurrentState(param1);
               return true;
      ...
      protected function checkIfImageChanged() : Boolean
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               _loc3_ = _loc2_.getString(RoomObjectVariableEnum.const_365);
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(this._imageUrl != null && _loc6_ == const_1485)
         {
