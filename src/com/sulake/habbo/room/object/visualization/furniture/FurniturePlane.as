package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlane
   {
      ...
      private var var_777:Vector3d = null;
      ...
      public function FurniturePlane(param1:IVector3d, param2:IVector3d, param3:IVector3d)
      {
         ...
         this.var_323.assign(param2);
         this.var_322 = new Vector3d();
         this.var_322.assign(param3);
         this.var_777 = new Vector3d();
         this.var_777.assign(param2);
         this.var_776 = new Vector3d();
         this.var_776.assign(param3);
      ...
      {
         if(param1 != this.var_2384)
         {
            if(!param1)
            {
               this.var_323.assign(this.var_777);
               this.var_322.assign(this.var_776);
            }
            else
            {
               this.var_323.assign(this.var_777);
               this.var_323.mul(this.var_776.length / this.var_777.length);
               this.var_322.assign(this.var_776);
               this.var_322.mul(this.var_777.length / this.var_776.length);
            }
            this.var_1762 = -1;
            this.var_1462 = this.var_1462 - 1;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         {
            _loc5_ = Number(this.var_323.length * param1.scale);
            _loc6_ = Number(this.var_322.length * param1.scale);
            if(_loc5_ < 1)
            {
               _loc5_ = 1;
            }
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc9_:* = null;
         if(param1 == null || this.var_106 == null && this.var_1178 != null || this.var_323 == null || this.var_322 == null || this._normal == null)
         {
            return false;
         }
         ...
         if(param1.updateId != this.var_1762)
         {
            ...
            if(_loc4_ != null && (_loc4_.x != this.var_1462 || _loc4_.y != this.var_2381 || _loc4_.z != this.var_2382 || param1.scale != this.var_1980))
            {
               this.var_1462 = _loc4_.x;
               this.var_2381 = _loc4_.y;
               this.var_2382 = _loc4_.z;
               ...
               _loc6_ = param1.getScreenPosition(this.var_1178);
               _loc7_ = _loc6_.z;
               _loc8_ = Math.max(this.var_172.z - _loc7_,this.var_130.z - _loc7_,this.var_97.z - _loc7_,this.var_129.z - _loc7_);
               this.var_2383 = _loc8_;
