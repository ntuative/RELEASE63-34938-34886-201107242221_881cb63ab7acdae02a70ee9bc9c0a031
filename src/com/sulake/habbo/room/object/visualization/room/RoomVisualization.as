package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1956:int = 16777215;
      
      public static const const_1784:int = 13421772;
      
      private static const const_1113:int = 16777215;
      
      private static const const_1112:int = 13421772;
      
      private static const const_1114:int = 10066329;
      
      private static const const_1111:int = 10066329;
      
      public static const const_1908:int = 16777215;
      
      public static const const_1924:int = 13421772;
      
      public static const const_1967:int = 10066329;
      ...
      private var var_560:RoomPlaneBitmapMaskParser = null;
      
      private var var_1524:String = null;
      
      private var _floorType:String = null;
      
      private var var_1523:String = null;
      
      private var var_1091:Number = NaN;
      
      private var var_1575:Number = NaN;
      
      private var var_2665:Number = NaN;
      
      private var var_1979:String = null;
      
      private var var_1294:uint = 16777215;
      
      private var var_2664:int = 255;
      
      private var var_2666:int = 255;
      
      private var var_2663:int = 255;
      ...
      private const const_2378:int = 250;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_560 = new RoomPlaneBitmapMaskParser();
         this.var_345["null"] = false;
         this.var_345["null"] = true;
         this.var_345["null"] = true;
         this.var_345["null"] = true;
      }
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         if(!isNaN(this.var_1091))
         {
            this._planeParser.floorThicknessMultiplier = this.var_1091;
         }
         if(!isNaN(this.var_1575))
         {
            this._planeParser.wallThicknessMultiplier = this.var_1575;
         }
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_915);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1396);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_1851)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_79,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this._lastUpdateTime + this.const_2378 && !_loc6_ && !_loc8_)
         {
            return;
         }
         ...
         {
            _loc10_ = 0;
            while(_loc10_ < this.var_391.length)
            {
               _loc11_ = this.var_694[_loc10_];
               _loc12_ = getSprite(_loc11_);
               _loc13_ = this.var_391[_loc10_] as RoomPlane;
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_1981)
                  {
                     _loc14_ = uint(_loc13_.color);
                     _loc15_ = uint((_loc14_ & 255) * this.var_2663 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2666 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2664 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1762)
         {
            this.var_1762 = param1.updateId;
            this.var_847 = null;
            _loc3_ = param1.direction;
            if(_loc3_ != null && (_loc3_.x != this.var_1462 || _loc3_.y != this.var_2381 || _loc3_.z != this.var_2382 || param1.scale != this.var_1980))
            {
               this.var_1462 = _loc3_.x;
               this.var_2381 = _loc3_.y;
               this.var_2382 = _loc3_.z;
               this.var_1980 = param1.scale;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1273);
            ...
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_945));
            if(_loc4_ != this.var_1294)
            {
               this.var_1294 = _loc4_;
               this.var_2663 = this.var_1294 & 255;
               this.var_2666 = this.var_1294 >> 8 & 255;
               this.var_2664 = this.var_1294 >> 16 & 255;
               _loc2_ = true;
            }
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_148 != param1.getUpdateID())
         {
            ...
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_801));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1003));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1032));
      ...
      private function updatePlaneThicknesses(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_148 != param1.getUpdateID())
         {
            ...
            _loc3_ = param1.getNumber(RoomObjectVariableEnum.const_1214);
            if(!isNaN(_loc2_) && !isNaN(_loc3_) && (_loc2_ != this.var_1091 || _loc3_ != this.var_1575))
            {
      ...
      private function updateFloorHoles(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_148 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1173);
            if(!isNaN(_loc2_) && _loc2_ != this.var_2665)
            {
               this.var_2665 = _loc2_;
               this.resetRoomPlanes();
               return true;
            }
         }
      ...
      {
         if(param1 != this.var_345["null"] || param2 != this.var_345["null"] || param3 != this.var_345["null"])
         {
            this.var_345["null"] = param1;
            this.var_345["null"] = param2;
            this.var_345["null"] = param3;
            this.var_391 = [];
            this.var_694 = [];
         }
      }
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_391;
         if(this.var_391.length == 0)
         {
            _loc6_ = this.var_159;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_391.length > 0;
         var _loc9_:int = 0;
         while(_loc9_ < _loc6_.length)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc11_.visible != (_loc12_.visible && this.var_345[_loc12_.type]))
                  {
                  ...
                  if(_loc11_.visible)
                  {
                     if(!_loc8_)
                     {
                        this.var_391.push(_loc12_);
                        this.var_694.push(_loc9_);
                     }
                  }
               }
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1295;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_560.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_560.maskCount)
         {
            _loc10_ = this.var_560.getMaskType(_loc8_);
            _loc11_ = this.var_560.getMaskLocation(_loc8_);
            _loc12_ = this.var_560.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
