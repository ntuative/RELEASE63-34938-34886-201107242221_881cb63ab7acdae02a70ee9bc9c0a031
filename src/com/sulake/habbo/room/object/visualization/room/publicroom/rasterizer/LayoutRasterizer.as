package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_1350:Point = null;
      
      private var var_1639:LayoutRasterizerData = null;
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != this.var_1085)
         {
            ...
            this._adBgIndex = -1;
            this._adImgIndex = -1;
            this.var_1639 = this.var_47.getValue(this.var_1085);
         }
      }
      ...
      public function initialize(param1:XML) : void
      {
         ...
         this.var_2865 = new Vector3d(-0.5,0.5,0);
         this.var_1086 = false;
      }
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(this.var_2865);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
         _loc3_.x = Math.round(_loc3_.x);
         _loc3_.y = Math.round(_loc3_.y);
         this.var_1350.x = _loc3_.x;
         this.var_1350.y = _loc3_.y;
      }
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc3_:LayoutRasterizerData = this.var_47.getValue(this.var_1085);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              this.var_2094 = RoomObjectVariableEnum.const_1320;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              this.var_2094 = RoomObjectVariableEnum.const_1255;
                           }
                           if(param2 != null)
                           {
      ...
      {
         var _loc1_:LayoutRasterizerData = this.var_47.getValue(this.var_1085);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      {
         if(param2 == this.var_2864 && param3 == this.var_2866)
         {
            return;
         }
         ...
         if(param3)
         {
            ...
            _loc5_.tag = RoomObjectVariableEnum.const_666;
         }
         if(param2 != "")
         {
            _loc4_.visible = true;
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = this.var_1639.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         param2.offsetX = int(_loc8_.@x) + _loc9_.offsetX + this.var_1350.x;
         param2.offsetY = int(_loc8_.@y) + _loc9_.offsetY + this.var_1350.y;
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(this.var_489.indexOf(_loc10_) >= 0 && this.var_1086)
            {
               param1 = this.var_489.indexOf(_loc10_);
               if(this.var_717[param1] != "")
               {
                  _loc9_ = this.var_784.getAsset(this.var_717[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
               ...
               if(this.var_718[param1] != -1)
               {
                  param2.alpha = this.var_718[param1];
               }
               this.var_489.splice(param1,1);
               this.var_717.splice(param1,1);
               this.var_718.splice(param1,1);
      ...
      public function exchangeElementGraphics(param1:String, param2:String) : void
      {
         ...
         if(_loc3_ < 0)
         {
            ...
            this.var_717.push(param2);
            this.var_718.push(-1);
         }
         else
         {
            this.var_717[_loc3_] = param2;
         }
      }
