package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      private var var_2104:int = 16777216;
      
      private var var_3106:int = 69069;
      
      private var var_3107:int = 5;
      ...
      {
         var _loc1_:int = this.var_3106 * this.var_2103 + this.var_3107;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_2104;
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_2104 * param2);
      }
   }
}
