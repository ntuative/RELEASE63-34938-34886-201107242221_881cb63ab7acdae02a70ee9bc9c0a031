package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1724:String = "head";
      
      private static const const_734:int = 1;
      
      private static const const_1162:int = 1000;
      
      private static const const_1723:String = "pet_experience_bubble_png";
      
      private static const const_1722:int = 0;
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         if(this._animationData.commonAssets != null)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               this.var_421 = new ExperienceData(_loc2_);
            }
         }
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != this.var_3003)
            {
               this.var_3003 = _loc3_;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc3_.getUpdateID() != var_148)
         {
            ...
            this.var_1825 = _loc3_.getNumber(RoomObjectVariableEnum.const_290) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_213);
            if(!isNaN(_loc8_))
            {
               this.var_2198 = _loc8_;
            }
            else
            {
               this.var_2198 = direction;
            }
            this.var_1518 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2355 = _loc3_.getNumber(RoomObjectVariableEnum.const_419);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_816);
            if(_loc9_ != this.var_2197)
            {
               this.var_2197 = _loc9_;
               this.var_3004 = this.var_2197.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_421 != null)
         {
            ...
            if(this.var_1518 > 0)
            {
               _loc2_ = param1 - this.var_1518;
               if(_loc2_ < const_1162)
               {
                  this.var_421.alpha = int(Math.sin(_loc2_ / const_1162 * 0) * 255);
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc3_.asset = this.var_421.image;
                     _loc3_.offsetX = -20;
                     _loc3_.offsetY = -80;
                     _loc3_.alpha = this.var_421.alpha;
                     _loc3_.visible = true;
                  }
                  else
                  {
      ...
      private function validateActions(param1:String, param2:String) : void
      {
         ...
         if(param1 != this.var_276)
         {
            ...
            this.setAnimationForIndex(const_1722,_loc3_);
         }
         if(param2 != this.var_1500)
         {
      ...
      {
         return super.getAdditionalSpriteCount() + const_734;
      }
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_3004);
         }
         return null;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_734)
         {
            _loc4_ = getSize(param1);
            if(param2 < _loc3_ - (1 + const_734))
            {
               if(param2 >= FurnitureVisualizationData.const_646.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_646[param2];
               if(_loc4_ == 1)
               {
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_2198);
         }
         return direction;
      }
      ...
      private function isHeadSprite(param1:int) : Boolean
      {
         ...
         {
            if(this._animationData.getTag(var_102,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1724)
            {
               this.var_1133[param1] = true;
            }
            else
            {
               this.var_1133[param1] = false;
            }
         }
