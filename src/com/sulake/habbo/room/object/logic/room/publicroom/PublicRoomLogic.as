package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomLogic extends RoomLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectRoomAdEvent.const_234,RoomObjectRoomAdEvent.const_382,RoomObjectRoomAdEvent.const_343];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         _loc2_.setNumber(RoomObjectVariableEnum.const_636,Number(false));
         this.var_929 = true;
      }
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomAdUpdateMessage.const_1347:
                  ...
                  _loc2_.setNumber(RoomObjectVariableEnum.const_636,Number(true));
                  this.var_1663 = getTimer() + _loc2_.getNumber(RoomVariableEnum.const_1220);
            }
         }
      }
      ...
      public function adDelayTimeout() : void
      {
         ...
         _loc1_.setNumber(RoomObjectVariableEnum.const_636,Number(false));
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               if(_loc3_.spriteTag == RoomObjectVariableEnum.const_666)
               {
                  _loc7_ = _loc4_.getString(RoomObjectVariableEnum.const_947);
                  if(_loc7_ != null && _loc7_.indexOf("http") == 0)
                  {
                     eventDispatcher.dispatchEvent(new RoomObjectRoomAdEvent(RoomObjectRoomAdEvent.const_234,_loc5_,_loc6_,_loc7_));
