package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1623:uint = 16777215;
      
      private var var_2065:int = 255;
      
      private var var_1336:uint = 16777215;
      
      private var var_2066:int = 255;
      
      private var var_1335:int = 0;
      
      private var var_2064:int = 1500;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_546,RoomObjectMouseEvent.const_164];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_915,param1.toString());
            _loc2_.setNumber(RoomObjectVariableEnum.const_945,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_801,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_1003,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_1032,1);
         }
      }
         ...
         if(this.var_1624)
         {
            if(object != null)
            {
               ...
               if(_loc2_ != null)
               {
                  ...
                  _loc2_.setString(RoomObjectVariableEnum.const_915,_loc3_.toString());
                  _loc2_.setNumber(RoomObjectVariableEnum.const_1173,param1);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1335)
         {
            ...
            if(_loc2_ - this.var_1335 >= this.var_2064)
            {
               _loc3_ = this.var_1336;
               _loc4_ = this.var_2066;
               this.var_1335 = 0;
            }
            else
            {
               _loc7_ = this.var_1623 >> 16 & 255;
               _loc8_ = this.var_1623 >> 8 & 255;
               _loc9_ = this.var_1623 & 255;
               _loc10_ = this.var_1336 >> 16 & 255;
               _loc11_ = this.var_1336 >> 8 & 255;
               _loc12_ = this.var_1336 & 255;
               _loc13_ = (_loc2_ - this.var_1335) / this.var_2064;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_2065 + (this.var_2066 - this.var_2065) * _loc13_;
               this._color = _loc3_;
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_945,_loc3_);
         }
      }
      ...
      private function updatePlaneTypes(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_760:
               param2.setString(RoomObjectVariableEnum.const_210,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_822:
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_535:
               ...
               this.var_560.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_971:
               _loc4_ = this.var_560.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_560.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1273,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1242:
               param2.setNumber(RoomObjectVariableEnum.const_801,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1336:
               param2.setNumber(RoomObjectVariableEnum.const_1003,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_1032,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomPlanePropertyUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomPlanePropertyUpdateMessage.const_717:
               ...
               break;
            case RoomObjectRoomPlanePropertyUpdateMessage.const_1226:
               param2.setNumber(RoomObjectVariableEnum.const_1214,param1.value);
         }
      }
      ...
      private function updateFloorHoles(param1:RoomObjectRoomFloorHoleUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomFloorHoleUpdateMessage.const_142:
               ...
               this.var_1624 = true;
               break;
            case RoomObjectRoomFloorHoleUpdateMessage.const_173:
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1266,int(param1.bgOnly));
         this.var_1623 = this._color;
         this.var_2065 = this.var_1880;
         this.var_1336 = _loc3_;
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_593,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1753,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1826,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1876,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_593,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_253 || _loc12_ == RoomPlaneData.const_402)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
