package com.sulake.habbo.room.object.logic
{
   ...
   public class PetLogic extends MovingObjectLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_164,RoomObjectMoveEvent.const_407];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(!this.var_2405)
         {
            ...
            if(param1 is RoomObjectAvatarSleepUpdateMessage)
            {
               ...
               _loc2_.setNumber(RoomObjectVariableEnum.const_290,Number(_loc7_.isSleeping));
               return;
            }
         }
         ...
         if(param1 is RoomObjectAvatarExperienceUpdateMessage)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_419,Number(_loc9_.gainedExperience));
            return;
         }
         if(param1 is RoomObjectAvatarFigureUpdateMessage)
         {
            _loc10_ = param1 as RoomObjectAvatarFigureUpdateMessage;
            _loc11_ = _loc2_.getString(RoomObjectVariableEnum.const_223);
            _loc2_.setString(RoomObjectVariableEnum.const_223,_loc10_.figure);
            _loc2_.setString(RoomObjectVariableEnum.const_1759,_loc10_.race);
            _loc2_.setNumber(RoomObjectVariableEnum.const_816,this.getPaletteIndex(_loc10_.figure));
            return;
         }
      }
      ...
      private function debugMouseEvent(param1:RoomSpriteMouseEvent) : void
      {
         ...
         if(!param1.altKey && !param1.ctrlKey)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_213,_loc3_ + this.var_964);
         }
         else if(param1.altKey && !param1.ctrlKey)
         {
            ++this.var_1786;
            _loc2_.setNumber(RoomObjectVariableEnum.const_279,this.var_1786);
            _loc2_.setNumber(RoomObjectVariableEnum.const_150,NaN);
         }
         else if(param1.ctrlKey && !param1.altKey)
         {
            ++this.var_1785;
            _loc2_.setNumber(RoomObjectVariableEnum.const_150,this.var_1785);
         }
         else
         {
            this.var_964 += 45;
