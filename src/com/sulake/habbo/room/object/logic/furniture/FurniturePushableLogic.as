package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurniturePushableLogic extends FurnitureMultiStateLogic
   {
      ...
      private static const const_2089:int = 1;
      ...
      override public function update(param1:int) : void
      {
         if(object != null)
         {
            this.var_1890.assign(object.getLocation());
            super.update(param1);
            if(Vector3d.dif(object.getLocation(),this.var_1890).length == 0)
            {
               if(object.getState(0) != const_1089)
               {
                  object.setState(const_1089,0);
               }
            }
         }
      }
