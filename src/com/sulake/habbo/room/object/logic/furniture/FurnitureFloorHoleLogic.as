package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureFloorHoleLogic extends FurnitureMultiStateLogic
   {
      ...
      {
         if(this.var_1220 == const_470)
         {
            eventDispatcher.dispatchEvent(new RoomObjectFloorHoleEvent(RoomObjectFloorHoleEvent.const_173,object.getId(),object.getType()));
         }
         super.dispose();
      }
      ...
      {
         var _loc1_:Array = [RoomObjectFloorHoleEvent.const_142,RoomObjectFloorHoleEvent.const_173];
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc4_ != this.var_1220)
               {
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(this.var_1220 == const_470)
                     {
                        eventDispatcher.dispatchEvent(new RoomObjectFloorHoleEvent(RoomObjectFloorHoleEvent.const_173,object.getId(),object.getType()));
                     }
                  }
