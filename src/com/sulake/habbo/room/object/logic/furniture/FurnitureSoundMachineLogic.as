package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureSoundMachineLogic extends FurnitureMultiStateLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectFurnitureActionEvent.const_531,RoomObjectFurnitureActionEvent.const_560,RoomObjectFurnitureActionEvent.const_620,RoomObjectFurnitureActionEvent.const_558];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != this.var_1220)
         {
            this.var_1220 = _loc3_;
            if(_loc3_ == 1)
            {
