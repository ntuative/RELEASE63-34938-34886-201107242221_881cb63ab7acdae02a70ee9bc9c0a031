package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      public function PopupCtrl(param1:HabboNavigator, param2:int, param3:int, param4:String)
      {
         ...
         this.var_444.addEventListener(TimerEvent.TIMER,this.onDisplayTimer);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_444)
         {
            this.var_444.removeEventListener(TimerEvent.TIMER,this.onDisplayTimer);
            this.var_444.reset();
            this.var_444 = null;
         }
         if(this.var_374)
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_58 == null)
         {
            this.var_58 = IWindowContainer(this._navigator.getXmlWindow(this.var_1152));
         ...
         this.var_58.x = _loc2_.x + this.var_2401 + param1.width;
