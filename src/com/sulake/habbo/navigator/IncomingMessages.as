package com.sulake.habbo.navigator
{
   ...
   public class IncomingMessages
   {
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.securityLevel >= SecurityLevelEnum.const_1960)
         {
      ...
      {
         if(this._navigator.configuration.getKey("roomenterad.habblet.enabled") == "FlatAccessibleMessageParser" && false)
         {
      ...
      private function onFlatCreated(param1:IMessageEvent) : void
      {
         ...
         this._navigator.mainViewCtrl.reloadRoomList(Tabs.const_308);
      }
      ...
      private function onError(param1:IMessageEvent) : void
      {
         ...
         {
            case -100002:
               this._navigator.passwordInput.method_13();
         }
      }
      ...
      private function onCantConnect(param1:IMessageEvent) : void
      {
         ...
         switch(_loc2_.reason)
         {
            ...
            case CantConnectMessageParser.const_1976:
               ...
               _loc3_.show();
               break;
            case CantConnectMessageParser.const_1765:
