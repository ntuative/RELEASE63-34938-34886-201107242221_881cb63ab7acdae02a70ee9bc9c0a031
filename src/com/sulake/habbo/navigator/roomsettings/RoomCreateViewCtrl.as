package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1356:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_35,80,"g"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_35,74,"h"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_35,416,"o"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_35,352,"p"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_35,304,"q"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_35,336,"r"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_35,748,"u"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_35,438,"v"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_42,540,"t"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_42,512,"w"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_42,396,"x"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_42,440,"y"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_42,456,"z"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_42,208,"0"));
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1356.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_2124 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_2124 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_206 = IWindowContainer(this._navigator.getXmlWindow("roc_create_room"));
         this.var_66 = IItemListWindow(this.var_206.findChildByName("item_list"));
         ...
         this.var_1355 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_206.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
         var _loc4_:Rectangle = Util.getLocationRelativeTo(this.var_206.desktop,this.var_206.width,this.var_206.height);
         this.var_206.x = _loc4_.x;
         this.var_206.y = _loc4_.y;
      }
      
      public function refresh() : void
      {
         this.var_1355.goBackToInitialState();
         this.var_1355.input.textBackgroundColor = 4294967295;
         this.var_1356 = this.var_47[0];
         this.refreshRoomThumbnails();
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_76,HabboWindowStyle.const_31,HabboWindowParam.const_65,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         return Boolean(this.var_1355.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      
      private function getCreateButton() : IButtonWindow
      {
         return IButtonWindow(this.var_206.findChildByName("create_button"));
      }
      
      private function getCancelButton() : IButtonWindow
      {
         return IButtonWindow(this.var_206.findChildByName("back_button"));
      }
      ...
      {
         var _loc2_:String = this.var_1355.getText();
         var _loc3_:String = "model_" + this.var_1356.name;
