package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      private var var_533:RoomPopupCtrl;
      
      private var var_607:IScrollbarWindow;
      
      private var var_1223:UserCountRenderer;
      ...
      public function GuestRoomListCtrl(param1:HabboNavigator)
      {
         ...
         this.var_533 = new RoomPopupCtrl(this._navigator,5,-5);
         this.var_1223 = new UserCountRenderer(this._navigator);
      }
      ...
      public function set content(param1:IWindowContainer) : void
      {
         ...
         this.var_607 = IScrollbarWindow(this.var_206.findChildByName("scroller"));
      }
      ...
      public function refresh() : void
      {
         ...
         this.var_206.findChildByName("no_rooms_found").visible = _loc1_.length < 1;
      }
      ...
      private function getListEntry(param1:int) : IWindowContainer
      {
         ...
         _loc2_.setParamFlag(HabboWindowParam.const_1757,true);
      ...
      public function refreshEntryDetails(param1:IWindowContainer, param2:GuestRoomData) : void
      {
         ...
         this.var_1223.refreshUserCount(param2.maxUserCount,param1,param2.userCount,"${navigator.usercounttooltip.users}",233,2);
      }
      ...
      private function onMouseOver(param1:WindowEvent) : void
      {
         ...
         if(this.var_533.visible && this.var_2438)
         {
            return;
         }
         ...
         this.var_533.room = _loc4_;
         this.var_533.showPopup(_loc2_);
      }
      ...
      private function hilite(param1:IWindowContainer) : void
      {
         ...
         {
            _loc2_ = this.var_1498.tags[0];
            this.var_1498.color = this.getBgColor(_loc2_);
         }
      ...
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         ...
         var _loc3_:int = Math.abs(this.var_2437 - _loc2_.stageX);
         this.var_2437 = _loc2_.stageX;
         this.var_2438 = _loc3_ > 2;
      }
   }
}
