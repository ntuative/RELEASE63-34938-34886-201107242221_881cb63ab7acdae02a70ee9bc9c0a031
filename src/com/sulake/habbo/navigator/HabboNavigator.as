package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_358:MainViewCtrl;
      
      private var var_749:RoomInfoViewCtrl;
      
      private var var_1409:RoomCreateViewCtrl;
      ...
      private var var_2959:RoomThumbnailRenderer;
      
      private var var_1124:GuestRoomPasswordInput;
      
      private var var_340:GuestRoomDoorbell;
      
      private var var_1410:OfficialRoomEntryManager;
      
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_3038 = new Array();
         ...
         this.var_358 = new MainViewCtrl(this);
         this.var_749 = new RoomInfoViewCtrl(this);
         this.var_1409 = new RoomCreateViewCtrl(this);
         this.var_2959 = new RoomThumbnailRenderer(this);
         this.var_1124 = new GuestRoomPasswordInput(this);
         this.var_340 = new GuestRoomDoorbell(this);
         this.var_503 = new Tabs(this);
         this.var_1410 = new OfficialRoomEntryManager(this);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_322,HabboWindowStyle.const_47,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_49)
         {
            ...
            {
               this.var_358.onNavigatorToolBarIconClick();
            }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = this.var_137.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_358.startSearch(Tabs.const_246,Tabs.const_644,param1);
         this.trackNavigationDataPoint("Search","search.tag",param1);
         this.var_358.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_358.startSearch(Tabs.const_245,Tabs.const_308);
         this.var_503.getTab(Tabs.const_245).tabPageDecorator.tabSelected();
      }
