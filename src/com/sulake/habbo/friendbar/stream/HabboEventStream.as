package com.sulake.habbo.friendbar.stream
{
   ...
   public class HabboEventStream extends AbstractView implements IHabboEventStream
   {
      ...
      private static const const_1286:String = "badge";
      
      private static const CLOSE:String = "close";
      
      private static const const_1161:String = "open_settings";
      
      private static const const_1159:String = "close_settings";
      
      private static const const_732:String = "settings";
      
      private static const const_731:String = "check_stream";
      
      private static const const_1716:String = "see_more";
      
      private static const const_1720:uint = 0;
      
      private static const const_2127:uint = 1;
      
      private static const const_1455:uint = 4293519841;
      
      private static const const_1454:uint = 4292467926;
      
      private static const const_733:int = -2;
      
      private static const const_1721:int = -3;
      
      private static const const_1160:int = 42;
      
      private static const const_1717:int = 60000;
      
      private static const const_1718:int = 30000;
      
      private static const const_1719:String = "friendbar.stream.";
      ...
      private var var_740:Vector.<EventStreamEntity>;
      ...
      private var var_2994:IHabboFriendBarView;
      
      private var var_1131:Boolean;
      
      private var var_1694:Vector.<int>;
      
      private var var_1693:Boolean = false;
      
      private var var_2992:Array;
      
      private var var_2993:Array;
      
      private var var_1692:Map;
      
      public function HabboEventStream(param1:HabboFriendBar, param2:uint, param3:IAssetLibrary)
      {
         this.var_1694 = new Vector.<int>();
         this.var_2992 = ["friend_made","room_liked","achievement_earned","motto_changed","room_decorated"];
         this.var_2993 = ["no_link","open_mini_profile","visit_room","open_achievements","open_motto_changer","friend_request"];
         this.var_1692 = new Map();
         super(param1,param2,param3);
         this.var_740 = new Vector.<EventStreamEntity>();
         ...
         this.var_1692.add("m","his");
         this.var_1692.add("f","her");
         if(!this.var_739)
         {
            this.var_739 = new Timer(const_1718);
            this.var_739.addEventListener(TimerEvent.TIMER,this.onRefreshTimerEvent);
            this.var_739.start();
         }
      }
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            this._window.x = this._window.desktop.width - (this._window.width + const_1721);
            this._window.y = const_733;
            this._window.height = this._window.desktop.height - (const_733 + const_1160);
            this._window.activate();
            this.requestEventStreamData(this.var_2185);
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            {
               this.var_741.stop();
               this.var_741.removeEventListener(TimerEvent.TIMER,this.onMinuteTimerEvent);
               this.var_741 = null;
            }
            if(this.var_739)
            {
               this.var_739.stop();
               this.var_739.removeEventListener(TimerEvent.TIMER,this.onRefreshTimerEvent);
               this.var_739 = null;
            }
            while(this.var_740.length > 0)
            {
               this.var_740.pop().dispose();
            }
            if(false)
            {
            ...
            EventStreamEntity.var_2226 = null;
      ...
      {
         var _loc1_:IItemListWindow = this._window.findChildByName(const_721) as IItemListWindow;
      ...
      public function populate(param1:Vector.<EventStreamData>) : void
      {
         ...
         if(this.visible)
         {
            ...
            _loc2_ = this.var_740.length % 2 == 0;
            _loc4_ = this._window.findChildByName(const_721) as IItemListWindow;
            _loc5_ = 0;
            for each(_loc6_ in param1)
            {
               ...
               _loc3_.window.color = !!_loc2_ ? uint(const_1455) : uint(const_1454);
               this.var_740.push(_loc3_);
               _loc4_.addListItem(_loc3_.window);
               _loc2_ = !_loc2_;
               if(this.var_1694.indexOf(_loc6_.id) == -1)
               {
                  _loc5_++;
                  this.var_1694.push(_loc6_.id);
               }
            }
            if(param1.length == 0)
            {
            ...
            _loc8_ = _loc7_.getListItemByName(const_1286);
         ...
         else
         {
            ...
            {
               if(this.var_1694.indexOf(_loc9_.id) == -1)
               {
                  this.var_1693 = true;
                  break;
               }
      ...
      private function resolveMessageText(param1:EventStreamData) : String
      {
         ...
         var _loc3_:String = "friendbar.stream.type." + this.var_2992[_loc2_];
         var _loc4_:ILocalization = var_317.getLocalization(_loc3_);
         if(!_loc4_)
         {
            return _loc3_;
         }
         ...
         switch(_loc2_)
         {
            case EventStreamData.const_660:
               _loc5_ = _loc5_.replace("%targetString%",param1.extraDataStruct.friendName);
               break;
            case EventStreamData.const_849:
               _loc5_ = _loc5_.replace("%targetString%",param1.extraDataStruct.roomName);
               break;
            case EventStreamData.const_888:
               _loc5_ = _loc5_.replace("%targetString%",var_317.getAchievementName(param1.extraDataStruct.achievementCode));
               break;
            case EventStreamData.const_1182:
               _loc6_ = var_317.getLocalization(const_1719 + this.var_1692.getValue(param1.accountGender));
               _loc5_ = _loc5_.replace("%gender%",_loc6_.value);
               _loc5_ = _loc5_.replace("%targetString%",param1.extraDataStruct.motto);
               break;
            case EventStreamData.const_1754:
         }
         return _loc5_;
      }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:String = "friendbar.stream.link." + this.var_2993[param1.linkTargetType];
         var _loc4_:int = 0;
         var _loc5_:* = 0;
         var _loc6_:* = null;
         var _loc7_:ILocalization = var_317.getLocalization(_loc2_);
         _loc3_ = !!_loc7_ ? _loc7_.raw : "";
         switch(param1.linkTargetType)
         {
            case EventStreamData.const_1978:
               _loc4_ = 0;
               _loc3_ = "";
               break;
            case EventStreamData.const_1203:
               _loc3_ = _loc3_.replace("%targetString%",param1.extraDataStruct.friendName);
               _loc4_ = 0;
               _loc5_ = uint(param1.extraDataStruct.friendId);
               break;
            case EventStreamData.const_1916:
               _loc4_ = 0;
               _loc5_ = uint(param1.extraDataStruct.roomId);
               break;
            case EventStreamData.const_1877:
               _loc4_ = 0;
               break;
      ...
      private function setupUserInterface() : void
      {
         ...
         if(!this._window)
         {
            ...
            this._window.height = this._window.desktop.height - (const_733 + const_1160);
            this._window.setParamFlag(WindowParam.const_376);
            this._window.setParamFlag(WindowParam.const_300);
            ...
            this._window.findChildByName(const_1161).addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMouseClick);
            this._window.findChildByName(const_1159).addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMouseClick);
            this._window.visible = false;
            _loc1_ = IWindowContainer(this._window.findChildByName(const_732));
            _loc1_.visible = !this.var_1131;
            _loc1_.procedure = this.settingsEventProc;
            ISelectableWindow(_loc1_.findChildByName(const_731)).isSelected = this.var_1131;
            _loc2_ = this._window.findChildByName(const_721) as IItemListWindow;
            _loc3_ = _loc2_.removeListItemAt(0) as IWindowContainer;
            EventStreamEntity.name_6 = _loc3_;
            EventStreamEntity.var_2226 = var_317;
            EventStreamEntity.ASSETS = assets;
            if(!this.var_741)
            {
               this.var_741 = new Timer(const_1717);
               this.var_741.addEventListener(TimerEvent.TIMER,this.onMinuteTimerEvent);
               this.var_741.start();
            }
         }
      }
      ...
      private function onMouseClick(param1:WindowMouseEvent) : void
      {
         switch(param1.target.name)
         {
            case CLOSE:
               ...
               break;
            case const_1161:
               this._window.findChildByName(const_732).visible = true;
               break;
            case const_1159:
               this._window.findChildByName(const_732).visible = false;
         }
      }
      ...
      private function settingsEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowEvent.const_455)
         {
            switch(param2.name)
            {
               case const_731:
      ...
      private function requestEventStreamData(param1:uint) : void
      {
         ...
         {
            this._connection.send(new GetEventStreamComposer(param1 == const_1720 ? 0 : int(GetEventStreamComposer.const_1947)));
            this.var_929 = true;
      ...
      private function onEventStreamEvent(param1:EventStreamEvent) : void
      {
         ...
         this.var_2994.setStreamIconNotify(!this.visible && this.var_1693);
      }
      ...
      private function testEventStream(param1:int = 1) : void
      {
         ...
         while(_loc3_ < param1)
         {
            _loc2_.push(new EventStreamData(_loc3_,EventStreamData.const_660,String(_loc3_ * 1000),"FooBar" + _loc3_,"m","http://d63.varoke.net/habbo-imaging/badge/b1003Xs05175s05173s091145ec244dcc5eaf54aaabf367665f39c67.gif",_loc3_,EventStreamData.const_1203,new TestMessageWrapper(["1234","Friend\'s friend" + _loc3_])));
            _loc3_++;
         }
      ...
      {
         this.var_2994 = param2 as IHabboFriendBarView;
      }
      ...
      {
         this.var_1131 = param1.getParser().streamPublishingAllowed;
         Logger.log("Stream events allowed " + this.var_1131);
      }
