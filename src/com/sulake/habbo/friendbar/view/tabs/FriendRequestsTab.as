package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendRequestsTab extends Tab
   {
      ...
      protected static const const_2063:String = "friend_requests_tab_xml";
      ...
      protected static const const_2061:String = "badge_counter";
      
      protected static const const_2062:String = "button_accept_all";
      
      protected static const const_2060:String = "click_area_discard_all";
      
      protected static const const_1431:String = "button_close";
      
      protected static const const_2064:String = "button_accept";
      
      protected static const const_1037:String = "click_area_discard";
      
      protected static const const_1422:String = "text_discard";
      
      private static var var_1450:FriendRequestsTab;
      
      private static const const_77:uint = 4294625561;
      
      private static const const_1057:uint = 4294957414;
      
      private static const const_1455:uint = 4289431312;
      
      private static const const_1454:uint = 4290616362;
      ...
      {
         var _loc2_:FriendRequestsTab = !!var_1450 ? var_1450 : new FriendRequestsTab();
         _loc2_.var_169 = false;
         _loc2_._requests = param1;
         _loc2_._window.findChildByName(const_2061).caption = String(param1.length);
         return _loc2_;
      }
               ...
               if(_loc2_)
               {
                  ...
                  if(!this.var_1748)
                  {
                     ...
                     if(_loc3_)
                     {
                        ...
                        {
                           _loc4_ = this.var_1176.clone() as IWindowContainer;
                           _loc4_.color = _loc8_ % 2 == 0 ? uint(const_1455) : uint(const_1454);
      ...
      {
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_2063).content as XML) as IWindowContainer;
         ...
         this.var_1176 = _loc7_.removeListItemAt(0) as IWindowContainer;
         return _loc1_;
      }
      ...
      private function bubbleEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(param2.name == const_1037)
            {
               ITextWindow(IWindowContainer(param2).getChildByName(const_1422)).textColor = const_1453;
            }
         }
      }
