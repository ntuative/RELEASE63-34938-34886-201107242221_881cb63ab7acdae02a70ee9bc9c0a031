package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendRequestTab extends FriendEntityTab
   {
      ...
      protected static const const_2066:String = "friend_request_tab_xml";
      ...
      {
         var _loc3_:* = null;
         var _loc2_:FriendRequestTab = !!var_1450 ? var_1450 : new FriendRequestTab();
      ...
      {
         var _loc6_:* = null;
         var _loc1_:IWindowContainer = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_2066).content as XML) as IWindowContainer;
         ...
         var _loc7_:IRegionWindow = WINDOWING.create("ICON",WindowType.const_368,WindowStyle.const_106,WindowParam.const_30,new Rectangle(0,0,25,25)) as IRegionWindow;
         _loc7_.mouseThreshold = 0;
         var _loc8_:IBitmapWrapperWindow = WINDOWING.create("BITMAP",WindowType.const_411,WindowStyle.const_106,WindowParam.const_33,new Rectangle(0,0,25,25)) as IBitmapWrapperWindow;
