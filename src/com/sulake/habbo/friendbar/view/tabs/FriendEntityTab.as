package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendEntityTab extends Tab
   {
      ...
      private static const const_1645:String = "entity_xml";
      
      private static const const_1643:String = "facebook_piece_xml";
      
      private static const const_1644:String = "controls_piece_xml";
      ...
      protected static const const_1434:String = "facebook";
      
      protected static const const_1433:String = "controls";
      ...
      protected static const const_1043:String = "icon_message";
      
      protected static const const_1432:String = "btn_visit";
      
      protected static const ICON:String = "icon";
      
      protected static const const_1038:String = "label";
      
      protected static const const_566:String = "notification";
      
      private static const const_77:uint = 10338138;
      
      private static const const_1057:uint = 13891476;
      
      private static const const_1140:String = null;
      
      private static const const_715:String = "icon_tag_notify";
      
      private static const const_1646:String = "icon_tag_message";
      ...
      private static function purgeEntityPieces(param1:IWindowContainer) : void
      {
         ...
         var _loc4_:* = [];
         _loc2_.groupListItemsWithTag(const_566,_loc4_);
         if(_loc4_.length > 0)
         {
      ...
      override public function select(param1:Boolean) : void
      {
         ...
         if(!selected)
         {
            ...
            {
               _loc3_ = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1643).content as XML) as IWindowContainer;
               _loc3_.name = const_1434;
               _loc6_ = _loc3_.getChildByName(const_703) as ITextWindow;
               _loc6_.caption = this.friend.realName;
               if(!_loc6_.wordWrap)
               {
                  var_2244.crop(_loc6_);
               }
            ...
            {
               _loc3_ = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1644).content as XML) as IWindowContainer;
               ...
               _loc8_ = _loc3_.getChildByName(const_1432);
               if(_loc8_)
               {
      ...
      {
         super.expose();
         _window.color = !!exposed ? uint(const_1057) : uint(const_77);
      ...
      protected function refresh() : void
      {
         ...
         if(this.var_168)
         {
            ...
            _loc1_ = IItemListWindow(_window.getChildByName(const_1042)).getListItemByName(const_469) as IWindowContainer;
            _loc1_.findChildByName(const_703).caption = this.var_168.name;
            var_2244.crop(_loc1_.getChildByName(const_703) as ITextWindow);
            _loc2_ = IBitmapWrapperWindow(_loc1_.findChildByName(const_317));
            _loc2_.bitmap = var_507.getAvatarFaceBitmap(this.var_168.figure);
      ...
      {
         var _loc1_:IWindowContainer = false ? const_483.pop() : WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1645).content as XML) as IWindowContainer;
      ...
      private function onButtonClick(param1:WindowMouseEvent) : void
      {
         if(!disposed && !recycled)
         {
            switch(param1.window.name)
            {
               case const_1069:
               case const_1043:
                  this.removeNotificationToken(FriendNotification.const_457,true);
                  if(var_361 && this.var_168)
                  {
                     var_361.startConversation(this.var_168.id);
                     this.deselect(true);
                     if(param1.window.name == const_1043)
                     {
      ...
      public function addNotificationToken(param1:FriendNotification, param2:Boolean) : void
      {
         ...
         var _loc5_:String = const_1140;
         switch(param1.typeCode)
         {
            case FriendNotification.const_1240:
            ...
            case FriendNotification.TYPE_ACHIEVEMENT:
               _loc4_ = new AchievementToken(this.friend,param1,param2,var_2249);
               _loc4_.iconElement.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onMouseClick);
               _loc5_ = const_715;
               break;
            case FriendNotification.const_1263:
               _loc4_ = new QuestToken(this.friend,param1,param2,var_2249);
               _loc4_.iconElement.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onMouseClick);
               _loc5_ = const_715;
               break;
            case FriendNotification.const_457:
               _loc4_ = new MessengerToken(this.friend,param1,param2);
               _loc4_.iconElement.name = const_1043;
