package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      private const const_2358:int = 5;
      ...
      public function BadgesModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:ISessionDataManager)
      {
         ...
         this.var_396 = param5;
         this.var_396.events.addEventListener(BadgeImageReadyEvent.const_214,this.onBadgeImageReady);
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_396.events.removeEventListener(BadgeImageReadyEvent.const_214,this.onBadgeImageReady);
            this.var_396 = null;
         }
      }
      ...
      private function stopWearingBadge(param1:Badge) : void
      {
         ...
         {
            if(this.var_768[_loc2_] == param1)
            {
               this.var_768.splice(_loc2_,1);
      ...
      public function updateBadge(param1:String, param2:Boolean, param3:int = 0) : void
      {
         ...
         if(param3 > 0)
         {
            this.var_1168.add(param1,param3);
         }
         ...
         else
         {
            ...
            _loc10_ = this.var_625.indexOf(param3) != -1;
      ...
      public function saveBadgeSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_351);
         var _loc3_:int = 0;
      ...
      public function forceSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_498);
         ...
         var _loc3_:Array = this.getBadges(const_351);
      ...
      {
         return this.getItemInIndex(param1,const_351);
      }
      
      public function getBadgeFromInactive(param1:int) : Badge
      {
         return this.getItemInIndex(param1,const_498);
      }
      ...
      {
         if(param1 == InventoryCategory.const_216 && this.var_27.isVisible)
         {
      ...
      public function addUnseenBadges(param1:Array) : void
      {
         ...
         {
            if(this.var_625.indexOf(_loc2_) == -1)
            {
               this.var_625.push(_loc2_);
            }
         }
      }
      ...
      public function resetUnseenItems() : void
      {
         ...
         if(this.var_625 && this.var_625.length > 0)
         {
            _loc1_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_1286));
            this.var_625 = [];
