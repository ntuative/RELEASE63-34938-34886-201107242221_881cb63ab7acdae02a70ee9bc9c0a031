package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1522:IThumbListDataProvider;
      
      private var var_250:int;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         this.var_105 = this.var_662.height;
         this.var_1243 = param5;
         this.var_1000 = param6;
         this.var_250 = Math.floor(this.var_1243 / this._thumbWidth);
         this.var_28 = new BitmapData(this.var_1243,this.var_1000);
      }
      ...
      public function updateImageFromList() : void
      {
         ...
         this.var_28 = new BitmapData(Math.max(this.var_250 * this._thumbWidth,this.var_1243),Math.max(this.var_663 * this.var_105,this.var_1000),true,16777215);
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == this.var_250 && this.var_28.height < _loc3_.y * this.var_105)
         {
         ...
         _loc4_ = new Rectangle(0,0,this._thumbWidth * (this.var_250 - 1),this.var_105);
         _loc2_.copyPixels(this.var_28,_loc4_,new Point(this._thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(this._thumbWidth * (this.var_250 - 1),0,this._thumbWidth,this.var_28.height);
         _loc2_.copyPixels(this.var_28,_loc4_,new Point(0,this.var_105),null,null,true);
         _loc4_ = new Rectangle(0,this.var_105,this._thumbWidth * (this.var_250 - 1),this.var_28.height - this.var_105);
      ...
      private function getList() : Array
      {
         ...
         {
            _loc1_ = this.var_1522.getDrawableList();
         }
      ...
      private function resolveRowCountFromList() : int
      {
         ...
         return int(Math.ceil(_loc1_.length / this.var_250));
      }
      ...
      {
         var _loc2_:Point = this.resolveGridLocationFromImage(param1);
         return int(_loc2_.y * this.var_250 + _loc2_.x);
      }
      ...
      {
         var _loc2_:int = Math.floor(param1 / this.var_250);
         var _loc3_:int = param1 % this.var_250;
         return new Point(_loc3_,_loc2_);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         var _loc4_:int = this.var_250 - param1.x - 1;
