package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private var var_2099:IWindowContainer;
      
      private var var_883:String;
      
      private var var_2876:IWindowContainer;
      ...
      private const const_2113:Point = new Point(120,150);
      ...
      {
         return !!this.var_16 ? Boolean(this.var_16.getStateFlag(WindowState.const_95)) : false;
      }
      ...
      public function showInventory() : void
      {
         ...
         _loc1_.visible = true;
         this.var_27.inventoryViewOpened(this.var_883);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true, param3:Boolean = false) : void
      {
         ...
         {
            if(param3 && this.var_406 != null && this.var_406 != param1)
            {
               this.setViewToCategory(param1);
               return;
            }
            _loc4_.visible = true;
            _loc4_.activate();
            if(param1 != this.var_406 || !this.var_27.isInventoryCategoryInit(param1))
            {
               this.setViewToCategory(param1);
            }
      ...
      public function updateSubCategoryView() : void
      {
         ...
         this.setSubViewToCategory(this.var_883);
      }
      ...
      private function resetUnseenCounters(param1:String) : void
      {
         switch(param1)
         {
            ...
            case InventoryCategory.const_125:
               ...
               break;
            case InventoryCategory.const_216:
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         {
            this.resetUnseenCounters(this.var_406);
         }
         ...
         _loc2_.container.removeChild(this.var_2099);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_406 == InventoryCategory.const_125)
            {
               this.toggleCategoryView(InventoryCategory.const_125);
            }
            else if(this.var_406 == InventoryCategory.const_78)
            {
      ...
      private function updateUnseenBadgeCount() : void
      {
         if(!this.var_2098)
         {
            this.var_2098 = this.createCounter("badges");
         }
         var _loc1_:int = this.var_27.badgesModel.getUnseenItemCount();
         this.updateCounter(this.var_2098,_loc1_);
