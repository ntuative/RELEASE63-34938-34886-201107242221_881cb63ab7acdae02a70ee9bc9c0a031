package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniGridView
   {
      ...
      public function FurniGridView(param1:FurniModel, param2:String, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         if(this._view != null)
         {
            this.var_233 = this._view.findChildByName("item_grid") as IItemGridWindow;
         }
      }
      ...
      {
         this.var_233.removeGridItem(param1);
         this.var_233.addGridItemAt(param1,param2);
      }
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_44)
         {
            ...
            this.var_78.toggleItemSelection(this._category,this.var_233.getGridItemIndex(param1.window));
            this.var_603 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_25 && this.var_603 != null && this.var_603 == param2 && !this.var_78.isTradingOpen)
         {
