   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_15 != null)
         {
            ...
            this.var_15.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_572,this.roomSessionEventHandler);
      ...
      public function get furniModel() : FurniModel
      {
         ...
         return FurniModel(this.var_64.getValue(InventoryCategory.const_78));
      }
      ...
      public function get tradingModel() : TradingModel
      {
         ...
         return TradingModel(this.var_64.getValue(InventorySubCategory.const_350));
      }
      ...
      public function get effectsModel() : EffectsModel
      {
         ...
         return EffectsModel(this.var_64.getValue(InventoryCategory.const_149));
      }
      ...
      public function get badgesModel() : BadgesModel
      {
         ...
         return BadgesModel(this.var_64.getValue(InventoryCategory.const_216));
      }
      ...
      public function get recyclerModel() : RecyclerModel
      {
         ...
         return RecyclerModel(this.var_64.getValue(InventorySubCategory.const_1230));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_64.getValue(InventoryCategory.const_409) as MarketplaceModel;
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_15.events.addEventListener(RoomSessionPropertyUpdateEvent.const_572,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_86:
               ...
               break;
            case RoomSessionPropertyUpdateEvent.const_572:
               if(this.petsModel != null)
               {
                  this.petsModel.updatePetsAllowed();
               }
      ...
      private function initInventory() : void
      {
         ...
         this.var_64.add(InventoryCategory.const_409,_loc1_);
         ...
         this.var_64.add(InventoryCategory.const_149,_loc4_);
         ...
         this.var_64.add(InventorySubCategory.const_350,_loc5_);
         ...
         this.var_64.add(InventorySubCategory.const_1230,_loc6_);
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = this.var_1045.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_1045.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_1045.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
