package com.sulake.habbo.inventory
{
   ...
   public class ItemPopupCtrl
   {
      ...
      private static const const_1477:int = 250;
      
      private static const const_1476:int = 100;
      
      private static const const_1478:int = 180;
      
      private static const const_1479:int = 200;
      ...
      {
         this.var_373 = new Timer(const_1477,1);
         this.var_372 = new Timer(const_1476,1);
         super();
         if(param1 == null)
         {
            return;
         ...
         this.var_372.addEventListener(TimerEvent.TIMER,this.onHideTimer);
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_372.removeEventListener(TimerEvent.TIMER,this.onHideTimer);
            this.var_372.stop();
            this.var_372 = null;
         }
         this._assets = null;
      ...
      public function updateContent(param1:IWindowContainer, param2:String, param3:BitmapData, param4:int = 2) : void
      {
         ...
         if(_loc6_)
         {
            _loc7_ = new BitmapData(Math.min(const_1478,param3.width),Math.min(const_1479,param3.height),true,16777215);
      ...
      public function show() : void
      {
         ...
         this.refreshArrow(this.var_1775);
         switch(this.var_1775)
         {
            case const_1372:
               this.var_93.x = -1 * this.var_93.width - const_1063;
               break;
            case const_532:
               this.var_93.x = this._parent.width + const_1063;
         }
      ...
      private function refreshArrow(param1:int = 2) : void
      {
         ...
         switch(param1)
         {
            case const_1372:
               ...
               _loc2_.y = (this.var_93.height - this.var_962.height) / 2;
            ...
            case const_532:
               ...
               _loc2_.y = (this.var_93.height - this.var_781.height) / 2;
