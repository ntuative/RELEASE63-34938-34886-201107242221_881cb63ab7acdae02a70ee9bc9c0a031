package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_943:int = 0;
      
      protected var var_761:BitmapData;
      
      protected var var_2416:int;
      
      protected var var_1721:Boolean;
      
      protected var var_2279:Boolean;
      
      protected var var_3067:BitmapData;
      
      private var var_1598:Boolean;
      
      private const const_2114:Number = 1;
      
      private const const_2115:Number = 0.2;
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2277 == FurniModelCategory.const_39)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1491));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2278);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_2115;
               _loc1_.blend = this.const_2115;
            }
            else
            {
               this._window.blend = this.const_2114;
               _loc1_.blend = this.const_2114;
            }
         }
         this.var_1549.color = !!this.var_1598 ? uint(const_1574) : uint(const_1575);
         this.var_2578.visible = this.isSelected;
