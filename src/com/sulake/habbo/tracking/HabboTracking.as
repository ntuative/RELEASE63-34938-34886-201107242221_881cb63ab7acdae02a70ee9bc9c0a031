package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_1080:uint = 11;
      ...
      private var var_278:PerformanceTracker = null;
      
      private var var_450:FramerateTracker = null;
      
      private var var_277:LatencyTracker = null;
      
      private var var_660:LagWarningLogger = null;
      
      private var var_449:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_278 = new PerformanceTracker();
         this.var_450 = new FramerateTracker();
         this.var_277 = new LatencyTracker();
         this.var_660 = new LagWarningLogger();
         this.var_449 = new ToolbarClickTracker(this);
         this.var_1514 = new Array(const_1080);
         var _loc4_:int = 0;
         while(_loc4_ < const_1080)
         {
            this.var_1514[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1880,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1951,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1791,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_781,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1249,String(0));
         }
         ...
         if(!disposed)
         {
            ...
            if(this._navigator)
            {
               if(!this._navigator.disposed)
               {
                  ...
                  this._navigator.events.removeEventListener(HabboNavigatorEvent.const_336,this.onZoomToggle);
               }
            ...
            if(this.var_217)
            {
               if(!this.var_217.disposed)
               {
                  ...
                  Component(this.var_217).events.removeEventListener(HabboFriendListTrackingEvent.const_533,this.onFriendlistTrackingEvent);
               }
            ...
            if(this._roomEngine)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomObjectRoomAdEvent.const_234,this.onRoomAdClick);
            ...
            {
               this.var_328.stop();
               this.var_328.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
               this.var_328 = null;
            }
      ...
      {
         this.var_1514[param2] = param1;
      }
      
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_137 = IHabboConfigurationManager(param2);
         if(this.var_137)
         {
            if(this.var_277 != null)
            {
               this.var_277.configuration = this.var_137;
            }
            if(this.var_278 != null)
            {
               this.var_278.configuration = this.var_137;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_1979);
            if(this.var_137)
            {
               if(this.var_660 != null)
               {
                  this.var_660.configure(this.var_137);
               }
               if(this.var_450 != null)
               {
                  this.var_450.configure(this.var_137);
               }
               if(this.var_449 != null)
               {
                  this.var_449.configure(this.var_137);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_315,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_1025,this.onHotelViewEvent);
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboCommunicationEvent.const_796:
               this.trackLoginStep(HabboLoginTrackingStep.const_1944,String(this._communication.port));
               break;
            case HabboCommunicationEvent.const_315:
               this.trackLoginStep(HabboLoginTrackingStep.const_315);
               break;
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_137)
            {
               if(this.var_137.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = this.var_137.getKey("client.fatal.error.url");
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1514)
                  {
                  ...
                  if(this.var_278 != null)
                  {
                     _loc4_["null"] = this.var_278.flashVersion;
                     _loc4_["null"] = this.var_278.averageUpdateInterval;
                  }
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1363);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1363,this.onCoreRunning);
         }
      }
      ...
      private function onNavigatorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._navigator.events.addEventListener(HabboNavigatorEvent.const_336,this.onZoomToggle);
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_217).events.addEventListener(HabboFriendListTrackingEvent.const_533,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_533:
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1249,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_781,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_234,this.onRoomAdClick);
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_335.events.addEventListener(AdEvent.const_610,this.onRoomAdLoad);
      }
      ...
      private function onRoomAction(param1:RoomEngineEvent) : void
      {
         if(param1.type == RoomEngineEvent.const_194)
         {
            if(this.var_1858 < 1)
            {
               if(!this.var_328)
               {
                  this.var_328 = new Timer(60000,1);
                  this.var_328.addEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
                  this.var_328.start();
               }
            }
         }
         ...
         if(!disposed)
         {
            if(this._connection)
            {
               if(this.var_450)
               {
                  ...
                  this.trackEventLog("Performance","fps",String(this.var_450.frameRate),_loc2_);
                  ++this.var_1858;
               }
            }
         }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_449)
         {
            this.var_449.track(param1.iconName);
         }
      }
      ...
      private function onZoomToggle(param1:HabboNavigatorEvent) : void
      {
         if(this.var_449)
         {
            this.var_449.track(param1.type);
         }
      }
      ...
      {
         if(this.var_137 != null && !Boolean(this.var_137.getKey("processlog.enabled")))
         {
            return;
         }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_539 > -1 && _loc2_ < this.var_539)
         {
            ++this.var_1859;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1859);
         }
         if(this.var_539 > -1 && _loc2_ - this.var_539 > 15000)
         {
            ++this.var_1857;
         ...
         if(this.var_278 != null)
         {
            this.var_278.update(param1,this.var_539);
         }
         if(this.var_277 != null)
         {
            this.var_277.update(param1,this.var_539);
         }
         if(this.var_450 != null)
         {
            this.var_450.trackUpdate(param1,this,this.var_539);
         }
         if(this.var_660 != null)
         {
            this.var_660.update(this.var_539);
         }
      }
   }
}
