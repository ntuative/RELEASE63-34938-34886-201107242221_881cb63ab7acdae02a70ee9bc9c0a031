package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1362:String = "AssetLibraryReady";
      
      public static const const_981:String = "AssetLibraryLoaded";
      
      public static const const_2004:String = "AssetLibraryUnloaded";
      
      public static const const_1938:String = "AssetLibraryLoadError";
      
      private static const const_703:String = "name";
      
      private static const const_1104:String = "asset";
      
      private static const const_1106:String = "param";
      
      private static const TYPE:String = "mimeType";
      
      private static const const_1105:String = "library";
      
      private static var var_338:Dictionary;
      
      private static var var_1933:LazyAssetProcessor = new LazyAssetProcessor();
      
      private static var var_556:uint = 0;
      
      private static var var_1029:Array = new Array();
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         this.var_557 = new Dictionary(false);
         this.var_1030 = new Dictionary(false);
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         var _loc5_:XMLList = param2.child(const_1105);
         if(_loc5_ == null)
         {
         ...
         if(_loc5_ != null)
         {
            _loc5_ = _loc5_.child(const_1104);
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc11_ = _loc6_.child(const_1106);
                  if(_loc11_.length())
                  {
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_1029.splice(var_1029.indexOf(this),1);
            --var_556;
            this.var_557 = null;
            this.var_1030 = null;
            this.var_183 = null;
      ...
      {
         if(this.var_686 == param1.url && this.var_1032)
         {
            if(!this.var_1031 && param2)
            {
      ...
      public function unload() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for(_loc1_ in this.var_557)
         {
            _loc2_ = this.var_557[_loc1_];
            _loc2_.assetLoader.dispose();
            delete this.var_557[_loc1_];
         }
         for(_loc1_ in this.var_183)
         {
            delete this.var_183[_loc1_];
         }
         for(_loc1_ in this.var_1030)
         {
         ...
         this.var_1032 = false;
         this.var_686 = null;
         dispatchEvent(new Event(AssetLibrary.const_2004));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_1030[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_557[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1178,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1217,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1192,this.assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         this.var_557[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_557[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE:
               ...
               if(decl != null)
               {
                  ...
                  {
                     ++this.var_472;
                     this.var_474.push(struct.assetName);
                  }
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_557[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         return param1 < this.var_474.length ? this.getAssetByName(this.var_474[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_183)
         {
            ...
            {
               return this.var_474.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_183[param1] != null || (this.var_685 != null ? this.var_685[param1] != null : false);
      }
      ...
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         ...
         if((param3 || _loc4_) && param2)
         {
            ...
            {
               var_1933.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in this.var_183)
            {
               if(this.var_183[_loc2_] == param1)
               {
                  this.var_474.splice(this.var_474.indexOf(_loc2_),1);
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         if(param2)
         {
            if(var_338.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_338[param1.mimeType] = param1;
         }
         else
         {
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            _loc3_ = AssetTypeDeclaration(var_338[param1]);
            if(_loc3_ != null)
            {
               return _loc3_;
            }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc4_ in var_338)
            {
               _loc3_ = AssetTypeDeclaration(var_338[_loc4_]);
               if(_loc3_ != null)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc5_ in var_338)
            {
               _loc4_ = AssetTypeDeclaration(var_338[_loc5_]);
               if(_loc4_ != null)
               {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1938));
         this.var_44 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this._manifest.child(const_1105);
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            _loc2_ = _loc2_.child(const_1104);
            if(_loc2_ != null)
            {
               _loc5_ = null;
               ...
               while(_loc8_ < _loc7_)
               {
                  ...
                  if(_loc3_.attribute(const_703) && _loc3_.attribute(const_703).toString() == param1)
                  {
                     ...
                     _loc6_ = _loc3_.child(const_1106);
