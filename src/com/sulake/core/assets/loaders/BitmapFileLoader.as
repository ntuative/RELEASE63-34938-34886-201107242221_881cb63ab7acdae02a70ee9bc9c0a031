package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      {
         super();
         this.var_1156 = param2 == null ? "" : param2.url;
         this._type = param1;
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_364 < var_3058)
            {
               ...
               this.var_44.load(new URLRequest(this.var_1156 + (this.var_1156.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_364),this.var_1157);
               return true;
            }
         }
         return false;
