package com.sulake.core.runtime
{
   ...
   public final class CoreComponentContext extends ComponentContext implements ICore
   {
      ...
      private static const const_1635:String = "asset-libraries";
      
      private static const const_1636:String = "library";
      
      private static const const_1633:String = "service-libraries";
      
      private static const const_1634:String = "library";
      
      private static const const_1631:String = "component-libraries";
      
      private static const const_1637:String = "library";
      
      private static const const_1638:String = "error_data";
      
      private static const const_1632:String = "error_cat";
      
      private static const const_1630:String = "error_desc";
       
      
      private var var_404:LibraryLoaderQueue;
      
      private var var_881:IEventDispatcher;
      ...
      public function CoreComponentContext(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         switch(param2 & 0)
         {
            ...
            case Core.const_766:
               ...
               var_434.addChild(new ProfilerViewer(this.var_229));
               break;
            case Core.const_574:
      ...
      override public function error(param1:String, param2:Boolean, param3:int = -1, param4:Error = null) : void
      {
         if(param4)
         {
            ErrorReportStorage.setParameter(const_1638,String(param4.getStackTrace()));
         }
         ErrorReportStorage.setParameter(const_1632,String(param3));
         ErrorReportStorage.setParameter(const_1630,param1);
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         this.var_881 = loadingEventDelegate;
         if(this.var_404 == null)
         {
         ...
         try
         {
            node = config.child(const_1635)[0];
            if(node != null)
            {
               list = node.child(const_1636);
         ...
         try
         {
            node = config.child(const_1633)[0];
            if(node != null)
            {
         ...
         try
         {
            node = config.child(const_1631)[0];
            if(node != null)
            {
               list = node.child(const_1637);
               for each(item in list)
               {
                  url = item.attribute("url").toString();
                  loader = new LibraryLoader(context,true,_debug);
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         this.error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1400);
         if(!disposed)
         {
      ...
      private function finalizeLoadingEventDelegate() : void
      {
         if(this.var_881)
         {
            this.var_881.dispatchEvent(new Event(Event.COMPLETE));
         }
      }
      ...
      private function updateLoadingProgress(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(this.var_881)
         {
            ...
            this.var_881.dispatchEvent(new LibraryProgressEvent(_loc2_.url,param1.bytesLoaded,param1.bytesTotal,_loc2_.elapsedTime));
         }
      }
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(!disposed)
               {
                  if(this.var_881)
                  {
                     this.var_881.dispatchEvent(new LibraryProgressEvent(_loc2_.url,this.var_583 - this.var_404.length,this.var_583,_loc2_.elapsedTime));
                  }
               }
            }
         }
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:int = !!this.var_229 ? 0 : this.var_1634 & 0;
         if(_loc3_ == Core.const_574)
         {
      ...
      private function complexFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         while(priority < CoreComponentContext.const_108)
         {
            ...
            {
               if(this.var_712[priority] < priority)
               {
                  ++this.var_712[priority];
                  skip = true;
               }
            }
            if(!skip)
