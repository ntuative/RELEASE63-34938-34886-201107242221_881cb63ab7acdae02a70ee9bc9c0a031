package com.sulake.core.window.graphics
{
   ...
   public class BitmapSkinParser
   {
      ...
      public static const const_107:String = "default";
      ...
      protected static function parseLayout(param1:ISkinRenderer, param2:XML, param3:Dictionary, param4:Map) : void
      {
         ...
         var _loc6_:* = param2.attribute("transparent") == "FlatAccessibleMessageParser";
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         _loc5_.colorize = _loc6_ == "" ? true : _loc6_ == "FlatAccessibleMessageParser";
         _loc6_ = null;
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_362 = SkinLayoutEntity.const_571;
                  break;
               case "move":
                  _loc5_.var_362 = SkinLayoutEntity.const_356;
                  break;
               case "strech":
                  _loc5_.var_362 = SkinLayoutEntity.const_638;
                  break;
               case "tiled":
                  _loc5_.var_362 = SkinLayoutEntity.const_345;
                  break;
               case "center":
                  _loc5_.var_362 = SkinLayoutEntity.const_651;
            }
            ...
            switch(_loc6_.toLowerCase())
            {
               case "fixed":
                  ...
                  break;
               case "move":
                  _loc5_.var_359 = SkinLayoutEntity.const_356;
                  break;
               case "strech":
                  _loc5_.var_359 = SkinLayoutEntity.const_638;
                  break;
               case "tiled":
                  _loc5_.var_359 = SkinLayoutEntity.const_345;
                  break;
               case "center":
                  _loc5_.var_359 = SkinLayoutEntity.const_651;
            }
         }
