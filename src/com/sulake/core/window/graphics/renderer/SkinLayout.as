package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinLayout extends ChildEntityArray implements ISkinLayout
   {
      ...
      public function SkinLayout(param1:String, param2:Boolean, param3:String, param4:IChildEntityArray)
      {
         ...
         this.var_230 = 0;
         this._height = 0;
         this.var_2782 = param3;
         this.var_3057 = param2;
      ...
      public function isFixedWidth() : Boolean
      {
         ...
         while(_loc2_ < _loc1_)
         {
            if(SkinLayoutEntity(getChildAt(_loc2_)).var_362 != SkinLayoutEntity.const_571)
            {
               return false;
            }
            _loc2_++;
      ...
      public function isFixedHeight() : Boolean
      {
         ...
         while(_loc2_ < _loc1_)
         {
            if(SkinLayoutEntity(getChildAt(_loc2_)).var_359 != SkinLayoutEntity.const_571)
            {
               return false;
            }
            _loc2_++;
