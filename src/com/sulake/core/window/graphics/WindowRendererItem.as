package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private static const const_707:uint = 0;
      
      private static const const_1119:uint = 1;
      
      private static const const_1118:uint = 2;
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         ...
         var _loc5_:uint = !!param1.background ? uint(const_1118) : uint(const_707);
         var _loc6_:Boolean = this.var_202.width > 0 && this.var_202.height > 0;
         var _loc7_:ISkinRenderer = this.resolveSkinRenderer(param1);
         if(_loc7_ != null)
         {
            if(_loc7_.isStateDrawable(this.var_1053))
            {
               _loc5_ = const_1119;
            }
         }
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc5_ == const_1119)
               {
                  ...
                  if(this.var_703)
                  {
                     ...
                     _loc7_.draw(param1,this.var_138,this.var_138.rect,this.var_1053,false);
                  }
                  if(param1.blend < 1 && param1.testParamFlag(WindowParam.const_33))
                  {
                     this.var_1159.tx = param2.x;
                     this.var_1159.ty = param2.y;
                     this.var_893.alphaMultiplier = param1.blend;
                     param3.offset(param2.x,param2.y);
                     _loc4_.draw(this.var_138,this.var_1159,this.var_893,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
      ...
      {
         return this._skinContainer.getTheActualState(param1.type,param1.style,param1.state) != this.var_1593;
      }
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.const_773:
               this.var_1053 = this._skinContainer.getTheActualState(param1.type,param1.style,param1.state);
               if(this.var_1053 != this.var_1593)
               {
                  this.var_703 = true;
                  _loc4_ = true;
               }
               break;
            case WindowRedrawFlag.const_1417:
               if(param1.testParamFlag(WindowParam.const_33))
               {
                  this.var_703 = true;
                  _loc4_ = true;
               ...
               break;
            case WindowRedrawFlag.const_1405:
               _loc4_ = true;
         }
         if(_loc4_)
         {
