package com.sulake.core.window.utils
{
   ...
   public class WindowRectLimits implements IRectLimiter
   {
      ...
      private var var_332:int = 2.147483647E9;
      ...
      {
         this.var_332 = param1;
         if(this.var_332 < int.MAX_VALUE && !this._target.disposed && this._target.width > this.var_332)
         {
      ...
      {
         return this.var_329 == int.MIN_VALUE && this.var_332 == int.MAX_VALUE && this.var_330 == int.MIN_VALUE && this.var_331 == int.MAX_VALUE;
      }
      
      public function setEmpty() : void
      {
         this.var_329 = int.MIN_VALUE;
         this.var_332 = int.MAX_VALUE;
      ...
      public function limit() : void
      {
         if(!this.isEmpty && this._target)
         {
            ...
            else if(this._target.width > this.var_332)
            {
               this._target.width = this.var_332;
            }
