package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      public function MouseEventProcessor()
      {
         ...
         {
            var_368 = new Array();
            var_368[0] = MouseCursorType.const_347;
            var_368[1] = MouseCursorType.const_31;
            var_368[2] = MouseCursorType.const_347;
            var_368[3] = MouseCursorType.const_347;
            var_368[4] = MouseCursorType.const_347;
            var_368[5] = MouseCursorType.const_31;
            var_368[6] = MouseCursorType.const_347;
         }
         if(var_320 == null)
         {
            var_320 = new Array();
            var_320[0] = WindowState.const_95;
            var_320[1] = WindowState.const_92;
            var_320[2] = WindowState.const_91;
            var_320[3] = WindowState.const_75;
            var_320[4] = WindowState.const_57;
            var_320[5] = WindowState.const_97;
            var_320[6] = WindowState.const_88;
         }
      }
      ...
      protected static function convertMouseEventType(param1:MouseEvent, param2:IWindow, param3:IWindow) : WindowMouseEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_UP:
               ...
               _loc4_ = !!_loc6_ ? "null" : WindowMouseEvent.const_296;
               break;
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this.var_71 = state.var_1416 as WindowController;
         this.var_193 = state.var_1414 as WindowController;
         this.var_174 = state.renderer;
         this.var_942 = state.var_1413;
         eventQueue.begin();
         this.var_760.x = -1;
         this.var_760.y = -1;
         ...
         while(true)
         {
            ...
            if(event.stageX != this.var_760.x || event.stageY != this.var_760.y)
            {
               this.var_760.x = event.stageX;
               this.var_760.y = event.stageY;
               array = new Array();
               this.var_96.groupParameterFilteredChildrenUnderPoint(this.var_760,array,WindowParam.const_30);
         ...
         state.var_1416 = this.var_71;
         state.var_1414 = this.var_193;
         state.renderer = this.var_174;
         state.var_1413 = this.var_942;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent, param3:Boolean = false) : WindowController
      {
         ...
         if(param1.testParamFlag(WindowParam.const_648))
         {
