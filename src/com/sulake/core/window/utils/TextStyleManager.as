package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      private static const const_1640:String = "/*";
      
      private static const const_1639:String = "*/";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_101[const_232],var_101[ITALIC],var_101[BOLD]];
            var_101.reset();
            var_101[const_232] = _loc5_[0];
      ...
      public static function parseCSS(param1:String) : Array
      {
         ...
         for each(_loc7_ in _loc3_)
         {
            ...
            _loc6_.kerning = !!_loc5_.kerning ? _loc5_.kerning == "FlatAccessibleMessageParser" : null;
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_713);
         if(countSubStrings(param1,const_714) != countSubStrings(param1,const_713))
         {
            throw new Error("Mismatching amount of \"" + const_714 + "\" versus \"" + const_713 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1640) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1639) + 2,_loc5_.length);
            }
