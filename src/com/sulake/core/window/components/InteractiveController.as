package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      {
         if(param1.toolTipCaption != PropertyDefaults.const_677)
         {
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_677)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_927,param1.toolTipCaption,PropertyStruct.const_54,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1773);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_1401)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_739,param1.toolTipDelay,PropertyStruct.const_266,true));
         }
         else
         {
