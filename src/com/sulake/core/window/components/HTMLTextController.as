package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_1001:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private var var_1884:StyleSheet = null;
      ...
      {
         this.var_808 = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      {
         return this.var_808 == LinkTarget.const_31 ? defaultLinkTarget : this.var_808;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_17);
            _field.styleSheet = this.var_1884;
            refreshTextImage();
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_808 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_829,this.var_808,PropertyStruct.const_54,true,PropertyDefaults.const_931));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1864);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_829)
            {
               this.var_808 = _loc2_.value as String;
               break;
            }
