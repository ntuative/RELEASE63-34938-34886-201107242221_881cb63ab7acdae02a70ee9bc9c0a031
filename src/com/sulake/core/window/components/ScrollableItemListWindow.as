package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1384:IItemListWindow;
      
      private var var_502:IScrollbarWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_502)
         {
            this.var_502.removeEventListener(WindowEvent.const_275,this.scrollBarEventProc);
            this.var_502.removeEventListener(WindowEvent.const_286,this.scrollBarEventProc);
            this.var_502 = null;
         }
         if(this.var_1384)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1384)
         {
            this.var_1384 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_502)
         {
            this.var_502 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_502)
            {
               this.var_502.addEventListener(WindowEvent.const_275,this.scrollBarEventProc);
               this.var_502.addEventListener(WindowEvent.const_286,this.scrollBarEventProc);
            }
         }
         return this.var_502;
      }
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_286)
         {
            this.hideScrollBar();
         }
      }
