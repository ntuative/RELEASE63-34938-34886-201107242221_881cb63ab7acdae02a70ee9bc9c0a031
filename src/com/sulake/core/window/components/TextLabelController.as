package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      private var var_397:Object = null;
      ...
      protected function get textField() : TextField
      {
         ...
         if(_loc1_)
         {
            ...
            {
               _loc1_.textColor = uint(this.var_397);
            }
         }
         return _loc1_;
      }
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         this.var_2734 = _loc2_.textWidth;
         this.var_2733 = _loc2_.textHeight;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_397 != _loc2_.color : this.var_397 != null && this.var_397 != PropertyDefaults.const_798) ? new PropertyStruct(PropertyDefaults.const_432,this.var_397,PropertyStruct.const_147,true) : PropertyDefaults.const_1337);
         if(this.var_42)
         {
            if(this.var_42.left != PropertyDefaults.const_738)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_278,this.var_42.left,PropertyStruct.const_37,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_871);
            }
            if(this.var_42.top != PropertyDefaults.const_951)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_310,this.var_42.top,PropertyStruct.const_37,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_865);
            }
            if(this.var_42.right != PropertyDefaults.const_765)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_314,this.var_42.right,PropertyStruct.const_37,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_935);
            }
            if(this.var_42.bottom != PropertyDefaults.const_790)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_306,this.var_42.bottom,PropertyStruct.const_37,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_742);
            }
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_427:
                  this.textStyle = TextStyleManager.getStyle(_loc2_.value as String);
                  break;
               case PropertyDefaults.const_432:
                  this.var_397 = _loc2_.value as uint;
                  break;
               ...
               case PropertyDefaults.const_310:
                  ...
                  break;
               case PropertyDefaults.const_314:
                  if(this.var_42 || _loc2_.valid)
                  {
