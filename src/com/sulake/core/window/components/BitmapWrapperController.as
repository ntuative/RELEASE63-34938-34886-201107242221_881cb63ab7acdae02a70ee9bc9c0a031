package com.sulake.core.window.components
{
   ...
   public class BitmapWrapperController extends WindowController implements IBitmapWrapperWindow, IBitmapDataContainer
   {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_608 != PropertyDefaults.const_1282)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_813,this.var_608,PropertyStruct.const_36,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1918);
         }
         if(this.var_937 != PropertyDefaults.const_1232)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_886,this.var_937,PropertyStruct.const_54,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_2007);
         }
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_813:
                  ...
                  break;
               case PropertyDefaults.const_886:
