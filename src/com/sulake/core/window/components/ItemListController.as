package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_2271:Boolean = false;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_192 = var_513 || !testParamFlag(WindowParam.const_33);
         this._container = _context.create("_CONTAINER","",WindowType.const_446,WindowStyle.const_106,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         ...
         this.resizeOnItemUpdate = this.var_1423;
      }
      ...
      {
         return new Rectangle(this.var_755 * this.maxScrollH,this.var_758 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         if(param1 != this.var_755)
         {
            ...
            _loc2_ = WindowEvent.allocate(WindowEvent.const_585,this,null);
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            if(this._horizontal)
            {
               this._container.setParamFlag(WindowParam.const_671,param1);
            }
            else
            {
               this._container.setParamFlag(WindowParam.const_668,param1);
            }
         }
      }
      ...
      public function get method_16() : IWindow
      {
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_184:
               if(this.var_1425)
               {
                  this.var_1426 = this.var_2270 - _loc3_;
                  this.var_1424 = this.var_2269 - _loc4_;
                  if(this._horizontal)
                  {
                  ...
                  else if(this.var_1424 != 0 && this.var_108 != 0)
                  {
                     this.scrollV += this.var_1424 / this.var_108;
                  }
                  this.var_2270 = _loc3_;
                  this.var_2269 = _loc4_;
                  _loc2_ = true;
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_1151 && !this.var_612 && this._container)
         {
            this.var_612 = true;
      ...
      override public function get properties() : Array
      {
         ...
         if(this._spacing != PropertyDefaults.const_823)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_412,this._spacing,PropertyStruct.const_37,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1345);
         }
         if(this.var_1151 != PropertyDefaults.const_1280)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_928,this.var_1151,PropertyStruct.const_36,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1982);
         }
         if(this.var_514 != PropertyDefaults.const_1407)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_756,this.var_514,PropertyStruct.const_36,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1847);
         }
         if(this.var_1423 != PropertyDefaults.const_1340)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_842,this.var_1423,PropertyStruct.const_36,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1845);
         }
         if(this.var_756 != PropertyDefaults.const_1414)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_772,this.var_756,PropertyStruct.const_123,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1928);
         }
         if(this.var_757 != PropertyDefaults.const_1200)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_802,this.var_757,PropertyStruct.const_123,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1777);
         }
         return _loc1_;
      }
