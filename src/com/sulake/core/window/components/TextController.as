package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_807 ? true : null;
         }
      ...
      {
         return new Rectangle(this.var_936 * this.maxScrollH,this.var_607 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_812,this._field.antiAliasType,PropertyStruct.const_54,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1342));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1190 ? new PropertyStruct(PropertyDefaults.const_746,this._autoSize,PropertyStruct.const_54,true,PropertyDefaults.const_1389) : PropertyDefaults.const_1779);
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_266,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1247 ? new PropertyStruct(PropertyDefaults.const_1359,this._field.gridFitType,PropertyStruct.const_54,true,PropertyDefaults.const_1239) : PropertyDefaults.const_1973);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_798) ? new PropertyStruct(PropertyDefaults.const_432,this._field.textColor,PropertyStruct.const_147,true) : PropertyDefaults.const_1337);
         _loc1_.push(this.var_443 != TextStyleManager.const_232 ? new PropertyStruct(PropertyDefaults.const_427,this.var_443,PropertyStruct.const_54,true,PropertyDefaults.const_862) : PropertyDefaults.const_1354);
         _loc1_.push(this.var_42.left != PropertyDefaults.const_738 ? new PropertyStruct(PropertyDefaults.const_278,this.var_42.left,PropertyStruct.const_37,true) : PropertyDefaults.const_871);
         _loc1_.push(this.var_42.top != PropertyDefaults.const_951 ? new PropertyStruct(PropertyDefaults.const_310,this.var_42.top,PropertyStruct.const_37,true) : PropertyDefaults.const_865);
         _loc1_.push(this.var_42.right != PropertyDefaults.const_765 ? new PropertyStruct(PropertyDefaults.const_314,this.var_42.right,PropertyStruct.const_37,true) : PropertyDefaults.const_935);
         _loc1_.push(this.var_42.bottom != PropertyDefaults.const_790 ? new PropertyStruct(PropertyDefaults.const_306,this.var_42.bottom,PropertyStruct.const_37,true) : PropertyDefaults.const_742);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1218 ? new PropertyStruct(PropertyDefaults.const_856,this._field.mouseWheelEnabled,PropertyStruct.const_36,true) : PropertyDefaults.const_1881);
