package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1604:String = "_SELECTOR";
      
      private static const const_1605:String = "_CONTENT";
       
      
      protected var var_1153:ITabSelectorWindow;
      
      protected var var_2280:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1153 = findChildByTag(const_1604) as ITabSelectorWindow;
            if(this.var_1153 != null)
            {
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_2280 = findChildByTag(const_1605) as IWindowContainer;
         }
      ...
      {
         return !!this.var_929 ? this.selector.iterator : null;
      }
