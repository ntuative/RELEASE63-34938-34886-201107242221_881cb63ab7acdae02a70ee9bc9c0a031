package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1726:uint = 500;
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_929 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            _context.handleError(WindowContext.const_399,e);
         }
      }
      ...
      private function onKeyUpEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            var_17 = _field.text;
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_366,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_837,false,PropertyStruct.const_36,true) : PropertyDefaults.const_2038);
         _loc1_.push(this.var_1427 != PropertyDefaults.const_1298 ? new PropertyStruct(PropertyDefaults.const_1010,this.var_1427,PropertyStruct.const_36,true) : PropertyDefaults.const_1834);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1412 ? new PropertyStruct(PropertyDefaults.const_786,_field.selectable,PropertyStruct.const_36,true) : PropertyDefaults.const_2059);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1366 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_36,true) : PropertyDefaults.const_1841);
         return _loc1_;
      }
