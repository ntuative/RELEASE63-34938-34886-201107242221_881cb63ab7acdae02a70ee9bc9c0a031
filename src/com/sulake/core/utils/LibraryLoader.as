package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_2078:uint = 2;
      
      protected static const const_2081:uint = 4;
      
      protected static const const_2079:uint = 3;
      ...
      public static const const_1327:Boolean = false;
      
      public static const const_1949:int = 2;
      
      private static var var_1066:Array = new Array();
      ...
      protected var var_3071:Boolean = true;
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1327)
         {
            ...
            while(_loc2_ > -1)
            {
               _loc1_ = var_867[_loc2_] as LibraryLoader;
               if(_loc1_ && (_loc1_.ready || _loc1_.disposed))
               {
                  var_867.splice(_loc2_,1);
               }
               _loc2_--;
            }
            while(var_867.length < const_1949 && false)
            {
               _loc1_ = var_1066.shift() as LibraryLoader;
      ...
      {
         return !!this.var_1155 ? uint(this.var_1428 - this.var_2282) : uint(getTimer() - this.var_2282);
      }
      ...
      {
         if(!this.var_1155 && !_disposed && this.var_1429 > 0)
         {
            try
            {
               this.var_44.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_269,const_1923 - this.var_1429);
            if(this.var_3071)
            {
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         if(this.var_517 == LibraryLoader.const_2079)
         {
