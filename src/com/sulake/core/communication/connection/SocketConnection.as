package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1912:int = 10000;
      ...
      private var var_569:ByteArray;
      
      private var var_1309:IEncryption;
      
      private var var_858:IProtocol;
      ...
      private var var_568:IConnectionStateListener;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         this._id = param1;
         this.var_306 = param2;
         this.var_569 = new ByteArray();
         this.var_1308 = new MessageClassManager();
         this.var_88 = new Socket();
         this.var_223 = new Timer(const_1912,1);
         this.var_223.addEventListener(TimerEvent.TIMER,this.onTimeOutTimer);
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_223.stop();
            this.var_223.removeEventListener(TimerEvent.TIMER,this.onTimeOutTimer);
         }
         this.var_223 = null;
         this.var_569 = null;
         this.var_568 = null;
      ...
      public function init(param1:String, param2:uint = 0) : Boolean
      {
         ...
         if(this.var_568)
         {
            this.var_568.connectionInit(param1,param2);
         }
         Security.loadPolicyFile("xmlsocket://" + param1 + ":" + param2);
         this.var_223.start();
         this.var_859 = getTimer();
      ...
      public function addMessageEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_306.addConnectionMessageEvent(this._id,param1);
      }
      ...
      public function removeMessageEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_306.removeConnectionMessageEvent(this._id,param1);
      }
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc6_:ByteArray = this.var_858.encoder.encode(_loc4_,_loc5_,param2);
         if(this.var_568)
         {
            this.var_568.messageSent(String(_loc4_),_loc6_.toString());
         }
      ...
      override public function toString() : String
      {
         ...
         _loc1_ += "Protocol Encoder: " + this.var_858.encoder + "\n";
         _loc1_ += "Protocol Decoder: " + this.var_858.decoder + "\n";
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = this.var_858.getMessages(this.var_569,receivedMessages);
         try
         {
            for each(message in receivedMessages)
            {
               ...
               if(this.var_568)
               {
                  this.var_568.messageReceived(String(id),data.toString());
               }
               eventClasses = this.var_1308.getMessageEventClasses(id);
               events = new Array();
               for each(eventClass in eventClasses)
               {
                  eventsForClass = this.var_306.getMessageEvents(this,eventClass);
               ...
               for each(messageEventInstance in events)
               {
                  ...
                  if(parserClass != null)
                  {
                     ...
                     if(parserClass != parserClassCurrent)
                     {
                        ...
                        parserInstance = this.var_306.getMessageParser(parserClass);
            ...
            {
               temp = new ByteArray();
               temp.writeBytes(this.var_569,offset);
               this.var_569 = temp;
               this.logConnection("[SOCKET REST] offset: " + offset + " rest: " + this.var_569.toString());
            }
         }
         catch(e:Error)
         {
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         {
            this.var_569.writeByte(this.var_88.readUnsignedByte());
         }
      }
      ...
      private function onConnect(param1:Event) : void
      {
         ...
         this.var_223.stop();
         this.var_2014 = true;
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - this.var_859));
      ...
      private function onClose(param1:Event) : void
      {
         ...
         this.var_2014 = false;
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - this.var_859));
         dispatchEvent(param1);
      }
      ...
      private function onComplete(param1:Event) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - this.var_859));
         dispatchEvent(param1);
      }
      ...
      private function onSecurityError(param1:SecurityErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - this.var_859));
         dispatchEvent(param1);
      }
      ...
      private function onIOError(param1:IOErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - this.var_859));
         switch(param1.type)
         {
      ...
      private function onTimeOutTimer(param1:TimerEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - this.var_859));
         var _loc2_:IOErrorEvent = new IOErrorEvent(IOErrorEvent.IO_ERROR);
         _loc2_.text = "Socket Timeout (" + this.var_223.delay + " ms). Possible Firewall.";
