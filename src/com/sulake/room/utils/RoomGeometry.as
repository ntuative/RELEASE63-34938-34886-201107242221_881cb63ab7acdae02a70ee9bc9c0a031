package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_612:Number = 64;
      
      public static const const_1350:Number = 32;
      ...
      private var var_3091:Number = -500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_1259 = new Vector3d();
         this.var_1914 = 1;
         this.var_1915 = 1;
         this.method_15 = 1;
         this.y_scale = 1;
         this.var_1913 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         this.var_467.assign(this.var_106);
         this.var_467.x *= this.var_470;
         this.var_467.y *= this.var_466;
         this.var_467.z *= this.var_469;
         return this.var_467;
      }
      ...
      public function set method_15(param1:Number) : void
      {
         if(this.var_470 != param1 * this.var_1914)
         {
            this.var_470 = param1 * this.var_1914;
            ++this.var_180;
         }
      }
      ...
      {
         if(this.var_466 != param1 * this.var_1915)
         {
            this.var_466 = param1 * this.var_1915;
            ++this.var_180;
         }
      }
      ...
      {
         if(this.var_469 != param1 * this.var_1913)
         {
            this.var_469 = param1 * this.var_1913;
            ++this.var_180;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_106.x /= this.var_470;
         this.var_106.y /= this.var_466;
         this.var_106.z /= this.var_469;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_468.x;
         var _loc3_:Number = this.var_468.y;
         var _loc4_:Number = this.var_468.z;
         this.var_468.assign(param1);
         this._direction.assign(param1);
         if(this.var_468.x != _loc2_ || this.var_468.y != _loc3_ || this.var_468.z != _loc4_)
         {
            ++this.var_180;
         }
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_1260.assign(this.var_188);
         }
         else
         {
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1259.assign(_loc22_);
         }
         else
         {
            this.var_1259.assign(_loc17_);
         }
         ++this.var_180;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= this.var_466;
         _loc2_.z *= this.var_469;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1259);
         if(_loc3_ < this.var_3091 || _loc3_ > this.var_3090)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_466;
            _loc2_.z *= this.var_469;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1259);
         }
         _loc2_.x = _loc4_;
         _loc2_.y = _loc5_;
         _loc2_.z = _loc3_;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_106.x * this.var_470,this.var_106.y * this.var_466,this.var_106.z * this.var_469);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_188;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_470,param2.y * this.var_466,param2.z * this.var_469);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_470,param3.y * this.var_466,param3.z * this.var_469);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_470,param4.y * this.var_466,param4.z * this.var_469);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1350;
         }
         else
         {
            this.scale = const_612;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_612;
      }
