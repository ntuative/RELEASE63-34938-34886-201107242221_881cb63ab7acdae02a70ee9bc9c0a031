package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_1093:Number = 60;
      
      private static const const_1558:Number = 50;
      ...
      private var var_1533:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_2533:Number = -1.0E7;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this._id = param2;
         this.var_285 = new Sprite();
         this.var_285.mouseEnabled = false;
         this.var_110 = new Sprite();
         this.var_110.name = "canvas";
         this.var_110.mouseEnabled = false;
         this.var_285.addChild(this.var_110);
         ...
         this.var_893 = new ColorTransform();
      ...
      {
         this.var_547.x -= param1 - this.var_672;
         this.var_672 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_547.y -= param1 - this.var_675;
         this.var_675 = param1;
      }
      ...
      public function set useMask(param1:Boolean) : void
      {
         ...
         {
            this.var_1079 = true;
            if(this.var_156 != null && !this.var_285.contains(this.var_156))
            {
               this.var_285.addChild(this.var_156);
               this.var_110.mask = this.var_156;
            }
         }
         else if(!param1 && this.var_1079)
         {
            this.var_1079 = false;
            if(this.var_156 != null && this.var_285.contains(this.var_156))
            {
               this.var_285.removeChild(this.var_156);
      ...
      public function dispose() : void
      {
         ...
         {
            while(this.var_285.numChildren > 0)
            {
               this.var_285.removeChildAt(0);
            }
            this.var_285 = null;
         }
         this.var_110 = null;
         ...
         if(this.var_674 != null)
         {
            ...
            {
               this.cleanSprite(this.var_674[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            this.var_674 = [];
         }
      ...
      public function render(param1:int) : void
      {
         ...
         if(this.var_549 != this.var_2531 || this.var_548 != this.var_2536)
         {
            _loc8_ = true;
         }
         if(this.var_110.x != this.var_672 || this.var_110.y != this.var_675)
         {
            this.var_110.x = this.var_672;
            this.var_110.y = this.var_675;
            _loc8_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_546.sortOn("z",0 | 0);
         if(_loc5_ < this.var_546.length)
         {
            this.var_546.splice(_loc5_);
         }
         var _loc9_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc9_ = this.var_546[_loc4_] as SortableSprite;
            if(_loc9_ != null)
            {
         ...
         this.var_2531 = this.var_549;
         this.var_2536 = this.var_548;
      }
      ...
      private function calculateUpdateInterval(param1:int) : void
      {
         ...
         if(this.var_1534 > 0)
         {
            ...
            if(_loc2_ > const_1093 * 3)
            {
               Logger.log("Really slow frame update " + _loc2_ + "ms");
               this.var_2530 = _loc2_;
            }
            if(_loc2_ <= MAXIMUM_VALID_FRAME_UPDATE_INTERVAL)
            {
               ++this.var_816;
               if(this.var_816 == const_390 + 1)
               {
                  this.var_523 = _loc2_;
                  this.var_1898 = this.var_2535;
               }
               else if(this.var_816 > const_390 + 1)
               {
                  _loc3_ = Number(this.var_816 - const_390);
                  this.var_523 = this.var_523 * (_loc3_ - 1) / _loc3_ + Number(_loc2_) / _loc3_;
                  this.var_1898 = this.var_1898 * (_loc3_ - 1) / _loc3_ + Number(this.var_2535) / _loc3_;
                  if(this.var_816 > const_390 + const_1559)
                  {
                     this.var_816 = const_390;
                     if(!this.var_1256 && this.var_523 > const_1093)
                     {
                        this.var_1256 = true;
                        Logger.log("Room canvas updating really slow - now entering frame skipping mode...");
                     }
                     else if(this.var_1256 && this.var_523 < const_1558)
                     {
                        this.var_1256 = false;
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         _loc6_.update(this._geometry,param3,!_loc9_.isEmpty || param4,this.var_1896 && this.var_1256);
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  ...
                  _loc20_ = _loc14_ + _loc18_.offsetY + this.var_675;
                  if(this.rectangleVisible(_loc19_,_loc20_,_loc22_.width,_loc22_.height))
                  {
                     ...
                     if(_loc17_ == null)
                     {
                        ...
                        this.var_546.push(_loc17_);
                        _loc17_.name = param2;
                     }
                     _loc17_.sprite = _loc18_;
                     _loc17_.x = _loc19_ - this.var_672;
                     _loc17_.y = _loc20_ - this.var_675;
      ...
      {
         if(param1 < this.var_549 && param1 + param3 >= 0 && (param2 < this.var_548 && param2 + param4 >= 0))
         {
            if(!this.var_3089)
            {
               return true;
      ...
      private function rectangleVisibleWithExclusion(param1:int, param2:int, param3:int, param4:int) : Boolean
      {
         ...
         if(param2 + param4 >= this.var_548)
         {
            param4 -= this.var_548 + 1 - (param2 + param4);
         }
         for each(_loc5_ in this.var_2532)
         {
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         {
            _loc3_ = this.var_674.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
      ...
      private function getSortableSprite(param1:int) : SortableSprite
      {
         ...
         return this.var_546[param1] as SortableSprite;
      }
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            {
               finalData = new ExtendedBitmapData(data.width,data.height,true,16777215);
               finalData.copyPixels(data,data.rect,const_712);
            }
            catch(e:Error)
            {
               finalData = new ExtendedBitmapData(1,1,true,16777215);
            }
            this.var_893.redMultiplier = tR;
            this.var_893.greenMultiplier = tG;
            this.var_893.blueMultiplier = tB;
            finalData.colorTransform(finalData.rect,this.var_893);
            if(name.length > 0)
            {
               this.var_284.addBitmapData(cacheName,finalData);
            }
      ...
      private function createMouseEvent(param1:int, param2:int, param3:int, param4:int, param5:String, param6:String, param7:Boolean, param8:Boolean, param9:Boolean, param10:Boolean) : RoomSpriteMouseEvent
      {
         ...
         var _loc12_:Number = param2 - this.var_548 / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_1897,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
      ...
      private function checkMouseHits(param1:int, param2:int, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = this.var_673.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        this.var_673.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2533 || param2 != this.var_2534)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = this.var_673.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = this.var_673.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = this.createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  this.bufferMouseEvent(_loc11_,_loc9_);
      ...
      {
         if(this.var_383 != null && param1 != null)
         {
            this.var_383.add(param2,param1);
         }
      }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this._container == null || this.var_383 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         ...
         {
            _loc2_ = this.var_383.getKey(_loc1_);
            _loc3_ = this.var_383.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1533.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
