package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_189:IRoomManagerListener;
      
      private var var_3137:IRoomContentLoader;
      
      private var var_743:IRoomObjectFactory = null;
      
      private var var_604:IRoomObjectVisualizationFactory = null;
      
      private var _state:int = 0;
      
      private var var_1397:XML = null;
      
      private var var_1132:Array;
      
      private var var_2189:Boolean = false;
      
      private var var_2996:Boolean = true;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         events.addEventListener(RoomContentLoadedEvent.const_461,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_649,this.onContentLoaded);
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_743 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc1_:* = null;
         if(this.var_743 == null || this.var_604 == null)
         {
            return;
         }
         ...
         {
            _loc1_ = this.var_1397;
            this.var_1397 = null;
            this.initialize(_loc1_,this.var_189);
         }
      }
      ...
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length)
         {
            ...
            if(this.var_742.indexOf(_loc5_) < 0)
            {
      ...
      public function method_5(param1:int) : void
      {
         var _loc4_:* = null;
         var _loc2_:int = this._updateCategories.indexOf(param1);
         if(_loc2_ < 0)
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc17_:IRoomObjectGraphicVisualization = this.var_604.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = this.var_604.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
         ...
         var _loc19_:IRoomObjectEventHandler = this.var_743.createRoomObjectLogic(_loc11_);
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(this.var_743 != null)
         {
            return this.var_743.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this._state == const_984)
         {
            return;
         }
         if(this.var_61 == null)
         {
            this._state = const_984;
            return;
         }
         if(this.var_61.getGraphicAssetCollection(param1) != null)
         {
            _loc2_ = this.var_742.indexOf(param1);
            if(_loc2_ >= 0)
            {
               this.var_742.splice(_loc2_,1);
            }
            if(this.var_742.length == 0)
            {
               ...
               {
                  this.var_189.roomManagerInitialized();
               }
            }
         }
         else
         {
            this._state = const_984;
            this.var_189.roomManagerInitialized(false);
         }
      }
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         if(_loc2_ == null)
         {
            if(this.var_189 != null)
            {
               this.var_189.contentLoaded(null,false);
            }
            return;
         }
         if(this.var_1132.indexOf(_loc2_) < 0)
         {
            this.var_1132.push(_loc2_);
         }
      }
      ...
      private function processLoadedContentTypes() : void
      {
         ...
         while(this.var_1132.length > 0)
         {
            _loc2_ = this.var_1132[0];
            this.var_1132.splice(0,1);
            _loc3_ = this.var_61.getVisualizationXML(_loc2_);
            if(_loc3_ == null)
            {
               if(this.var_189 != null)
               {
                  this.var_189.contentLoaded(_loc2_,false);
               }
               return;
            }
            ...
            if(this.var_189 != null)
            {
               this.var_189.contentLoaded(_loc2_,true);
            }
            if(this.var_742.length > 0)
            {
            ...
            _loc5_ = getTimer();
            if(_loc5_ - _loc1_ >= CONTENT_PROCESSING_TIME_LIMIT_MILLISECONDS && this.var_2996)
            {
               this.var_2189 = true;
               break;
            }
      ...
      private function updateObjectContents(param1:String) : void
      {
         ...
         if(this.var_61 == null || this.var_604 == null)
         {
            return;
         }
         ...
         var _loc7_:IRoomObjectVisualizationData = this.var_604.getRoomObjectVisualizationData(param1,_loc5_,_loc2_);
            ...
            if(_loc9_ != null)
            {
               ...
               for each(_loc12_ in _loc11_)
               {
                  ...
                  while(_loc14_ >= 0)
                  {
                     ...
                     if(_loc15_ != null)
                     {
                        _loc16_ = this.var_604.createRoomObjectVisualization(_loc5_);
                        if(_loc16_ != null)
                        {
                           ...
                           else
                           {
                              ...
                              _loc17_ = this.var_743.createRoomObjectLogic(_loc6_);
                              ...
                              if(this.var_189 != null)
                              {
                                 this.var_189.objectInitialized(_loc10_,_loc15_.getId(),_loc12_);
                              }
                           }
                        }
                        else
